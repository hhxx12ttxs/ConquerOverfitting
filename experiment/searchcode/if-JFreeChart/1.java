...
public class Chart extends JPanel 
	 ...
	 */
	public Chart(UID sEntityName, int iScrollPane, int iToolBarOrientation) {
	 ...
	 */
	public Chart(UID entityName, int iScrollPane, int toolBarOrientation, UID foreignKeyFieldToParent) {
	 ...
	 * @postcondition this.getForeignKeyFieldToParent() == foreignKeyFieldToParent
	 */
	public Chart(UID entityName, int iScrollPane, int toolBarOrientation, UID foreignKeyFieldToParent, boolean bFromProperties, boolean bSearchable) {
		...
		//UID sDataSource = entityName.substring(MasterDataMetaVO.CHART_ENTITY_PREFIX.length()).toLowerCase();
		
		DatasourceVO datasourceVO  = null;
		try {
			datasourceVO = DatasourceDelegate.getInstance().getDatasource(entityName);
			//DatasourceVO datasourceVO = DatasourceDelegate.getInstance().getChartByEntity(entityName);
	...
	public static class Column {
		...
		public boolean equals(Object oValue) {
			...
			return LangUtils.equals(getUID(), ((Column) oValue).getUID());
		}
