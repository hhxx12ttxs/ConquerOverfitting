...
import gwt.ns.gwtbox2d.client.collision.OBB;
...
import gwt.ns.gwtbox2d.client.pooling.TLAABB;
import gwt.ns.gwtbox2d.client.pooling.TLMassData;
...
public class PolygonShape extends Shape implements SupportsGenericDistance{
	...
	// djm gwt.ns.gwtbox2d.pooling, and from above
...
//			float denominator = Vec2.dot(m_normals[i],d);
	...
	// djm gwt.ns.gwtbox2d.pooling, hot method
