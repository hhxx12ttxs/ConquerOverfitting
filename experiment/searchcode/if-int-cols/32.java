...
public class SmjPdfReport extends PdfPageEventHelper {
	...
	public void reportTable() {
		...
		while (itRep.hasNext()) {
			...
			if (rpt.getSmj_reportline() != null	&& rpt.getSmj_reportline().equals("T")) {
				...
				tableCell = new PdfPCell(new Phrase(dataNull(rpt.getDescription())));
	...
	public void onEndPage(PdfWriter writer, Document document) {
		...
		cb.saveState();
		Date date = new Date();
		String textLeft = Msg.getMsg(Env.getCtx(), "Page") + " " + writer.getPageNumber() + " " + Msg.getMsg(Env.getCtx(), "of") + " ";
		String textRight = date + "         " + Msg.getMsg(Env.getCtx(), "Page") + " "+ writer.getPageNumber() + " " + Msg.getMsg(Env.getCtx(), "of") + " ";
