...
*/
	    ...
	    public void Verificar_Bluetouth() {
	    	...
	    	if (mBluetoothAdapter == null) {
	    		Toast.makeText(TrabalhoFinalActivity.this, "O seu dispositivo não possui Bluetooth", Toast.LENGTH_SHORT).show();
	    	}
	    	else{
	    ...
	    private void Fechar_ligacao()  {
	        ...
	        conectado = false;
	        metodo_controlo = 0;
	        Toast.makeText(TrabalhoFinalActivity.this, "Ligação terminada", Toast.LENGTH_SHORT).show();
	    }
	    /*******************************************************/
	    /********************************************************/
		...
		private OutputStream getOutputStreamOfBTDevice(String address) {
			...
			if (address != null && address.length() > 0) {
				...
				try {
					...
					conectado = true;
					Toast.makeText(this, "Ligação estabelecida",Toast.LENGTH_SHORT).show();
					beginListenForData();
				} catch (IOException e) {
					conectado = false;
