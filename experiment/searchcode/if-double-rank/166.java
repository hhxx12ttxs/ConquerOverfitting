// $Id: StringCharAdapter.java,v 1.1 2007/03/26 13:07:24 dmedv Exp $
/*
...
public class StringCharAdapter implements MultiArray {
	 ...
	 */
	public
	StringCharAdapter(MultiArray delegateA, char fillValue)
	{
		if(delegateA.getComponentType() != Character.TYPE)
