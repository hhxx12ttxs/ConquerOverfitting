...
/**
 * NSGA2MultiObjectiveFitness is a subclass of MultiObjeciveFitness which adds
 * auxiliary fitness measures (sparsity, rank) largely used by
 * MultiObjectiveStatistics. It also redefines the comparison measures to
 * compare based on rank, and break ties based on sparsity.
 * 
 */
...
public class NSGA2MultiObjectiveFitness extends MultiObjectiveFitness {
    ...
    public boolean equivalentTo(Fitness _fitness) {
        ...
        return (rank == ((NSGA2MultiObjectiveFitness) _fitness).rank) && (sparsity == other.sparsity);
    }
