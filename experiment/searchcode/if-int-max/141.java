...
public class StscChecker
{
        ...
        if (sType.getDerivationType() == SchemaType.DT_RESTRICTION && !sType.isSimpleType())
        {
            ...
            switch (sType.getContentType())
            {
                case SchemaType.SIMPLE_CONTENT:
                    ...
                    {
                        case SchemaType.SIMPLE_CONTENT:
                            // 5.1.1 The {content type} of the {base type definition} must be a simple type definition of which the {content type} is a ˇvalid restrictionˇ as defined in Derivation Valid (Restriction, Simple) (§3.14.6).
                            // todo: we don't allow the content type to be an "on the side" simple type, so nothing fancy to check here
                            break;
                            
                        case SchemaType.MIXED_CONTENT:
                            // 5.1.2 The {base type definition} must be mixed and have a particle which is ˇemptiableˇ as defined in Particle Emptiable (§3.9.6).
                ...
                case SchemaType.EMPTY_CONTENT:
                    ...
                    switch (baseType.getContentType())
                    {
                        ...
                        case SchemaType.ELEMENT_CONTENT:
                            // 5.2.2 The {content type} of the {base type definition} must be elementOnly or mixed and have a particle which is ˇemptiableˇ as defined in Particle Emptiable (§3.9.6).
                            if (baseType.getContentModel() != null && !baseType.getContentModel().isSkippable())
                            {
                ...
                case SchemaType.ELEMENT_CONTENT:
                    ...
                    // 5.3 ... then the particle of the complex type definition itself must be a ˇvalid restrictionˇ of the particle of the {content type} of the {base type definition}
    ...
    private static boolean mapAndSum(SchemaParticle baseModel, SchemaParticle derivedModel, Collection errors, XmlObject context)  {
        ...
        // For a sequence group particle to be a ˇvalid restrictionˇ of a choice group particle all of the following
        // must be true:
        // 1 There is a complete functional mapping from the particles in the {particles} of R to the particles in the
        // {particles} of B such that each particle in the {particles} of R is a ˇvalid restrictionˇ of the particle in
    ...
    private static boolean recurseAsIfGroup(SchemaParticle baseModel, SchemaParticle derivedModel, Collection errors, XmlObject context) {
        ...
        // For an element declaration particle to be a ˇvalid restrictionˇ of a group particle
        ...
        // must be a ˇvalid restrictionˇ of the group as defined by Particle Derivation OK
    ...
    private static boolean recurseLax(SchemaParticle baseModel, SchemaParticle derivedModel, Collection errors, XmlObject context)  {
        ...
        // For a choice group particle to be a ˇvalid restrictionˇ of another choice group particle all of the
        // following must be true:
        // 1 R's occurrence range is a valid restriction of B's occurrence range as defined by Occurrence
        // Range OK (§3.9.6);
        // 2 There is a complete ˇorder-preservingˇ functional mapping from the particles in the {particles} of R
        // to the particles in the {particles} of B such that each particle in the {particles} of R is a
        // ˇvalid restrictionˇ of the particle in the {particles} of B it maps to as defined by
        // Particle Valid (Restriction) (§3.9.6).
        // NOTE: Although the ˇvalidationˇ semantics of a choice group does not depend on the order of its particles,
    ...
    private static boolean recurseUnordered(SchemaParticle baseModel, SchemaParticle derivedModel, Collection errors, XmlObject context) {
        ...
        // For a sequence group particle to be a ˇvalid restrictionˇ of an all group particle all of the
        // following must be true:
        ...
        // the {particles} of R;
        // 2.2 Each particle in the {particles} of R is a ˇvalid restrictionˇ of the particle in the {particles} of B
        ...
        // of R are ˇemptiableˇ as defined by Particle Emptiable (§3.9.6).
    ...
    private static boolean recurse(SchemaParticle baseModel, SchemaParticle derivedModel, Collection errors, XmlObject context) {
        ...
        // For an all or sequence group particle to be a ˇvalid restrictionˇ of another group particle with the same
        // {compositor} all of the following must be true:
        // 1 R's occurrence range is a valid restriction of B's occurrence range as defined by
        // Occurrence Range OK (§3.9.6).
        // 2 There is a complete ˇorder-preservingˇ functional mapping from the particles in the {particles} of R to
        // the particles in the {particles} of B such that all of the following must be true:
        //   2.1 Each particle in the {particles} of R is a ˇvalid restrictionˇ of the particle in the {particles}
        ...
        //   of R are ˇemptiableˇ as defined by Particle Emptiable (§3.9.6).
        // NOTE: Although the ˇvalidationˇ semantics of an all group does not depend on the order of its particles,
    ...
    private static boolean nsRecurseCheckCardinality(SchemaParticle baseModel, SchemaParticle derivedModel, Collection errors, XmlObject context) {
        ...
        // For a group particle to be a ˇvalid restrictionˇ of a wildcard particle all of the following must be true:
        // 1 Every member of the {particles} of the group is a ˇvalid restrictionˇ of the wildcard as defined by Particle Valid (Restriction) (§3.9.6).
    ...
    private static boolean nsSubset(SchemaParticle baseModel, SchemaParticle derivedModel, Collection errors, XmlObject context) {
        ...
        // For a wildcard particle to be a ˇvalid restrictionˇ of another wildcard particle all of the following must be true:
    ...
    private static boolean nsCompat(SchemaParticle baseModel, SchemaLocalElement derivedElement, Collection errors, XmlObject context) {
        ...
        // For an element declaration particle to be a ˇvalid restrictionˇ of a wildcard particle all of the following must be true:
        // 1 The element declaration's {target namespace} is ˇvalidˇ with respect to the wildcard's {namespace constraint}
    ...
    private static boolean typeDerivationOK(SchemaType baseType, SchemaType derivedType, Collection errors, XmlObject context) {
        ...
        // 2.3.1 D's {base type definition} must not be the ˇur-type definitionˇ.
