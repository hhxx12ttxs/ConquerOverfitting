...
public class RandomGenerator {
  ...
  public final long nextLong() {
    ...
    int y2 = nextInt();
    byte[] buf = new byte[8];
    buf[0] = (byte) (0xff & (y2 >> 24));
    buf[1] = (byte) (0xff & (y2 >> 16));
    buf[2] = (byte) (0xff & (y2 >> 8));
    buf[3] = (byte) (0xff & y2);
    buf[4] = (byte) (0xff & (y1 >> 24));
    buf[5] = (byte) (0xff & (y1 >> 16));
    buf[6] = (byte) (0xff & (y1 >> 8));
    buf[7] = (byte) (0xff & y1);
    return (
        (((long) (buf[0] & 0xff) << 56) |
            ((long) (buf[1] & 0xff) << 48) |
  ...
  public final byte[] nextBytes(int num, int off, byte[] buf) {
    int y = -1;
    for (int i = 0; i < num; i++) {
      switch (i % 4) {
        case 0:
          y = nextInt();
          buf[i] = (byte) (0xff & (y >> 24));
          break;
        case 1:
          buf[i] = (byte) (0xff & (y >> 16));
          break;
        case 2:
          buf[i] = (byte) (0xff & (y >> 8));
          break;
  ...
  public void setSeed(long s) {
    setSeed((int) Math.abs(s % BIG_PRIME));
  }//setSeed
