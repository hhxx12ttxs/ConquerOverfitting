 ...
 * Centro de Informбtica - CIn
 * 
 * Paradigmas de Linguagem de Programaзгo - PLP
 * 
 * Tipo: TipoQualquer
 */
...
/**
 * Esta classe representa um tipo polimуrfico, ou seja, que й vбlido como
 * qualquer dos tipos da linguagem.
 * 
 * Exemplo: let fun Id x = x in Id(2)
 * 
 * O tipo inferido para "x" serб um curinga ("?"). O tipo instanciado serб
...
public class TipoPolimorfico implements Tipo {
	...
	/**
	 * O tipo inferido. <code>null</code> atй ser inferido.
	...
	/**
	 * Construtor da classe que representa tipo polimуrfico.
	 */
	...
	/**
	 * Retorna o tipo inferido por este tipo polimуrfico, se estiver vбlido.
	 * Caso contrбrio, retorna o prуprio tipo polimуrfico.
	 * 
	 * @return
	 */
	public Tipo inferir() {
