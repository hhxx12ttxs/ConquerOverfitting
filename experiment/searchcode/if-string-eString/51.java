...
public class ContextoExecucaoOO1 implements AmbienteExecucaoOO1 {
    ...
    /**
	 * A referкncia do objeto a ser inserido na pilha de objetos
	 */
	 ...
	 * 
	 * @param entrada
	 *            Entrada para o contexto de execuзгo.
	 */
    ...
    /**
	 * Obtйm a pilha de valores associados a identificadores
	 * 
    ...
    /**
	 * Retorna a pilha com as definiзoes das classes.
	 * 
	 * @return a pilha com as definiзoes das classes.
	 */
    ...
    /**
	 * Obtйm o mapeamento com os objetos e seus valores.
	 * 
    ...
    /**
	 * Lк da entrada padrгo e associa o conteъdo a um determinado identificador.
	 * 
	 * @param tipoIdLido
	 *            Tipo do identificador ao qual serб associado o valor lido.
	 * @return o valor lido.
	 * @throws EntradaInvalidaException
	 *             Quando a entrada fornecida nгo pode ser atribuнda ao tipo do
	 *             identificador.
	 */
      ...
      if (valorLido!=null){
        ...
        if (tipoIdLido instanceof TipoPrimitivo){
            ...
            try {
              ...
              throw new EntradaInvalidaException("O tipo da entrada e o da variбvel"+
                                                 " a ser lida sгo diferentes!");
            }
        }
      }
      throw new EntradaInvalidaException("O tipo da variбvel a ser lida nгo й um tipo Primitivo!");
    }

    /**
	 * Este mйtodo lк uma entrada que pode ser de uma tail ou do teclado
	 * 
	 * @return Obtйm uma entrada que pode ser de uma tail ou do teclado
	 * @exception Lanзa
	 *                uma exceзгo se a tail com os valores nao tiver mais
	 *                elementos.
	 */
    private String leEntrada() throws EntradaInvalidaException{
      if(this.entrada==null) {
        ...
        if(entrada.length()==0) {
          throw new EntradaInvalidaException("Nъmero de argumentos menor do que o nъmero de reads!");
        }
        return leDaListaValor();
      }
    }
    /**
	 * Este mйtodo lк da entrada padrгo
	 * 
	 * @return o que o usuбrio digitou na entrada padrгo
	 */
    private String leDaEntradaPadrao(){
      try {
        ...
        return in.readLine();
         ...
         System.out.println("Erro no valor lido da entrada padrгo");
      }
      return "";
    }
    ...
    /**
	 * Escreve um valor 'v' na saнda.
	 * 
	 * @param v
	 *            O valor a ser escrito.
	 * @return o ambiente de execuзгo, que representa o estado atual.
	 */
    ...
    /**
	 * Incrementa a pilha do ambiente, passando para o prуximo estado.
	 */
    public void incrementa() {
        pilha.push(new HashMap<Id, Valor>());
        // pilhaDefClasse.push(new HashIdDefClasse()); // sу incrementa no
		// construtor
        // pilhaObjeto.push(new HashValorObjeto()); // sу incrementa no
		// construtor
    }
    ...
    public void restaura(){
        pilha.pop();
        // pilhaDefClasse.pop(); // nгo restaura
        // pilhaObjeto.pop(); // nгo restaura
    }
	 ...
	 *             Quando a variбvel jб foi declarada.
	 */
    ...
    /**
	 * Mapeia um identificador a um definiзгo de classe.
	 * 
	 * @param idArg
	 *            o nome da classe
	 * @param defClasse
	 ...
	 *             quando a classe jб foi declarada.
	 */
    ...
    /**
	 * Mapeia um valor referкncia a um objeto.
	 * 
	 * @param valorRef
	 *            Valor referкncia.
	 * @param objeto
	 ...
	 *             Quando esse objeto jб foi declarado.
	 */
	 ...
	 *             Quando a variбvel nгo foi declarada.
	 */
    ...
    /**
	 * Obtйm o valor associado a um determinado identificador.
	 * 
	 * @param idArg
	 *            Identificador
    ...
    /**
	 * Obtйm a definiзгo da classe cujo nome й idArg
	 * 
	 * @param idArg
	 *            Nome da classe.
	 * @return a definiзгo da classe.
    ...
    /**
	 * Obtйm a prуxima referкncia de acordo com o contexto atual de execuзгo.
	 * 
	 * @return a prуxima referкncia de acordo com o contexto atual de execuзгo.
	 */
    ...
    /**
	 * Obtйm o valor referencia atual.
	 * 
    ...
    /**
	 * Retorna a representaзгo textual do contexto de execuзгo.
	 * 
	 * @return a representaзгo textual do contexto de execuзгo.
	 */
    ...
    /**
	 * Obtйm um novo contexto de execuзгo com a mesma entrada, saнda e pilha de
	 * mapeamentos id/valor.
	 * 
	 * @return um novo contexto de execuзгo com a mesma entrada, saнda e pilha
