 ...
 * Centro de Informрtica - CIn
 * 
 * Paradigmas de Linguagem de Programaусo - PLP
 * 
 * Tipo: TipoFuncao
 */
...
/**
 * Esta classe representa o tipo de uma funусo.
 * 
 * Caso o tipo do domьnio da funусo tambжm seja um objeto dessa classe a funусo
 * representada por esse objeto ж uma funусo que recebe uma funусo como
 * parРmetro, logo, trata-se de um caso de suporte a funушes de alta ordem.
 * 
 * Se o tipo da imagem da funусo tambжm for um objeto da classe TipoFuncao
 * trata-se de uma funусo com mЩltiplos parРmetros. Assim, o tipo do retorno da
 * funусo serр sempre o tipo da imagem do Щltimo objeto dessa classe.
 * 
...
public class TipoFuncao implements Tipo {
	...
	/**
	 * O tipo do domьnio da funусo.
	 */
	private List<Tipo> dominio;

	/**
	 * O tipo da imagem (o tipo de retorno) da funусo.
	 */
	private Tipo imagem;

	/**
	 * Construtor da classe que representa um tipo funусo (T1 x ... x Tn -> T).
	 * 
	 * @param dominio
	 *            A lista dos tipos do domьnio da funусo (T1 x ... x Tn).
	 * @param imagem
	 *            O tipo da imagem da funусo (T).
	 */
	...
	/**
	 * Este mжtodo ж usado para limpar os tipos curingas, pois apзs a aplicaусo
	 * os mesmos podem estar instanciados e isto pode influenciar um erro de
	 * tipos na prзxima aplicaусo.
	 */
	...
	public Tipo getTipo(AmbienteCompilacao ambiente,
		...
		// Obtem o resultado. 
		Tipo ret = getImagem();
		// Caso seja um tipo polimorfico procura a mais especьfica instanciaусo.
