...
public class CCTesselator implements GLUtessellatorCallback{
	...
	private final static int VERTEX_X = 0;
	private final static int VERTEX_Y = 1;
	private final static int VERTEX_Z = 2;

	private final static int NORMAL_X = 3;
	private final static int NORMAL_Y = 4;
	private final static int NORMAL_Z = 5;

	private final static int COLOR_R = 6;
	private final static int COLOR_G = 7;
	private final static int COLOR_B = 8;
	private final static int COLOR_A = 9;

	private final static int TEXTURE_S = 10;
	private final static int TEXTURE_T = 11;
	private final static int TEXTURE_R = 12;
	private final static int TEXTURE_Q = 13;
	
	private boolean _myHasColorData = false;
	private boolean _myHasNormalData = false;
	private boolean _myHasTextureData = false;
...
//				System.out.println(theWeights[0] + ":"+((double[]) theInputData[0])[i]);
//				System.out.println(theWeights[1] + ":"+((double[]) theInputData[1])[i]);
				myVertexData[i] =1;
//					theWeights[0] * ((double[]) theInputData[0])[i] +
//					theWeights[1] * ((double[]) theInputData[1])[i] +
//					(theInputData[2] == null ? 0 : theWeights[2] * ((double[]) theInputData[2])[i]) +
...
//	      System.out.println("ERROR:"+theErrorNumber+":"+estring);
//	      System.out.println("GLU_TESS_MISSING_BEGIN_POLYGON:"+GLU.GLU_TESS_MISSING_BEGIN_POLYGON);
//	      System.out.println("GLU_TESS_MISSING_END_POLYGON:"+GLU.GLU_TESS_MISSING_END_POLYGON);
//	      System.out.println("GLU_TESS_MISSING_BEGIN_CONTOUR:"+GLU.GLU_TESS_MISSING_BEGIN_CONTOUR);
//	      System.out.println("GLU_TESS_MISSING_END_CONTOUR:"+GLU.GLU_TESS_MISSING_END_CONTOUR);
//	      System.out.println("GLU_TESS_COORD_TOO_LARGE:"+GLU.GLU_TESS_COORD_TOO_LARGE);
//	      System.out.println("GLU_TESS_NEED_COMBINE_CALLBACK:"+GLU.GLU_TESS_NEED_COMBINE_CALLBACK);
//	      System.out.println("GLU_OUT_OF_MEMORY:"+GLU.GLU_OUT_OF_MEMORY);
	}
