...
public final class LargeInteger extends Number<LargeInteger> {
     ...
     * @return <code>this ˇ multiplier</code>.
     */
     ...
     * 
     * @param precision the requested precision (reciprocal error being ą 1).
     ...
     * @return <code>this ˇ 2<sup>n</sup></code>.
     */
     ...
     * @return <code>this ˇ 10<sup>n</sup></code>
     */
