 ...
 * sirayla almak için kullanilir. ?ki constructor'u vard?r, istenirse verilen bir
...
public class TurkishTokenStream {
            ...
            while ((readChar = bis.read()) != -1) {
                ...
                if (Character.isLetter(ch) || (kelimeBasladi == true & ( ch == '\'' || ch == '-')) ) {
                    ...
                    if (kelimeIndex < MAX_KELIME_BOY)
                        ...
                        System.out.println("maksimum kelime boyu a??ld?. " + ch);
                    continue;
                }
     ...
     * @return Sonraki cümle, e?er kalmam??sa null
     */
