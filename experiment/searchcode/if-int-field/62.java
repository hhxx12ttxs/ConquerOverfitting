package net.mufly.client.ui.tag;
 ...
 * @see NumberField
 */
public class SuggestField<D> extends Field<D> {
  ...
  private SuggestBox messages = new SuggestBox();
...
//    return (TextFieldMessages) messages.getText();
//  }
