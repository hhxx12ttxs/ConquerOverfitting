...
public class DateUtils {
	...
	public static String getCurrent() {
		...
		sb.append(year).append("_").append(StringUtils.addzero(month, 2))
				.append("_").append(StringUtils.addzero(day, 2)).append("_")
				.append(StringUtils.addzero(hour, 2)).append("_").append(
						StringUtils.addzero(minute, 2)).append("_").append(
						StringUtils.addzero(second, 2));
		return sb.toString();
	}
...
//	 获得参数月的本季度第一天
	...
	public static void main(String[] args) {
		...
		System.out.println("获取本季度第一天:" + du.getThisSeasonTime(DateUtils.getToMonth()).split(";"));
		...
		Date now=new Date();
		System.out.println("当前天:"+DateUtils.DateToString(now, DateUtils.LONG_DATE_FORMAT));
