 ...
 *
 * Created on December 23, 2005, 6:41 PM
 *
 */
...
/**
 * An orthographic projection of a planet
 *
 * @author martin
 * @version $Id: OrthographicProjection.java,v 1.7 2006/07/06 06:58:34 martin Exp $
 */
public class OrthographicProjection extends AbstractProjector
    implements Projector
{
    /** Our logging object */
    private static Log log = LogFactory.getLog(OrthographicProjection.class);

    /** Creates a new instance of OrthographicProjection */
     ...
     */
    public OrthographicProjection(AllPlanetParameters params)
    {
        super(params);
    }
