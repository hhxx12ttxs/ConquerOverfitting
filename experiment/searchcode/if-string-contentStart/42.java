		...
		//#ifdef polish.css.horizontalview-left-arrow
			...
			if (leftArrowUrl != null) {
				try {
					...
					//#debug error
de.enough.polish.util.Debug.debug("error", "de.enough.polish.ui.containerviews.HorizontalChoiceView", 323, "Unable to load left arrow image [" + leftArrowUrl + "]", e );
				}
			}
		//#endif
		//#ifdef polish.css.horizontalview-right-arrow
			...
			if (rightArrowUrl != null) {
				try {
					...
					//#debug error
de.enough.polish.util.Debug.debug("error", "de.enough.polish.ui.containerviews.HorizontalChoiceView", 334, "Unable to load right arrow image [" + rightArrowUrl + "]", e );
				}
			}
		//#endif
