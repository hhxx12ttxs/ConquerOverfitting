 ...
 */
public class Const {
    public static final String CONST_SERVER_VERSION = "3.2.1";
    public static final String CACHE_KEY_PREFIX = "01";
    ...
    public static final String ANDROID_DB_NAME = "nimbits125";
    ...
    public static final String CACHE_KEY_CURRENT_VALUE = "MOSTRECENTPOINTVALUE:";
    ...
    public static final String MESSAGE_LINKS_AFTER_ERROR = " <P><a href = \"Http://www.nimbitc.com\" go to Nimbits.com </P>";
    ...
    public static final String PARAM_ENABLE_CONNECTIONS = "enableConnections";
    ...
    public static final String PARAM_TWITTER_CLIENT_ID = "twitterClientId";
    public static final String PARAM_TWITTER_SECRET = "twitterSecret";
    ...
    public static final String PATH_CHART_WIKI = "https://code.google.com/p/nimbits-server/wiki/AnnotatedTimeline";
    ...
    public static final String PARAM_FACEBOOK_CLIENT_ID = "facebookClientId";
    public static final String PARAM_FACEBOOK_SECRET = "facebookSecret";
    public static final String PARAM_FACEBOOK_REDIRECT_URL = "facebookRedirectUrl";
    ...
    public static final String PARAM_WOLFRAM_ALPHA_KEY = "wolframAlphaKey";
