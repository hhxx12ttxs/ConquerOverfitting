...
// removed import of reflect package.
import org.not.java.Locale;
import org.mozilla.javascript.debug.*;

import org.mozilla.javascript.xml.XMLLib;

import org.not.java.ClassLoader;
...
public class Context
{
     ...
     */
    public final void addPropertyChangeListener() throws Exception//(PropertyChangeListener l)
    {
        throw new Exception("Context.java - addPropertyChangeListener");
        //if (sealed) onSealedMutation();
     ...
     * @param l the listener
     */
    public final void removePropertyChangeListener() throws Exception//PropertyChangeListener l)
    {
        throw new Exception("Context.java - removePropertyChangeListener");
        //if (sealed) onSealedMutation();
                                        ...
                                        
    {
        for (int i = 0; ; ++i) {
            ...
            if (l == null)
                break;
            throw new UnsupportedOperationException("Context.java - firePropertyChangeImpl");
...
//            }
    ...
    {
        if (value instanceof String || org.not.java.Number.isNumber(value)
     ...
     * // Changed because we do not need to load chanaged type to void
     */
