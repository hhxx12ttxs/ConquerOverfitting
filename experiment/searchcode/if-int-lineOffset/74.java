...
import com.nexj.njsdoc.org.mozilla.javascript.ast.AstNode;
import com.nexj.njsdoc.org.mozilla.javascript.ast.AstRoot;
import com.nexj.njsdoc.org.mozilla.javascript.ast.Comment;
import com.nexj.njsdoc.org.mozilla.javascript.ast.NodeVisitor;
import com.nexj.njsdoc.org.mozilla.javascript.ast.ScriptNode;
import com.nexj.njsdoc.org.mozilla.javascript.debug.DebuggableScript;
import com.nexj.njsdoc.org.mozilla.javascript.debug.Debugger;
import com.nexj.njsdoc.org.mozilla.javascript.xml.XMLLib;
...
public class Context
{
    ...
    /**
     * @deprecated
     * @see ContextFactory#addListener(com.nexj.njsdoc.org.mozilla.javascript.ContextFactory.Listener)
     * @see ContextFactory#getGlobal()
     */
    public static void addContextListener(ContextListener listener)
    {
        // Special workaround for the debugger
        String DBG = "com.nexj.njsdoc.org.mozilla.javascript.tools.debugger.Main";
        if (DBG.equals(listener.getClass().getName())) {
            Class<?> cl = listener.getClass();
            Class<?> factoryClass = Kit.classOrNull(
                "com.nexj.njsdoc.org.mozilla.javascript.ContextFactory");
    ...
    /**
     * @deprecated
     * @see ContextFactory#removeListener(com.nexj.njsdoc.org.mozilla.javascript.ContextFactory.Listener)
     * @see ContextFactory#getGlobal()
     */
     ...
     *
     * @see com.nexj.njsdoc.org.mozilla.javascript.ErrorReporter
     */
     ...
     * @see com.nexj.njsdoc.org.mozilla.javascript.SecurityController
     */
            ...
            throws ContinuationPending
    {
        ...
        return Interpreter.restartContinuation(
                (com.nexj.njsdoc.org.mozilla.javascript.NativeContinuation) continuation,
                this, scope, args);
    }
     ...
     * @exception IOException if an IOException was generated by the Reader
     * @see com.nexj.njsdoc.org.mozilla.javascript.Script
     */
     ...
     * @see com.nexj.njsdoc.org.mozilla.javascript.Function
     */
        ...
        throws IOException
    {
        ...
        loadCommentLocationMap(ast, sourceName);
    ...
    private static Class<?> codegenClass = Kit.classOrNull(
                             "com.nexj.njsdoc.org.mozilla.javascript.optimizer.Codegen");
    private static Class<?> interpreterClass = Kit.classOrNull(
                             "com.nexj.njsdoc.org.mozilla.javascript.Interpreter");
    ...
    public CodeLocation getCodeLocation() {
        int[] i = { 0 };
        String file = getSourcePositionFromStack2(i);

        return new CodeLocation(file, i[0]);
    }

    public static CodeLocation getCodeLocation(DebuggableScript idata) {
        if (idata instanceof InterpreterData) {
            return new CodeLocation(((InterpreterData) idata).itsSourceFile,
                    ((InterpreterData) idata).firstLinePC /*
                                                           * Undocumented use of
                                                           * this field?
                                                           */);
        }
    ...
    /**
     * Store a location at which a value is assigned or initialized. For example
     * variable assignment, object literal instantiation, variable
     * initialization, object member assignment.
     * 
     * The code location is taken from the current stack.
     * 
     * @param lhs
     *            The object in which the slot is being assigned.
     * @param slotName
     *            The name of the slot being assigned (String or Integer)
     * @param rhs
     *            The value that is being assigned or initialized.
     */
    public void storeLocation(Object lhs, Object slotName, Object rhs) {
        CodeLocation location;
        if (rhs instanceof CodeLocation) {
            location = (CodeLocation) rhs;
            rhs = null;
        } else {
            location = getCodeLocation();
        }
        storeLocation(lhs, slotName, rhs, location);
    }

    public void storeLocation(Object lhs, Object slotName, Object rhs, CodeLocation location) {
        for (ExecutionListener l : executionListeners) {
            l.slotAssigned(lhs, slotName, rhs, location);
        }
    }
    ...
    static String getSourcePositionFromStack(int[] linep) {
        ...
        return cx.getSourcePositionFromStack2(linep);
    }

    protected String getSourcePositionFromStack2(int[] linep) {
        if (lastInterpreterFrame != null) {
            Evaluator evaluator = createInterpreter();
            if (evaluator != null)
                return evaluator.getSourcePositionFromStack(this, linep);
        }
        /**
    ...
    RegExpProxy getRegExpProxy()
    {
        if (regExpProxy == null) {
            Class<?> cl = Kit.classOrNull(
                          "com.nexj.njsdoc.org.mozilla.javascript.regexp.RegExpImpl");
            if (cl != null) {
...
// The method must NOT be public or protected
    ...
    private void loadCommentLocationMap(final AstRoot ast, final String file) {
        ast.visit(new NodeVisitor() {
            public boolean visit(AstNode node) {
                Comment c = node.getJsDocNode();
                if (c != null) {
                    for (int i = node.getLineno(), start = c.getLineno();i >= start; i--) {
                        for (ExecutionListener l : executionListeners) {
                            l.storeComment(c.getValue(), new CodeLocation(file, i));
                        }
                    }
                }
                return true;
    ...
    private List<ExecutionListener> executionListeners = new ArrayList<ExecutionListener>(2);
}
