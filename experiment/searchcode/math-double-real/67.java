...
public class complex {
    ...
    /**
     * Initializes a new complex number with real part Real and imagenary part Imag, casting from double to float
     */
    ...
    /**
     * initializes a float as a complex number
     */
    ...
    /**
     * initializes a double as a complex number ( caste to float )
     */
    ...
    /**
     * This multiplies two complex numbers, storing result here.
     */
    public complex timeseq(complex n) {
        float x4 = real * n.real ;
        float x5 = imag * n.imag ;
        real = x4 - x5 ;
        imag = ( real + imag ) * ( n.real + n.imag ) - x4 - x5 ;
        return this;
    }
