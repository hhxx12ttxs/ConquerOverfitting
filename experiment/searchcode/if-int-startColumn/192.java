...
public final class GridPrint implements Print {
	 ...
	 * @param spacing
	 *            the spacing (in points) between grid cells.
	 * @see #BORDER_OVERLAP
	 * @deprecated use GridPrint(String) instead, then set a DefaultGridLook on
	 ...
	 *            the horizontal spacing (in points) between grid cells.
	 * @param verticalSpacing
	 *            the vertical spacing (in points) between grid cells.
	 * @see GridColumn#parse(String)
	 * @see #BORDER_OVERLAP
	 * @deprecated use GridPrint(String) instead, then set a DefaultGridLook on
	 *             the grid with the desired cell spacing.
	 ...
	 *            the spacing (in points) between grid cells.
	 * @see #BORDER_OVERLAP
	 * @deprecated use GridPrint(GridColumn[]) instead, then set a
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((defaultLook == null) ? 0 : defaultLook.hashCode());
	 ...
	 *            One of {@link SWT#DEFAULT} , {@link SWT#LEFT},
	 *            {@link SWT#CENTER} or {@link SWT#RIGHT}.
	 * @deprecated Use {@link #addHeader(int, Print, int)} instead. GridPrint's
	...
	/**
	 * Returns the background color of the header cells (defaults to the body
	 * background if null).
	 * 
	 * @return the background color of the header cells (defaults to the body
	 *         background if null).
	 ...
	 *            null).
	 * @deprecated this functionality has been moved to DefaultGridLook. Set a
	 ...
	 *            One of {@link SWT#DEFAULT} , {@link SWT#LEFT},
	 *            {@link SWT#CENTER} or {@link SWT#RIGHT}.
	 * @deprecated Use {@link #add(int, Print, int)} instead. GridPrint's add
	...
	/**
	 * Returns the background color of the body cells (no background color if
	 * null).
	 * 
	 * @return the background color of the body cells (no background color if
	 *         null).
	 * @deprecated this functionality has been moved to DefaultGridLook.
	 */
	 ...
	 *            the new background color (no background is drawn if null).
	 * @deprecated this functionality has been moved to DefaultGridLook. Set a
	 ...
	 *            One of {@link SWT#DEFAULT} , {@link SWT#LEFT},
	 *            {@link SWT#CENTER} or {@link SWT#RIGHT}.
	 * @deprecated Use {@link #addFooter(int, Print, int)} instead. GridPrint's
	 ...
	 * 
	 * @return the background color of the footer cells (defaults to body
	 *         background if null).
	...
	private int add(
		...
		if (startColumn > columns.size()) {
			...
			PaperClips.error(SWT.ERROR_INVALID_ARGUMENT,
					"Colspan " + colspan + " too wide at column " //$NON-NLS-1$ //$NON-NLS-2$
							+ startColumn
							+ " (" + columns.size() + " columns total)"); //$NON-NLS-1$//$NON-NLS-2$
		}
	 ...
	 * 
	 * @param horizontalSpacing
	 *            the new horizontal spacing. A value of {@link #BORDER_OVERLAP}
	...
	public void setHorizontalSpacing(int horizontalSpacing) {
		defaultLook.setCellSpacing(horizontalSpacing, defaultLook
				.getCellSpacing().y);
	}
	 ...
	 * 
	 * @param verticalSpacing
	 *            the new vertical spacing. A value of {@link #BORDER_OVERLAP}
	 *            indicates that the borders should be overlapped instead of
	 *            spaced.
	 * @deprecated this functionality has been moved to DefaultGridLook. Set a
	 *             DefaultGridLook on the grid, then call setCellSpacing(Point)
	...
	public void setVerticalSpacing(int verticalSpacing) {
		defaultLook.setCellSpacing(defaultLook.getCellSpacing().x,
				verticalSpacing);
	}
