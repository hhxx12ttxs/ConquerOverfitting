...
public class Base64 {
	...
	public static String encodeString(String source, int options)
			throws java.io.IOException {
		return encodeBytes(source.getBytes(), 0, source.getBytes().length,
				options);
	} // end encodeBytes
	...
	public static String decodetoString(String s) throws java.io.IOException {
		return decodetoString(s, NO_OPTIONS);
	}

	public static String decodetoString(String s, int options)
			throws java.io.IOException {
		return new String(decode(s, options));
	}
