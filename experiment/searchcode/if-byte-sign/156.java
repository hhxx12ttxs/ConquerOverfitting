  	...
  	class keyThread extends Thread{
  		...
  		public void run(){
  			try {
				...
				System.out.println("Server's Private KeyŁş" + byteToBinary(serverKeyRSA.getPrivateKey().getEncoded()) + "\n");
				System.out.println("Server's Public KeyŁş" + byteToBinary(serverKeyRSA.getPublicKey().getEncoded()) + "\n");
				System.out.println("Client's Public KeyŁş" + byteToBinary(clientPBK.getEncoded()) + "\n");
				System.out.println("DES KeyŁş" + byteToBinary(keyDES.getEncoded()) + "\n");
