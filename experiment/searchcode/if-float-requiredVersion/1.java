...
public class SystemUtil {
    ...
    public static final class OsInfo {
        ...
        private final String  FILE_ENCODING      = getCanonicalCharset(new OutputStreamWriter(
    ...
    public static final class HostInfo {
        ...
        private final String NET_WORK_ADDRESS;
        /**
         * 防止从外界创建此对象。
         */
        private HostInfo() {
            ...
            NET_WORK_ADDRESS=netWorkAddress;
        }
            ...
            try{
                ...
                while(enumeration.hasMoreElements()){
                    ...
                    for (InterfaceAddress address :interface1.getInterfaceAddresses()) {
                        if(!"127.0.0.1".equals(address.getAddress().getHostAddress())&&!(address.getAddress().getHostAddress().contains(":"))) {
                            addressString+=address.getAddress().toString();
                        }
                    }
                }
                if(addressString.length()>13)
//                    return StringUtil.split(addressString,"/")[0];
         ...
         * 获取当前主机到外部IP
         * <p>
         * 例如：<code>"192.168.1.110"</code>
         * </p>
         *
         * @return 主机地址
         */
        public final String getNewWorkAddress(){
            return NET_WORK_ADDRESS;
        }
        ...
        public final String toString() {
            ...
            append(buffer, "Net Work Host Address: ", getNewWorkAddress());
    ...
    private static void append(StringBuffer buffer, String caption, String value) {
        buffer.append(caption).append(defaultIfNull(StringEscapeUtils.escapeJava(value), "[n/a]"))
            .append("\n");
    }
