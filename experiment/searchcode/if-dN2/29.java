...
{
	private static final String DN1 = "1.3.6.1.4.1.42.2.11.2.1=127.0.0.1, CN=Tomasz Hajto+CN=Tomasz Wa?doch,C=PL";
	...
	public void testPrint()
	{
		...
		assertEquals("IP=127.0.0.1,CN=Tomasz Hajto+CN=Tomasz Wa?doch,C=PL", rf);
