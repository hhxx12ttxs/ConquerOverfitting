...
public class MaxentEvaluation {
	...
	public static List<String> computeOptimalOrdering(List<String> data, List<String> poss, CorpusData cd, String head, Reranker<List<String>> r,
		...
		Map<List<String>, List<IValued<String>>> map = new HashMap<List<String>, List<IValued<String>>>();
		Set<List<String>> set = PermutationGenerator.permute(data);
		...
		List<String> best = new ArrayList<List<String>>(set).get(random.nextInt(set.size()));
		for (List<String> perm : set) {
