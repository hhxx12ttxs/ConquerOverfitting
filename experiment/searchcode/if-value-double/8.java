...
public class PurchaseEditOrderActivity extends ListActivity {
...
//        productHash = (HashMap<String, String>)this.getIntent().getSerializableExtra("item");  
    ...
    private void setListener(){
    	...
    	btn_Back.setOnClickListener(new View.OnClickListener() {			
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
//				i = new Intent(PurchaseEditOrderActivity.this,TabView.class);
...
//		    	startActivity(i);
    	...
    	btn_Cancel.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (!m_orders.isEmpty()){
					...
					ToastUtil.getCustomToast(PurchaseEditOrderActivity.this,getString(R.string.warning_empty_list));
				}
    	...
    	btn_Add.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				i = new Intent(PurchaseEditOrderActivity.this,PurchaseEditProductActivity.class);
		    	startActivity(i);
		    	finish();
			}
		});
			...
			public void onClick(View v) {
				...
				if (vaildate()){
					if (saveOrder()) {
						...
						((BigDealApplication)getApplication()).setStatus(0);
						ToastUtil.getCustomToast(PurchaseEditOrderActivity.this,getString(R.string.info_sucess));
//				    	i = new Intent(PurchaseEditOrderActivity.this,TabView.class);
//				    	i.putExtra("activateTab", "1");
//				    	startActivity(i);
						finish();
    ...
    private void cancelAlert() {
		AlertDialog.Builder dialog=new AlertDialog.Builder(PurchaseEditOrderActivity.this);
    ...
    private void cancelList(){
    	mDbHelper.cancelResumePurchase(TV_InvoiceNo.getText().toString(),"Canceled");
    	((BigDealApplication)getApplication()).setList(new ArrayList<HashMap<String, String>>());
    	((BigDealApplication)getApplication()).setPosition(-1);
    	((BigDealApplication)getApplication()).setStatus(0);      	
    	i = new Intent(PurchaseEditOrderActivity.this,PurchaseActivity.class);
    	startActivity(i);
    	finish();
    ...
    private boolean vaildate(){
        ...
        if (StringTools.toDate(TV_Date.getText().toString(), "yyyy-MM-dd").compareTo(StringTools.toDate(TV_DueDate.getText().toString(), "yyyy-MM-dd"))>0){
    ...
    private boolean saveOrder(){
    	...
    	for (int i=0;i<orders.size();i++){
    		...
    		System.out.println("product_id:"+productitem.get("product_id"));
    	...
    	return mDbHelper.updatePurchase(purchase);
    ...
    public void email(){
	    ...
	    if (mDbHelper.updatePurchase(purchase)){
			((BigDealApplication)getApplication()).setList(new ArrayList<HashMap<String, String>>());
			((BigDealApplication)getApplication()).setPosition(0);
			((BigDealApplication)getApplication()).setStatus(0);
