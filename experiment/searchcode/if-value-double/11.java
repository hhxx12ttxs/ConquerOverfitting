...
public class OrderCreateActivity extends ListActivity {
    ...
    private void setListener(){
    	...
    	btn_Back.setOnClickListener(new View.OnClickListener() {			
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
//				i = new Intent(OrderCreateActivity.this,TabView.class);
...
//		    	startActivity(i);
    	...
    	btn_Cancel.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (!m_orders.isEmpty()){
					...
					ToastUtil.getCustomToast(OrderCreateActivity.this,getString(R.string.warning_empty_list));
				}
    	...
    	btn_Add.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				i = new Intent(OrderCreateActivity.this,OrderProductCreateActivity.class);
		    	startActivity(i);
		    	finish();
			}
		});
			...
			public void onClick(View v) {
				...
				if (vaildate()){
					if (saveOrder()) {
						...
						((BigDealApplication)getApplication()).setStatus(0);
						ToastUtil.getCustomToast(OrderCreateActivity.this,getString(R.string.info_sucess));
//				    	i = new Intent(OrderCreateActivity.this,TabView.class);
//				    	i.putExtra("activateTab", "2");
//				    	startActivity(i);
						finish();
    ...
    private void cancelAlert() {
		AlertDialog.Builder dialog=new AlertDialog.Builder(OrderCreateActivity.this);
    ...
    private boolean saveOrder(){
    	...
    	purchaseNo.append("D").append(String.format("%010d", mDbHelper.fetchMaxSeqNo("orderHeader")));
    	...
    	return mDbHelper.insertOrder(purchase);
    ...
    public void email(){
		 ...
		 purchaseNo = new StringBuffer();
	     purchaseNo.append("D").append(String.format("%010d", mDbHelper.fetchMaxSeqNo("purchaseHeader")));
	    ...
	    if (mDbHelper.insertOrder(purchase)){
			((BigDealApplication)getApplication()).setList(new ArrayList<HashMap<String, String>>());
			((BigDealApplication)getApplication()).setPosition(0);
			((BigDealApplication)getApplication()).setStatus(0);
