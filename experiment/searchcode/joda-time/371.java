 ...
 */
package org.cakeframework.test.sisyphus.spi;
...
class InternalTestProgressPrinter extends Thread {
    ...
    void finished() {
        ...
        System.out.println("Total time " + InternalDurationFormatter.DEFAULT.formatNanos(dur) + ", avg time = "
                + InternalDurationFormatter.DEFAULT.formatNanos(avgNs));
    }
    ...
    static class InternalDurationFormatter implements Serializable {
        ...
        private static final String[] NAME = new String[] { "nanosecond", "microsecond", "millisecond", "second",
                "minute", "hour", "day" };
        ...
        public String formatNanos(long nanos) {
            if (nanos < MC_S) {
                ...
                return doFormat((int) (nanos / M), (int) (nanos / S % 60), (int) (nanos / MS % 1000), (int) (nanos
                        / MC_S % 1000), (int) (nanos % 1000));
            } else if (nanos < D) {
