...
package com.aelitis.azureus.geoip;
 ...
 *          2012/Nov/19: Added countryFlagName
 */
public class LookupService {
	...
	private final Country UNKNOWN_COUNTRY = new Country("N_A", "N/A",
			"flag_unknown");
	...
	private static final String[] countryCode = { "N_A", "AP", "EU", "AD",
			"AE", "AF", "AG", "AI", "AL", "AM", "CW", "AO", "AQ", "AR", "AS",
			...
			"FJ", "FK", "FM", "FO", "FR", "SX", "GA", "GB", "GD", "GE", "GF",
			...
			"TM", "TN", "TO", "TL", "TR", "TT", "TV", "TW", "TZ", "UA", "UG",
			"UM", "US", "UY", "UZ", "VA", "VC", "VE", "VG", "VI", "VN", "VU",
			"WF", "WS", "YE", "YT", "RS", "ZA", "ZM", "ME", "ZW", "A1", "A2",
			"O1", "AX", "GG", "IM", "JE", "BL", "MF", "BQ" };
	private static final String[] countryFlagName = { "flag_unknown",
			"flag_unknown", "flag_eu", "flag_ad", "flag_ae", "flag_af",
			"flag_ag", "flag_ai", "flag_al", "flag_am", "flag_unknown",
			"flag_ao", "flag_unknown", "flag_ar", "flag_as", "flag_at",
			"flag_au", "flag_aw", "flag_az", "flag_ba", "flag_bb", "flag_bd",
			"flag_be", "flag_bf", "flag_bg", "flag_bh", "flag_bi", "flag_bj",
			"flag_bm", "flag_bn", "flag_bo", "flag_br", "flag_bs", "flag_bt",
			"flag_unknown", "flag_bw", "flag_by", "flag_bz", "flag_ca",
			"flag_unknown", "flag_cd", "flag_cf", "flag_cg", "flag_ch",
			"flag_ci", "flag_ck", "flag_cl", "flag_cm", "flag_cn", "flag_co",
			"flag_cr", "flag_cu", "flag_cv", "flag_cx", "flag_cy", "flag_cz",
			"flag_de", "flag_dj", "flag_dk", "flag_dm", "flag_do", "flag_dz",
			"flag_ec", "flag_ee", "flag_eg", "flag_unknown", "flag_er",
			"flag_es", "flag_et", "flag_fi", "flag_fj", "flag_fk", "flag_fm",
			"flag_fo", "flag_fr", "flag_unknown", "flag_ga", "flag_gb",
			"flag_gd", "flag_ge", "flag_unknown", "flag_gh", "flag_gi",
			"flag_gl", "flag_gm", "flag_gn", "flag_unknown", "flag_gq",
			"flag_gr", "flag_gs", "flag_gt", "flag_gu", "flag_gw", "flag_gy",
			"flag_hk", "flag_unknown", "flag_hn", "flag_hr", "flag_ht",
			"flag_hu", "flag_id", "flag_ie", "flag_il", "flag_in",
			"flag_unknown", "flag_iq", "flag_ir", "flag_is", "flag_it",
			"flag_jm", "flag_jo", "flag_jp", "flag_ke", "flag_kg", "flag_kh",
			"flag_ki", "flag_km", "flag_kn", "flag_kp", "flag_kr", "flag_kw",
			"flag_ky", "flag_kz", "flag_la", "flag_lb", "flag_lc", "flag_li",
			"flag_lk", "flag_lr", "flag_ls", "flag_lt", "flag_lu", "flag_lv",
			"flag_ly", "flag_ma", "flag_mc", "flag_md", "flag_mg", "flag_mh",
			"flag_mk", "flag_ml", "flag_mm", "flag_mn", "flag_mo",
			"flag_unknown", "flag_mq", "flag_mr", "flag_ms", "flag_mt",
			"flag_mu", "flag_mv", "flag_mw", "flag_mx", "flag_my", "flag_mz",
			"flag_na", "flag_unknown", "flag_ne", "flag_nf", "flag_ng",
			"flag_ni", "flag_nl", "flag_no", "flag_np", "flag_nr", "flag_nu",
			"flag_nz", "flag_om", "flag_pa", "flag_pe", "flag_pf", "flag_pg",
			"flag_ph", "flag_pk", "flag_pl", "flag_pm", "flag_pn", "flag_pr",
			"flag_unknown", "flag_pt", "flag_pw", "flag_py", "flag_qa",
			"flag_unknown", "flag_ro", "flag_ru", "flag_rw", "flag_sa",
			"flag_sb", "flag_sc", "flag_sd", "flag_se", "flag_sg",
			"flag_unknown", "flag_si", "flag_unknown", "flag_sk", "flag_sl",
			"flag_sm", "flag_sn", "flag_so", "flag_sr", "flag_st", "flag_sv",
			"flag_sy", "flag_sz", "flag_tc", "flag_td", "flag_unknown",
			"flag_tg", "flag_th", "flag_tj", "flag_unknown", "flag_tm",
			"flag_tn", "flag_to", "flag_tl", "flag_tr", "flag_tt", "flag_tv",
			"flag_tw", "flag_tz", "flag_ua", "flag_ug", "flag_unknown",
			"flag_us", "flag_uy", "flag_uz", "flag_va", "flag_vc", "flag_ve",
			"flag_vg", "flag_vi", "flag_vn", "flag_vu", "flag_wf", "flag_ws",
			"flag_ye", "flag_unknown", "flag_rs", "flag_za", "flag_zm",
			"flag_me", "flag_zw", "flag_unknown", "flag_unknown",
			"flag_unknown", "flag_unknown", "flag_unknown", "flag_unknown",
			"flag_unknown", "flag_unknown", "flag_unknown", "flag_unknown" };
