...
//      showResultSet(statement.executeQuery(" Select * from RepTable"));
  ...
  public void startElement(String namespace, String localname, String qname, Attributes atts) throws SAXException {
    ...
    if ( (currentElement == null ||
          !currentElement.elementName.equalsIgnoreCase("operation")) &&
        qname.equalsIgnoreCase("tableName")) {
  ...
  public void endElement(String namespace, String localname, String qname) throws SAXException {
    try {
      ...
      if ( (parentElement == null ||
            parentElement.elementName.equalsIgnoreCase("tableName")) &&
          qname.equalsIgnoreCase("operation")) {
        if (currentElement.elementValue.equalsIgnoreCase(RepConstants.insert_operation)) {
          createInsertQuery();
//         Utility.insertCount++;
        }
        else if (currentElement.elementValue.equalsIgnoreCase(RepConstants.update_operation)) {
          createUpdateQuery();
        }
        else if (currentElement.elementValue.equalsIgnoreCase(RepConstants.delete_operation)) {
          createDeleteQuery();
        }
      }
      if ( (parentElement == null ||
            !parentElement.elementName.equalsIgnoreCase("operation")) &&
          qname.equalsIgnoreCase("tableName")) {
        try {
