...
import maicliant.event.block.GetBlockBrightnessEvent;
import maicliant.event.block.GetMixedBlockBrightnessEvent;
import maicliant.event.block.RenderAsNormalBlockEvent;
import maicliant.event.block.ShouldSideBeRenderedEvent;
...
public class Block
{
	...
	//TODO Events
	private RenderAsNormalBlockEvent renderAsNormalBlockEvent;
	private GetBlockBrightnessEvent getBlockBrightnessEvent;
	private GetMixedBlockBrightnessEvent getMixedBlockBrightnessEvent;
	private ShouldSideBeRenderedEvent shouldSideBeRenderedEvent;
    /**
    ...
    {
    	//TODO RenderAsNormalBlockEvent
    	if(!MaiWrapper.getEventHandler().IntensiveEnabled())return true;
    	this.renderAsNormalBlockEvent = new RenderAsNormalBlockEvent(true);
    	this.renderAsNormalBlockEvent.invokeEvent();
        return this.renderAsNormalBlockEvent.getRenderAsNormalBlock();
    }
    ...
    {
    	//TODO GetBlockBrightnessEvent
    	float f = par1IBlockAccess.getBrightness(par2, par3, par4, lightValue[par1IBlockAccess.getBlockId(par2, par3, par4)]);
    	if(!MaiWrapper.getEventHandler().IntensiveEnabled())return f;
    	this.getBlockBrightnessEvent = new GetBlockBrightnessEvent(f);
        this.getBlockBrightnessEvent.invokeEvent();
        return this.getBlockBrightnessEvent.getBlockBrightness();
    }
    ...
    {
    	//TODO GetMixedBlockBrightnessEvent
    	int i = par1IBlockAccess.getLightBrightnessForSkyBlocks(par2, par3, par4, lightValue[par1IBlockAccess.getBlockId(par2, par3, par4)]);
    	if(!MaiWrapper.getEventHandler().IntensiveEnabled())return i;
    	this.getMixedBlockBrightnessEvent = new GetMixedBlockBrightnessEvent(i);
    	this.getMixedBlockBrightnessEvent.invokeEvent();
        return this.getMixedBlockBrightnessEvent.getBlockBrightness();
    ...
    {
    	//TODO ShouldSideBeRenderedEvent
    	boolean flag = par5 == 0 && this.minY > 0.0D ? true : (par5 == 1 && this.maxY < 1.0D ? true : (par5 == 2 && this.minZ > 0.0D ? true : (par5 == 3 && this.maxZ < 1.0D ? true : (par5 == 4 && this.minX > 0.0D ? true : (par5 == 5 && this.maxX < 1.0D ? true : !par1IBlockAccess.isBlockOpaqueCube(par2, par3, par4))))));
        if(!MaiWrapper.getEventHandler().IntensiveEnabled())return flag;
    	this.shouldSideBeRenderedEvent = new ShouldSideBeRenderedEvent(this, flag);
        this.shouldSideBeRenderedEvent.invokeEvent();
    	return this.shouldSideBeRenderedEvent.getShouldSideBeRendered();
    }
