...
public class RenderBlocks
{
    ...
    private float getAmbientOcclusionLightValue(Block par1Block, int par2, int par3, int par4) {
    	...
    	return par1Block.getAmbientOcclusionLightValue(blockAccess, par2, par3, par4);
    }
    
    private float getBlockBrightness(Block par1Block, int par2, int par3, int par4) {
    	...
    	return par1Block.getBlockBrightness(blockAccess, par2, par3, par4);
    }
    
    private boolean shouldSideBeRendered(Block par1Block, int par2, int par3, int par4, int par5){
		
		try {
			if (CJB.modxray) 
			{
				if(mod_cjb_x_ray.xray){
					for(int n : CJB.blacklist)
					{   
						if(n == par1Block.blockID) return false;
					}
					if(CJB.blacklist.length != 0)
					{
						if(par1Block.blockID == 8 || par1Block.blockID == 9 || par1Block instanceof BlockGlass) return par1Block.shouldSideBeRendered(blockAccess, par2, par3, par4, par5);
						return true;
					}
				} else if(mod_cjb_x_ray.cave) {
					if (Math.abs(MathHelper.floor_double(ModLoader.getMinecraftInstance().thePlayer.posY) - par3) < 3) return false;
		...
		return par1Block.shouldSideBeRendered(blockAccess, par2, par3, par4, par5);
	}

    public boolean renderBlockByRenderType(Block par1Block, int par2, int par3, int par4)
    {
    	try {
			if(CJB.modxray && mod_cjb_x_ray.xray){
				
				for(int n : CJB.blacklist)
					if(n == par1Block.blockID) return false;
				
			} else 
			if(CJB.modxray && mod_cjb_x_ray.cave) {
				for(int n : CJB.blacklist){
					if(n == 1) continue;
					if(n == par1Block.blockID) return false;
				}
    ...
    public boolean renderBlockBed(Block par1Block, int par2, int par3, int par4)
    {
        ...
        if (l != 2 && (renderAllFaces || shouldSideBeRendered(par1Block, par2, par3, par4 - 1, 2)))
        {
        ...
        if (l != 3 && (renderAllFaces || shouldSideBeRendered(par1Block, par2, par3, par4 + 1, 3)))
        {
        ...
        if (l != 4 && (renderAllFaces || shouldSideBeRendered(par1Block, par2 - 1, par3, par4, 4)))
        {
        ...
        if (l != 5 && (renderAllFaces || shouldSideBeRendered(par1Block, par2 + 1, par3, par4, 5)))
        {
    ...
    public boolean renderPistonExtension(Block par1Block, int par2, int par3, int par4, boolean par5)
    {
        ...
        float f = getBlockBrightness(par1Block, par2, par3, par4);
    ...
    public boolean renderBlockFluids(Block par1Block, int par2, int par3, int par4)
    {
        ...
        boolean flag = shouldSideBeRendered(par1Block, par2, par3 + 1, par4, 1);
        boolean flag1 = shouldSideBeRendered(par1Block, par2, par3 - 1, par4, 0);
        boolean aflag[] =
        {
            shouldSideBeRendered(par1Block, par2, par3, par4 - 1, 2), shouldSideBeRendered(par1Block, par2, par3, par4 + 1, 3), shouldSideBeRendered(par1Block, par2 - 1, par3, par4, 4), shouldSideBeRendered(par1Block, par2 + 1, par3, par4, 5)
        };
    ...
    public boolean renderStandardBlockWithAmbientOcclusion(Block par1Block, int par2, int par3, int par4, float par5, float par6, float par7)
    {
        ...
        boolean flag5 = true;
        boolean flag6 = true;
        lightValueOwn = getAmbientOcclusionLightValue(par1Block, par2, par3, par4);
        aoLightValueXNeg = getAmbientOcclusionLightValue(par1Block, par2 - 1, par3, par4);
        aoLightValueYNeg = getAmbientOcclusionLightValue(par1Block, par2, par3 - 1, par4);
        aoLightValueZNeg = getAmbientOcclusionLightValue(par1Block, par2, par3, par4 - 1);
        aoLightValueXPos = getAmbientOcclusionLightValue(par1Block, par2 + 1, par3, par4);
        aoLightValueYPos = getAmbientOcclusionLightValue(par1Block, par2, par3 + 1, par4);
        aoLightValueZPos = getAmbientOcclusionLightValue(par1Block, par2, par3, par4 + 1);
        ...
        if (renderAllFaces || shouldSideBeRendered(par1Block, par2, par3 - 1, par4, 0))
        {
            float f1;
            float f8;
            float f15;
            ...
            if (aoType > 0)
            {
                ...
                aoLightValueScratchXYNN = getAmbientOcclusionLightValue(par1Block, par2 - 1, par3, par4);
                aoLightValueScratchYZNN = getAmbientOcclusionLightValue(par1Block, par2, par3, par4 - 1);
                aoLightValueScratchYZNP = getAmbientOcclusionLightValue(par1Block, par2, par3, par4 + 1);
                aoLightValueScratchXYPN = getAmbientOcclusionLightValue(par1Block, par2 + 1, par3, par4);
                ...
                {
                    aoLightValueScratchXYZNNN = getAmbientOcclusionLightValue(par1Block, par2 - 1, par3, par4 - 1);
                ...
                {
                    aoLightValueScratchXYZNNP = getAmbientOcclusionLightValue(par1Block, par2 - 1, par3, par4 + 1);
                ...
                {
                    aoLightValueScratchXYZPNN = getAmbientOcclusionLightValue(par1Block, par2 + 1, par3, par4 - 1);
                ...
                {
                    aoLightValueScratchXYZPNP = getAmbientOcclusionLightValue(par1Block, par2 + 1, par3, par4 + 1);
        ...
        if (renderAllFaces || shouldSideBeRendered(par1Block, par2, par3 + 1, par4, 1))
        {
            float f2;
            float f9;
            float f16;
            ...
            if (aoType > 0)
            {
                ...
                aoLightValueScratchXYNP = getAmbientOcclusionLightValue(par1Block, par2 - 1, par3, par4);
                aoLightValueScratchXYPP = getAmbientOcclusionLightValue(par1Block, par2 + 1, par3, par4);
                aoLightValueScratchYZPN = getAmbientOcclusionLightValue(par1Block, par2, par3, par4 - 1);
                aoLightValueScratchYZPP = getAmbientOcclusionLightValue(par1Block, par2, par3, par4 + 1);
                ...
                {
                    aoLightValueScratchXYZNPN = getAmbientOcclusionLightValue(par1Block, par2 - 1, par3, par4 - 1);
                ...
                {
                    aoLightValueScratchXYZPPN = getAmbientOcclusionLightValue(par1Block, par2 + 1, par3, par4 - 1);
                ...
                {
                    aoLightValueScratchXYZNPP = getAmbientOcclusionLightValue(par1Block, par2 - 1, par3, par4 + 1);
                ...
                {
                    aoLightValueScratchXYZPPP = getAmbientOcclusionLightValue(par1Block, par2 + 1, par3, par4 + 1);
        ...
        if (renderAllFaces || shouldSideBeRendered(par1Block, par2, par3, par4 - 1, 2))
        {
            float f3;
            float f10;
            float f17;
            ...
            if (aoType > 0)
            {
                ...
                aoLightValueScratchXZNN = getAmbientOcclusionLightValue(par1Block, par2 - 1, par3, par4);
                aoLightValueScratchYZNN = getAmbientOcclusionLightValue(par1Block, par2, par3 - 1, par4);
                aoLightValueScratchYZPN = getAmbientOcclusionLightValue(par1Block, par2, par3 + 1, par4);
                aoLightValueScratchXZPN = getAmbientOcclusionLightValue(par1Block, par2 + 1, par3, par4);
                ...
                {
                    aoLightValueScratchXYZNNN = getAmbientOcclusionLightValue(par1Block, par2 - 1, par3 - 1, par4);
                ...
                {
                    aoLightValueScratchXYZNPN = getAmbientOcclusionLightValue(par1Block, par2 - 1, par3 + 1, par4);
                ...
                {
                    aoLightValueScratchXYZPNN = getAmbientOcclusionLightValue(par1Block, par2 + 1, par3 - 1, par4);
                ...
                {
                    aoLightValueScratchXYZPPN = getAmbientOcclusionLightValue(par1Block, par2 + 1, par3 + 1, par4);
        ...
        if (renderAllFaces || shouldSideBeRendered(par1Block, par2, par3, par4 + 1, 3))
        {
            float f4;
            float f11;
            float f18;
            ...
            if (aoType > 0)
            {
                ...
                aoLightValueScratchXZNP = getAmbientOcclusionLightValue(par1Block, par2 - 1, par3, par4);
                aoLightValueScratchXZPP = getAmbientOcclusionLightValue(par1Block, par2 + 1, par3, par4);
                aoLightValueScratchYZNP = getAmbientOcclusionLightValue(par1Block, par2, par3 - 1, par4);
                aoLightValueScratchYZPP = getAmbientOcclusionLightValue(par1Block, par2, par3 + 1, par4);
                ...
                {
                    aoLightValueScratchXYZNNP = getAmbientOcclusionLightValue(par1Block, par2 - 1, par3 - 1, par4);
                ...
                {
                    aoLightValueScratchXYZNPP = getAmbientOcclusionLightValue(par1Block, par2 - 1, par3 + 1, par4);
                ...
                {
                    aoLightValueScratchXYZPNP = getAmbientOcclusionLightValue(par1Block, par2 + 1, par3 - 1, par4);
                ...
                {
                    aoLightValueScratchXYZPPP = getAmbientOcclusionLightValue(par1Block, par2 + 1, par3 + 1, par4);
        ...
        if (renderAllFaces || shouldSideBeRendered(par1Block, par2 - 1, par3, par4, 4))
        {
            float f5;
            float f12;
            float f19;
            ...
            if (aoType > 0)
            {
                ...
                aoLightValueScratchXYNN = getAmbientOcclusionLightValue(par1Block, par2, par3 - 1, par4);
                aoLightValueScratchXZNN = getAmbientOcclusionLightValue(par1Block, par2, par3, par4 - 1);
                aoLightValueScratchXZNP = getAmbientOcclusionLightValue(par1Block, par2, par3, par4 + 1);
                aoLightValueScratchXYNP = getAmbientOcclusionLightValue(par1Block, par2, par3 + 1, par4);
                ...
                {
                    aoLightValueScratchXYZNNN = getAmbientOcclusionLightValue(par1Block, par2, par3 - 1, par4 - 1);
                ...
                {
                    aoLightValueScratchXYZNNP = getAmbientOcclusionLightValue(par1Block, par2, par3 - 1, par4 + 1);
                ...
                {
                    aoLightValueScratchXYZNPN = getAmbientOcclusionLightValue(par1Block, par2, par3 + 1, par4 - 1);
                ...
                {
                    aoLightValueScratchXYZNPP = getAmbientOcclusionLightValue(par1Block, par2, par3 + 1, par4 + 1);
        ...
        if (renderAllFaces || shouldSideBeRendered(par1Block, par2 + 1, par3, par4, 5))
        {
            float f6;
            float f13;
            float f20;
            ...
            if (aoType > 0)
            {
                ...
                aoLightValueScratchXYPN = getAmbientOcclusionLightValue(par1Block, par2, par3 - 1, par4);
                aoLightValueScratchXZPN = getAmbientOcclusionLightValue(par1Block, par2, par3, par4 - 1);
                aoLightValueScratchXZPP = getAmbientOcclusionLightValue(par1Block, par2, par3, par4 + 1);
                aoLightValueScratchXYPP = getAmbientOcclusionLightValue(par1Block, par2, par3 + 1, par4);
                ...
                {
                    aoLightValueScratchXYZPNN = getAmbientOcclusionLightValue(par1Block, par2, par3 - 1, par4 - 1);
                ...
                {
                    aoLightValueScratchXYZPNP = getAmbientOcclusionLightValue(par1Block, par2, par3 - 1, par4 + 1);
                ...
                {
                    aoLightValueScratchXYZPPN = getAmbientOcclusionLightValue(par1Block, par2, par3 + 1, par4 - 1);
                ...
                {
                    aoLightValueScratchXYZPPP = getAmbientOcclusionLightValue(par1Block, par2, par3 + 1, par4 + 1);
