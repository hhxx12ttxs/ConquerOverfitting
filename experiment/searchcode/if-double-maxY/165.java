...
public class Block
{
     ...
     * MODIF Block: harvestBlock(World par1World, EntityPlayer par2EntityPlayer, int par3, int par4, int par5, int par6)
     */
    public void harvestBlock(World par1World, EntityPlayer par2EntityPlayer, int par3, int par4, int par5, int par6)
    {
    	this.destroyer = par2EntityPlayer;
        par2EntityPlayer.addStat(StatList.mineBlockStatArray[blockID], 1);
        par2EntityPlayer.addExhaustion(0.025F); 
        Random rand;
        if ((func_50074_q() && EnchantmentHelper.getSilkTouchModifier(par2EntityPlayer.inventory)) 
        		|| (par1World.rand.nextInt(20) == 0 && par2EntityPlayer.isSkillActive(TKHSkill.silkTouch)))
        { 
