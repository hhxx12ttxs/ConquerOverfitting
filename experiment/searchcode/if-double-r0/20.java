 ...
 */
public class GeodesicAlgorithmExact extends GeodesicAlgorithmBase {
    ...
    m_edge_interval_lists(mesh->edges().size())
    {
        ...
        for(long i=0; i<m_edge_interval_lists.size(); ++i)
        {
...
/*    for(unsigned i=0; i<m_edge_interval_lists.size(); ++i)
    ...
    long best_source(SurfacePoint& point,    //quickly find what source this point belongs to and what is the distance to this source
    ...
    long compute_propagated_parameters(double pseudo_x,
                                           double pseudo_y,
                                           ...
                                           boolean first_interval,    //if it is the first interval on the edge
    ...
    void construct_propagated_intervals(boolean invert,
                                        edge_pointer edge,
    ...
    long intersect_intervals(interval_pointer zero,
    ...
    boolean check_stop_conditions(long& index)
    {
    ...
    boolean erase_from_queue(interval_pointer p)
    {
    ...
    long m_queue_max_size;    //used for statistics
    long m_iterations;        //used for statistics
