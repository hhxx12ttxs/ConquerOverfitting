package sirentropy.weaponry.cannon;
...
public class Cannonball extends EntityThrowable {
	...
	public Cannonball(World par1World) {
		super(par1World);
		this.fuse = 0;
	...
	public Cannonball(World world, double x, double y, double z, float rotationYaw, float rotationPitch, double velocity) {
        ...
        this.motionY = (double)(-MathHelper.sin((this.rotationPitch + this.func_40074_d()) / 180.0F * (float)Math.PI) * velocity);
	}
