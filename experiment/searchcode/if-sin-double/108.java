...
package org.vaadin.virkki.paperstack.client.canvas.client.impl.ie;
...
import org.vaadin.virkki.paperstack.client.canvas.client.impl.CanvasImpl;
...
public class CanvasImplIE extends CanvasImpl {
    ...
    protected native void insert(String where, String html) /*-{
		this.@org.vaadin.virkki.paperstack.client.canvas.client.impl.CanvasImpl::element.insertAdjacentHTML(where, html);
	}-*/;
