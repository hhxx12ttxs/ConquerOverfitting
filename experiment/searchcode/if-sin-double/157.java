...
public abstract class EntityPlayer extends EntityLiving implements ICommandSender
{
    ...
    public int swingProgressIntLeft = 0;
    ...
    protected void updateEntityActionState()
    {
        ...
        if (this.isSwingingLeft) {
            ++this.swingProgressIntLeft;
            if (this.swingProgressIntLeft >= var1) {
                this.swingProgressIntLeft = 0;
                this.isSwingingLeft = false;
            }
        }
        else this.swingProgressIntLeft = 0;

        this.swingProgressLeft = (float)this.swingProgressIntLeft / (float)var1;
    }
     ...
     */
    // TODO: DUAL WIELD
    public void swingItemLeft()
    {
        if (!this.isSwingingLeft || this.swingProgressIntLeft >= this.getSwingSpeedModifier() / 2 || this.swingProgressIntLeft < 0)
        {
            this.swingProgressIntLeft = -1;
