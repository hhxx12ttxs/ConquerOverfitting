    ...
    implements org.apache.turbine.om.Retrievable
{
    ...
    public Object getByPeerName(String name)
    {
          ...
          if (name.equals(InboxEventPeer.CUSTOMER_ID))
        {
          ...
          if (name.equals(InboxEventPeer.CONTACT_ID))
        {
                return new Integer(getContactId());
            }
          ...
          if (name.equals(InboxEventPeer.SENDER_CC))
        {
          ...
          if (name.equals(InboxEventPeer.CUSTOM_1))
        {
                return getCustom1();
            }
          if (name.equals(InboxEventPeer.CUSTOM_2))
        {
                return getCustom2();
            }
          if (name.equals(InboxEventPeer.CUSTOM_3))
        {
                return getCustom3();
            }
          if (name.equals(InboxEventPeer.CUSTOM_4))
        {
                return getCustom4();
            }
          if (name.equals(InboxEventPeer.CUSTOM_5))
        {
                return getCustom5();
            }
          if (name.equals(InboxEventPeer.CUSTOM_6))
        {
                return getCustom6();
            }
