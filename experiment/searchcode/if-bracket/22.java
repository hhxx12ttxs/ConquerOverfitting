...
public class JEditTextArea extends JComponent {
	...
	/**
	 * Sets the document's UndoManager. Equivalent to caling
	 * <code>getDocument().setUndoManager()</code>.
	 *
	 * @param tokenMarker The UndoManager
	 */
	public final void setUndoManager(UndoManager undo) {
		document.setUndoManager(undo);
	}
