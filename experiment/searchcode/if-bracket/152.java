...
public class Stubs {
  ...
  /**
     * Write stubs and api.
     * 
     * @param stubsDir the stubs dir
     * @param apiFile the api file
     * @param keepListFile the keep list file
     * @param stubPackages the stub packages
     */
  ...
  /**
     ...
     * 
     * @param cl the cl
     * @param notStrippable the not strippable
     * @param why the why
     */
...
static void writeMethod(PrintStream stream, MethodInfo method, boolean isConstructor) {
  ...
  static String superCtorCall(ClassInfo cl, ArrayList<ClassInfo> thrownExceptions) {
     ...
     * @param isDeprecated the is deprecated {@code @deprecated} in their
     *            documentation but fail to add {@code @Deprecated} as an
     *            annotation.
     *            <p>
...
public static void writeXml(PrintStream xmlWriter, Collection<PackageInfo> pkgs) {
  ...
  /**
     * Write api.
     * 
     * @param apiWriter the api writer
     * @param pkgs the pkgs
     */
...
static void writeThrowsApi(PrintStream apiWriter, ArrayList<ClassInfo> exceptions) {
  ...
  /**
     * Write keep list.
     * 
     * @param keepListWriter the keep list writer
     * @param allClasses the all classes
     * @param notStrippable the not strippable
     */
