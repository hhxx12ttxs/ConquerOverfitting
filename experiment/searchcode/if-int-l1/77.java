    ...
    protected void updateEntityActionState()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            if (this.entityToAttack == null && !this.hasPath())
            {
                ...
                {
                    // CraftBukkit start
                    if (CraftEventFactory.callEntityChangeBlockEvent(this, i + Facing.offsetsXForSide[l1], j + Facing.offsetsYForSide[l1], k + Facing.offsetsZForSide[l1], Block.silverfish.blockID, BlockSilverfish.getMetadataForBlockType(l)).isCancelled())
                    {
                        return;
                    }
