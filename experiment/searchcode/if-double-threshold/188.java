...
public final class XMLEntityCodec
{
    ...
    private static class Entities
    {
        ...
        static final String[][] ISO8859_1_ARRAY =
        {
            ...
            {"copy", "169"}, // Š - copyright sign
            {"ordf", "170"}, //feminine ordinal indicator
            {"laquo", "171"}, //left-pointing double angle quotation mark = left pointing guillemet
            {"not", "172"}, //not sign
            {"shy", "173"}, //soft hyphen = discretionary hyphen
            {"reg", "174"}, // Ž - registered trademark sign
            ...
            {"Agrave", "192"}, // Ŕ - uppercase A, grave accent
            {"Aacute", "193"}, // Á - uppercase A, acute accent
            {"Acirc", "194"}, // Â - uppercase A, circumflex accent
            {"Atilde", "195"}, // Ă - uppercase A, tilde
            {"Auml", "196"}, // Ä - uppercase A, umlaut
            {"Aring", "197"}, // Ĺ - uppercase A, ring
            {"AElig", "198"}, // Ć - uppercase AE
            {"Ccedil", "199"}, // Ç - uppercase C, cedilla
            {"Egrave", "200"}, // Č - uppercase E, grave accent
            {"Eacute", "201"}, // É - uppercase E, acute accent
            {"Ecirc", "202"}, // Ę - uppercase E, circumflex accent
            {"Euml", "203"}, // Ë - uppercase E, umlaut
            {"Igrave", "204"}, // Ě - uppercase I, grave accent
            {"Iacute", "205"}, // Í - uppercase I, acute accent
            {"Icirc", "206"}, // Î - uppercase I, circumflex accent
            {"Iuml", "207"}, // Ď - uppercase I, umlaut
            {"ETH", "208"}, // Đ - uppercase Eth, Icelandic
            {"Ntilde", "209"}, // Ń - uppercase N, tilde
            {"Ograve", "210"}, // Ň - uppercase O, grave accent
            {"Oacute", "211"}, // Ó - uppercase O, acute accent
            {"Ocirc", "212"}, // Ô - uppercase O, circumflex accent
            {"Otilde", "213"}, // Ő - uppercase O, tilde
            {"Ouml", "214"}, // Ö - uppercase O, umlaut
            {"times", "215"}, //multiplication sign
            {"Oslash", "216"}, // Ř - uppercase O, slash
            {"Ugrave", "217"}, // Ů - uppercase U, grave accent
            {"Uacute", "218"}, // Ú - uppercase U, acute accent
            {"Ucirc", "219"}, // Ű - uppercase U, circumflex accent
            {"Uuml", "220"}, // Ü - uppercase U, umlaut
            {"Yacute", "221"}, // Ý - uppercase Y, acute accent
            {"THORN", "222"}, // Ţ - uppercase THORN, Icelandic
            {"szlig", "223"}, // ß - lowercase sharps, German
            {"agrave", "224"}, // ŕ - lowercase a, grave accent
            {"aacute", "225"}, // á - lowercase a, acute accent
            {"acirc", "226"}, // â - lowercase a, circumflex accent
            {"atilde", "227"}, // ă - lowercase a, tilde
            {"auml", "228"}, // ä - lowercase a, umlaut
            {"aring", "229"}, // ĺ - lowercase a, ring
            {"aelig", "230"}, // ć - lowercase ae
            {"ccedil", "231"}, // ç - lowercase c, cedilla
            {"egrave", "232"}, // č - lowercase e, grave accent
            {"eacute", "233"}, // é - lowercase e, acute accent
            {"ecirc", "234"}, // ę - lowercase e, circumflex accent
            {"euml", "235"}, // ë - lowercase e, umlaut
            {"igrave", "236"}, // ě - lowercase i, grave accent
            {"iacute", "237"}, // í - lowercase i, acute accent
            {"icirc", "238"}, // î - lowercase i, circumflex accent
            {"iuml", "239"}, // ď - lowercase i, umlaut
            {"eth", "240"}, // đ - lowercase eth, Icelandic
            {"ntilde", "241"}, // ń - lowercase n, tilde
            {"ograve", "242"}, // ň - lowercase o, grave accent
            {"oacute", "243"}, // ó - lowercase o, acute accent
            {"ocirc", "244"}, // ô - lowercase o, circumflex accent
            {"otilde", "245"}, // ő - lowercase o, tilde
            {"ouml", "246"}, // ö - lowercase o, umlaut
            {"divide", "247"}, // division sign
            {"oslash", "248"}, // ř - lowercase o, slash
            {"ugrave", "249"}, // ů - lowercase u, grave accent
            {"uacute", "250"}, // ú - lowercase u, acute accent
            {"ucirc", "251"}, // ű - lowercase u, circumflex accent
            {"uuml", "252"}, // ü - lowercase u, umlaut
            {"yacute", "253"}, // ý - lowercase y, acute accent
            {"thorn", "254"}, // ţ - lowercase thorn, Icelandic
