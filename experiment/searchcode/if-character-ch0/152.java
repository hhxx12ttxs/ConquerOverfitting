...
public abstract class LWUITImplementation {
    ...
    private boolean builtinSoundEnabled;
     ...
     */
    public VideoComponent createVideoPeer(Object videoInfo, String type) throws IOException {
        throw new IllegalArgumentException(videoInfo.getClass().getName());
    }
