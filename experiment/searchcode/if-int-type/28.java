package com.objectwave.persist.jdo;
...
import java.io.*;
/**
 * Originally created by org.apache.bcel.util.BCELifier.
 * @author Dave Hoag
 * @version $Id: PersistenceBaseCreator.java,v 1.8 2005/02/08 02:58:44 dave_hoag Exp $
 */
public class PersistenceBaseCreator implements Constants {
  private InstructionFactory _factory;
  private ConstantPoolGen    _cp;
  private ClassGen           _cg;
    private String thisClassName = "com.objectwave.persist.jdo.PersistenceBase";
    private String superclassName = "com.objectwave.persist.jdo.PlaceholderClass";
...
/* my code */
    ...
    public void addPersistentInterfaces()
    {
        ...
        _cg.addInterface("javax.jdo.spi.PersistenceCapable" );
    }
/* end */
  ...
  private void createMethod_1() {
    ...
    InstructionHandle ih_0 = il.append(_factory.createLoad(Type.OBJECT, 0));
    InstructionHandle ih_1 = il.append(_factory.createInvoke(thisClassName, "__setup", Type.VOID, Type.NO_ARGS, Constants.INVOKEVIRTUAL));
    ...
    il.append(InstructionConstants.DUP);
    il.append(_factory.createInvoke("java.lang.StringBuffer", "<init>", Type.VOID, Type.NO_ARGS, Constants.INVOKESPECIAL));
    ...
    goto_4.setTarget(ih_47);
    method.addExceptionHandler(ih_0, ih_1, ih_7, new ObjectType("java.lang.Throwable"));
    method.setMaxStack();
    method.setMaxLocals();
    _cg.addMethod(method.getMethod());
    il.dispose();
  ...
  private void createMethod_5() {
    ...
    il.append(new INSTANCEOF(_cp.addClass(new ObjectType("com.objectwave.persist.jdo.JdoAdapter"))));
    ...
    il.append(_factory.createLoad(Type.OBJECT, 1));
    il.append(_factory.createCheckCast(new ObjectType("com.objectwave.persist.jdo.JdoAdapter")));
  ...
  private void createMethod_23() {
    ...
    il.append(new PUSH(_cp, 1));
    il.append(_factory.createInvoke("com.objectwave.persist.mapping.RDBPersistentAdapter", "setTransactionalOnly", Type.VOID, new Type[] { Type.BOOLEAN }, Constants.INVOKEVIRTUAL));
    InstructionHandle ih_48 = il.append(_factory.createLoad(Type.OBJECT, 2));
    il.append(new PUSH(_cp, 1));
    ...
    InstructionHandle ih_54 = il.append(_factory.createReturn(Type.OBJECT));
    method.setMaxStack();
    method.setMaxLocals();
    _cg.addMethod(method.getMethod());
    il.dispose();
  ...
  private void createMethod_25() {
    ...
    il.append(goto_78);
    InstructionHandle ih_81 = il.append(_factory.createStore(Type.OBJECT, 8));
    il.append(_factory.createLoad(Type.OBJECT, 4));
    InstructionHandle ih_85 = il.append(InstructionConstants.MONITOREXIT);
    il.append(_factory.createLoad(Type.OBJECT, 8));
    il.append(InstructionConstants.ATHROW);
    InstructionHandle ih_89 = il.append(_factory.createReturn(Type.VOID));
    ifnull_12.setTarget(ih_19);
    goto_78.setTarget(ih_89);
    method.addExceptionHandler(ih_8, ih_17, ih_81, null);
    method.addExceptionHandler(ih_19, ih_77, ih_81, null);
    method.addExceptionHandler(ih_81, ih_85, ih_81, null);
    method.setMaxStack();
    method.setMaxLocals();
    _cg.addMethod(method.getMethod());
    il.dispose();
  ...
  private void createMethod_34() {
    ...
    InstructionHandle ih_2 = il.append(_factory.createLoad(Type.INT, 2));
    il.append(_factory.createLoad(Type.OBJECT, 1));
    il.append(_factory.createInvoke("java.util.ArrayList", "size", Type.INT, Type.NO_ARGS, Constants.INVOKEVIRTUAL));
        BranchInstruction if_icmpge_7 = _factory.createBranchInstruction(Constants.IF_ICMPGE, null);
    ...
    il.append(_factory.createStore(Type.OBJECT, 3));
    InstructionHandle ih_19 = il.append(_factory.createLoad(Type.OBJECT, 3));
    ...
    il.append(_factory.createFieldAccess("com.objectwave.persist.AttributeTypeColumn", "PRIMARYATT", new ObjectType("com.objectwave.persist.Type"), Constants.GETSTATIC));
        BranchInstruction if_acmpne_28 = _factory.createBranchInstruction(Constants.IF_ACMPNE, null);
    il.append(if_acmpne_28);
    InstructionHandle ih_31 = il.append(_factory.createReturn(Type.VOID));
    InstructionHandle ih_32 = il.append(new IINC(2, 1));
        BranchInstruction goto_35 = _factory.createBranchInstruction(Constants.GOTO, ih_2);
    il.append(goto_35);
    InstructionHandle ih_38 = il.append(_factory.createLoad(Type.OBJECT, 1));
    ...
    InstructionHandle ih_58 = il.append(_factory.createReturn(Type.VOID));
    if_icmpge_7.setTarget(ih_38);
    if_acmpne_28.setTarget(ih_32);
    method.setMaxStack();
    method.setMaxLocals();
    _cg.addMethod(method.getMethod());
    il.dispose();
  ...
  private void createMethod_35() {
    ...
    InstructionHandle ih_0 = il.append(_factory.createNew("com.objectwave.persist.jdo.JdoAdapter"));
    il.append(InstructionConstants.DUP);
    il.append(_factory.createLoad(Type.OBJECT, 1));
    il.append(_factory.createInvoke("com.objectwave.persist.jdo.JdoAdapter", "<init>", Type.VOID, new Type[] { new ObjectType("com.objectwave.persist.Persistence") }, Constants.INVOKESPECIAL));
    il.append(_factory.createStore(Type.OBJECT, 2));
  ...
  private void createMethod_36() {
    ...
    il.append(_factory.createInvoke("java.lang.StringBuffer", "toString", Type.STRING, Type.NO_ARGS, Constants.INVOKEVIRTUAL));
    il.append(_factory.createStore(Type.OBJECT, 6));
    InstructionHandle ih_110 = il.append(_factory.createLoad(Type.OBJECT, 0));
    il.append(_factory.createNew("java.lang.StringBuffer"));
    il.append(InstructionConstants.DUP);
    il.append(_factory.createInvoke("java.lang.StringBuffer", "<init>", Type.VOID, Type.NO_ARGS, Constants.INVOKESPECIAL));
    ...
    InstructionHandle ih_134 = il.append(_factory.createLoad(Type.OBJECT, 5));
    il.append(_factory.createLoad(Type.OBJECT, 2));
    il.append(_factory.createInvoke("java.lang.Object", "getClass", new ObjectType("java.lang.Class"), Type.NO_ARGS, Constants.INVOKEVIRTUAL));
    il.append(_factory.createLoad(Type.OBJECT, 6));
    il.append(_factory.createInvoke("com.objectwave.utility.FileFinder", "getUrl", new ObjectType("java.net.URL"), new Type[] { new ObjectType("java.lang.Class"), Type.STRING }, Constants.INVOKEVIRTUAL));
    InstructionHandle ih_145 = il.append(_factory.createStore(Type.OBJECT, 4));
    InstructionHandle ih_147;
    BranchInstruction goto_147 = _factory.createBranchInstruction(Constants.GOTO, null);
    ih_147 = il.append(goto_147);
    InstructionHandle ih_150 = il.append(_factory.createStore(Type.OBJECT, 6));
    InstructionHandle ih_152 = il.append(_factory.createNew("java.lang.StringBuffer"));
    il.append(InstructionConstants.DUP);
    il.append(_factory.createInvoke("java.lang.StringBuffer", "<init>", Type.VOID, Type.NO_ARGS, Constants.INVOKESPECIAL));
    ...
    il.append(InstructionConstants.ATHROW);
    InstructionHandle ih_184 = il.append(_factory.createLoad(Type.OBJECT, 4));
        BranchInstruction ifnonnull_186 = _factory.createBranchInstruction(Constants.IFNONNULL, null);
    il.append(ifnonnull_186);
    InstructionHandle ih_189 = il.append(_factory.createNew("java.io.FileNotFoundException"));
    il.append(InstructionConstants.DUP);
    il.append(_factory.createNew("java.lang.StringBuffer"));
    il.append(InstructionConstants.DUP);
    il.append(_factory.createInvoke("java.lang.StringBuffer", "<init>", Type.VOID, Type.NO_ARGS, Constants.INVOKESPECIAL));
    ...
    il.append(InstructionConstants.ATHROW);
    InstructionHandle ih_225 = il.append(_factory.createLoad(Type.OBJECT, 4));
    il.append(_factory.createInvoke("java.net.URL", "toString", Type.STRING, Type.NO_ARGS, Constants.INVOKEVIRTUAL));
    InstructionHandle ih_230 = il.append(_factory.createReturn(Type.OBJECT));
    ...
    ifnonnull_64.setTarget(ih_147);
    goto_147.setTarget(ih_184);
    ifnonnull_186.setTarget(ih_225);
    method.addExceptionHandler(ih_23, ih_145, ih_150, new ObjectType("java.net.MalformedURLException"));
    method.setMaxStack();
    method.setMaxLocals();
    _cg.addMethod(method.getMethod());
    il.dispose();
  ...
  private void createMethod_37() {
    ...
    il.append(_factory.createInvoke("java.lang.Class", "getName", Type.STRING, Type.NO_ARGS, Constants.INVOKEVIRTUAL));
    il.append(_factory.createInvoke("java.lang.StringBuffer", "append", Type.STRINGBUFFER, new Type[] { Type.STRING }, Constants.INVOKEVIRTUAL));
    il.append(new PUSH(_cp, ".listener"));
    il.append(_factory.createInvoke("java.lang.StringBuffer", "append", Type.STRINGBUFFER, new Type[] { Type.STRING }, Constants.INVOKEVIRTUAL));
    il.append(_factory.createInvoke("java.lang.StringBuffer", "toString", Type.STRING, Type.NO_ARGS, Constants.INVOKEVIRTUAL));
    il.append(_factory.createInvoke("java.lang.System", "getProperty", Type.STRING, new Type[] { Type.STRING }, Constants.INVOKESTATIC));
    il.append(_factory.createStore(Type.OBJECT, 1));
    InstructionHandle ih_29 = il.append(_factory.createLoad(Type.OBJECT, 1));
        BranchInstruction ifnull_30 = _factory.createBranchInstruction(Constants.IFNULL, null);
    il.append(ifnull_30);
    InstructionHandle ih_33 = il.append(_factory.createLoad(Type.OBJECT, 1));
    ...
    il.append(_factory.createStore(Type.OBJECT, 2));
    InstructionHandle ih_38 = il.append(_factory.createLoad(Type.OBJECT, 2));
    il.append(_factory.createInvoke("java.lang.Class", "newInstance", Type.OBJECT, Type.NO_ARGS, Constants.INVOKEVIRTUAL));
    il.append(_factory.createCheckCast(new ObjectType("com.objectwave.event.ChangeEventFactoryIF")));
    il.append(_factory.createStore(Type.OBJECT, 3));
    InstructionHandle ih_46 = il.append(_factory.createLoad(Type.OBJECT, 0));
    il.append(_factory.createFieldAccess(thisClassName, "editor", new ObjectType("com.objectwave.transactionalSupport.ObjectEditingView"), Constants.GETFIELD));
    il.append(new INSTANCEOF(_cp.addClass(new ObjectType("java.beans.PropertyChangeSupport"))));
        BranchInstruction ifeq_53 = _factory.createBranchInstruction(Constants.IFEQ, null);
    il.append(ifeq_53);
    InstructionHandle ih_56 = il.append(_factory.createLoad(Type.OBJECT, 0));
    il.append(_factory.createFieldAccess(thisClassName, "editor", new ObjectType("com.objectwave.transactionalSupport.ObjectEditingView"), Constants.GETFIELD));
    il.append(_factory.createCheckCast(new ObjectType("java.beans.PropertyChangeSupport")));
    il.append(_factory.createLoad(Type.OBJECT, 3));
    il.append(_factory.createInvoke("com.objectwave.event.ChangeEventFactoryIF", "getListener", new ObjectType("java.beans.PropertyChangeListener"), Type.NO_ARGS, Constants.INVOKEINTERFACE));
    InstructionHandle ih_69 = il.append(_factory.createInvoke("java.beans.PropertyChangeSupport", "addPropertyChangeListener", Type.VOID, new Type[] { new ObjectType("java.beans.PropertyChangeListener") }, Constants.INVOKEVIRTUAL));
    InstructionHandle ih_72;
    BranchInstruction goto_72 = _factory.createBranchInstruction(Constants.GOTO, null);
    ih_72 = il.append(goto_72);
    InstructionHandle ih_75 = il.append(_factory.createStore(Type.OBJECT, 1));
    InstructionHandle ih_76 = il.append(_factory.createInvoke("com.objectwave.event.StatusManager", "getDefaultManager", new ObjectType("com.objectwave.event.StatusManager"), Type.NO_ARGS, Constants.INVOKESTATIC));
    il.append(InstructionConstants.POP);
    il.append(_factory.createNew("java.lang.StringBuffer"));
    il.append(InstructionConstants.DUP);
    il.append(_factory.createInvoke("java.lang.StringBuffer", "<init>", Type.VOID, Type.NO_ARGS, Constants.INVOKESPECIAL));
    il.append(new PUSH(_cp, "Non Fatal Exception in Constructor: "));
    il.append(_factory.createI
