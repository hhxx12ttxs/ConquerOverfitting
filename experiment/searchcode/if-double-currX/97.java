package embedded.org.sgJoe.tools.interfaces;
...
import embedded.org.sgJoe.tools.decorators.VToolHandle;
...
public abstract class VToolForm  extends Form {
    ...
    protected Point3d               eyePosition = null;
    protected Vector3d              lookingDirection = null;
    ...
    public final static int ACT_OFFSET = 10000,
                            ...
                            // collision 
                            ACT_MOUSE_DRAGGED_HIT_OTHER_TOOL = ACT_OFFSET + 408,
    
                            // uni tool actions
                            ACT_MOUSE_TRANSLATE_HANDLE_PRESSED = ACT_OFFSET + 501,
                            ACT_MOUSE_TRANSLATE_HANDLE_CLICKED = ACT_OFFSET + 502,
                            ACT_MOUSE_TRANSLATE_HANDLE_RELEASED = ACT_OFFSET + 503,
                            ACT_MOUSE_TRANSLATE_HANDLE_DRAGGED = ACT_OFFSET + 504,
    
                            ACT_MOUSE_SCALE_HANDLE_PRESSED = ACT_OFFSET + 505,
                            ACT_MOUSE_SCALE_HANDLE_CLICKED = ACT_OFFSET + 506,
                            ACT_MOUSE_SCALE_HANDLE_RELEASED = ACT_OFFSET + 507,

                            ACT_MOUSE_TRANSLATE_SLIDER_PRESSED = ACT_OFFSET + 508,
                            ACT_MOUSE_TRANSLATE_SLIDER_CLICKED = ACT_OFFSET + 509,
                            ACT_MOUSE_TRANSLATE_SLIDER_RELEASED = ACT_OFFSET + 510,
                            ACT_MOUSE_TRANSLATE_SLIDER_DRAGGED = ACT_OFFSET + 511,
    
                            ACT_MOUSE_SCALE_SLIDER_PRESSED = ACT_OFFSET + 512,
                            ACT_MOUSE_SCALE_SLIDER_CLICKED = ACT_OFFSET + 513,
                            ACT_MOUSE_SCALE_SLIDER_RELEASED = ACT_OFFSET + 514,
                            ACT_MOUSE_SCALE_SLIDER_DRAGGED = ACT_OFFSET + 515,    
    
                            ACT_MOUSE_ROTATE_SLIDER_PRESSED = ACT_OFFSET + 516,
                            ACT_MOUSE_ROTATE_SLIDER_CLICKED = ACT_OFFSET + 517,
                            ACT_MOUSE_ROTATE_SLIDER_RELEASED = ACT_OFFSET + 518,
                            ACT_MOUSE_ROTATE_SLIDER_DRAGGED = ACT_OFFSET + 519,
                            
                            ACT_MOUSE_AXIS_ROTATE_HANDLE_PRESSED = ACT_OFFSET + 520,
                            ACT_MOUSE_AXIS_ROTATE_HANDLE_CLICKED = ACT_OFFSET + 521,
                            ACT_MOUSE_AXIS_ROTATE_HANDLE_RELEASED = ACT_OFFSET + 522,
                            ACT_MOUSE_AXIS_ROTATE_HANDLE_DRAGGED = ACT_OFFSET + 523,
            
                            ACT_MOUSE_AXIS_ROTATE_SLIDER_PRESSED = ACT_OFFSET + 524,
                            ACT_MOUSE_AXIS_ROTATE_SLIDER_CLICKED = ACT_OFFSET + 525,
                            ACT_MOUSE_AXIS_ROTATE_SLIDER_RELEASED = ACT_OFFSET + 526,
                            ACT_MOUSE_AXIS_ROTATE_SLIDER_DRAGGED = ACT_OFFSET + 527;
            

    protected String toolName;       
    
    protected VToolHandle activatedToolHandle = null;
...
//    }
    ...
    public VToolHandle getActivatedToolHandle() {
        return activatedToolHandle;
    }

    public void setActivatedToolHandle(VToolHandle activatedToolHandle) {
        this.activatedToolHandle = activatedToolHandle;
    }
    ...
    public void setEyePosition(Point3d eyePosition) {
    ...
    public void setLookingDirection(Vector3d lookingDirection) {
