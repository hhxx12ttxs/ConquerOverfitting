package org.sgJoe.embedded.tools.interfaces;
...
import org.sgJoe.embedded.logic.ActionErrors;
...
public abstract class VToolForm  extends Form {
    ...
    // helper fields with viewer data
...
//-->                            ACT_MOUSE_DRAGGED_HIT_OTHER_TOOL = ACT_OFFSET + 407;
    ...
    // we will remember TG that was source for action.
    protected TransformGroup evtSource = null;
...
//        }
    ...
    public TransformGroup getEvtSource() {
        return evtSource;
    }
    
    public void setEvtSource(TransformGroup evtSource) {
