...
/**
 * DEBreeder provides a straightforward Differential Evolution (DE) breeder for
 * the ECJ system. The code is derived from the "classic" DE algorithm, known as
 * DE/rand/1/bin, found on page 140 of
 ...
 * defined as c = r0 + F * (r1 - r2). Last, we cross over c with the original
 * individual and produce a single child, using uniform crossover with
 * gene-independent crossover probability "Cr".
 * 
 * <p>
 ...
 * <table>
 * <tr>
 * <td valign=top><i>base.</i><tt>f</tt><br>
 * <font size=-1>0.0 &lt;= double &lt;= 1.0 </font></td>
 * <td valign=top>The "F" mutation scaling factor</td>
 * </tr>
 * 
 * <tr>
 * <td valign=top><i>base.</i><tt>cr</tt><br>
 * <font size=-1>0.0 &lt;= double &lt;= 1.0 </font></td>
 * <td valign=top>The "Cr" probability of crossing over genes</td>
 * </tr>
 * </table>
 * 
...
public class DEBreeder extends Breeder {
    ...
    /**
     * the previous population is stored in order to have parents compete
    ...
    public Population breedPopulation(EvolutionState state) {
        ...
        // breed the children
        for (int subpop = 0; subpop < state.population.subpops.length; subpop++) {
            if (state.population.subpops[subpop].individuals.length < 4) // Magic
                                                                         // number,
                                                                         // sorry.
                                                                         // createIndividual()
                                                                         // requires
            ...
            for (int i = 0; i < inds.length; i++) {
                newpop.subpops[subpop].individuals[i] = createIndividual(state, subpop, i, 0); // unthreaded
                                                                                               // for
                                                                                               // now
            }
        }
