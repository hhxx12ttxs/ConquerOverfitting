 ...
 * in Journal of the ACM 46 (5): 604â632 (1999)
 *
 * @author pjmcswee
 */
public class Hits implements Statistics, LongTask {
    ...
    public String getReport() {
        ...
        String report = "<HTML> <BODY> <h1> HITS Metric Report </h1>"
                ...
                + "Jon M. Kleinberg, <i>Authoritative Sources in a Hyperlinked Environment</i>, in Journal of the ACM 46 (5): 604â632 (1999)<br />"
                + "</BODY> </HTML>";
