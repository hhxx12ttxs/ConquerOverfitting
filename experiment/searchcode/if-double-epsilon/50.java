...
public class AdaBoostM1 
  ...
  protected Classifier m_ZeroR;
    ...
    private int resamplingIterations;
  ...
  public void buildClassifier(Instances data) throws Exception {
    ...
    super.buildClassifier(data);  // jakobk: builds m_NumIterations instances of m_Classifier
  ...
  protected void buildClassifierUsingResampling(Instances data)
      ...
      int numInstances = data.numInstances();
      randomInstance = new Random(m_Seed);
      ...
      m_NumIterationsPerformed = 0;
      // next: user has to call doIteration() n-times
  }

    public void doIteration() throws Exception {
        if (m_NumIterationsPerformed >= m_Classifiers.length) {
            throw new IllegalStateException("Illegal Iteration, already finished all iterations.");
        }
        if (m_Debug) {
