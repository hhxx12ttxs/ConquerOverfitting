...
//REM  derived from commons-lang 2.3
...
public class EqualsBuilder
{
    ...
    public EqualsBuilder append(double lhs, double rhs)
    {
        ...
        // original: return append(Double.doubleToLongBits(lhs), Double.doubleToLongBits(rhs));
        isEquals = (lhs == rhs);
        return this;
    }
    ...
    public EqualsBuilder append(float lhs, float rhs)
    {
        ...
        // original: return append(Float.floatToIntBits(lhs), Float.floatToIntBits(rhs));
        isEquals = (lhs == rhs);
        return this;
    }
