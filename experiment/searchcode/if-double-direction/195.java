...
public abstract class Objected2DObject_Abstract implements Objected2DObject, Cloneable {
    ...
    public final void _paint (java.awt.Graphics2D g) {
        if (this.isVisible()) {
            ...
            g.drawImage(
                    this.internalImage, null, this.getXPos()-1, this.getYPos()-1
            );
        }
    }
    ...
    public void renderInternalImage () {
        this.internalImage = new BufferedImage(
                this.getWidth()+2, this.getHeight()+2, BufferedImage.TYPE_INT_ARGB
                );
        System.out.println(this.getWidth()+2);

        Graphics2D g = this.internalImage.createGraphics();
