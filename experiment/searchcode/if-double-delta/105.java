...
public class Assert {
	 ...
	 */
	static public void doAssert(String message, boolean condition) {
		if (!condition)
			fail(message);
	}
	/**
	 ...
	 */
	static public void doAssert(boolean condition) {
		doAssert(null, condition);
	}
	/**
