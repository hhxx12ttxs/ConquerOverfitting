...
public class Licence {
	...
	public byte[] generate_hwid() throws UnsupportedEncodingException {
		...
		byte[] name = SessionManager.getInstance().getOption( secure.getSessionId() ).hostname.getBytes("US-ASCII");
	...
	public void process_demand(RdpPacket_Localised data)
			...
			IOException, CryptoException {
		Options options = SessionManager.getInstance().getOption(secure.getSessionId());
