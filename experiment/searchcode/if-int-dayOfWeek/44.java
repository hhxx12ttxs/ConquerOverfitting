...
import org.openmrs.module.usagestatistics.TelereferralUsage;
import org.openmrs.module.usagestatistics.TelereferralUsageStatsService;
...
import org.openmrs.module.usagestatistics.db.TelereferralUsageStatsDAO;
 ...
 */
public class TelereferralUsageStatsServiceImpl extends BaseOpenmrsService implements TelereferralUsageStatsService {

	protected static final Log log = LogFactory.getLog(TelereferralUsageStatsServiceImpl.class);
	
	protected TelereferralUsageStatsDAO dao;
	
	/**
	 * Sets the database access object for this service
	 * @param dao the database access object
	 */
	public void setUsageStatsDAO(TelereferralUsageStatsDAO dao) {
		this.dao = dao;
	}
	 ...
	 */
	public void saveUsage(TelereferralUsage usage) throws APIException {
		dao.saveUsage(usage);
	}
	 ...
	 */
	public List<TelereferralUsage> getUsages(User user, Patient patient, Date from, Date until, UsageFilter filter, PagingInfo paging) throws APIException {
	 ...
	 */
	public TelereferralUsage getLastUsage(User user, Patient patient, int maxAgeSecs) throws APIException {
