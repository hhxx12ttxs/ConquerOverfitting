...
public class StringUtils {
    ...
    static {
        ...
        htmlEntities.put("&amp;", "&");
        htmlEntities.put("&quot;", "\"");
        htmlEntities.put("&agrave;", "ŕ");
        htmlEntities.put("&Agrave;", "Ŕ");
        htmlEntities.put("&acirc;", "â");
        htmlEntities.put("&auml;", "ä");
        htmlEntities.put("&Auml;", "Ä");
        htmlEntities.put("&Acirc;", "Â");
        htmlEntities.put("&aring;", "ĺ");
        htmlEntities.put("&Aring;", "Ĺ");
        htmlEntities.put("&aelig;", "ć");
        htmlEntities.put("&AElig;", "Ć");
        htmlEntities.put("&ccedil;", "ç");
        htmlEntities.put("&Ccedil;", "Ç");
        htmlEntities.put("&eacute;", "é");
        htmlEntities.put("&Eacute;", "É");
        htmlEntities.put("&egrave;", "č");
        htmlEntities.put("&Egrave;", "Č");
        htmlEntities.put("&ecirc;", "ę");
        htmlEntities.put("&Ecirc;", "Ę");
        htmlEntities.put("&euml;", "ë");
        htmlEntities.put("&Euml;", "Ë");
        htmlEntities.put("&iuml;", "ď");
        htmlEntities.put("&Iuml;", "Ď");
        htmlEntities.put("&ocirc;", "ô");
        htmlEntities.put("&Ocirc;", "Ô");
        htmlEntities.put("&ouml;", "ö");
        htmlEntities.put("&Ouml;", "Ö");
        htmlEntities.put("&oslash;", "ř");
        htmlEntities.put("&Oslash;", "Ř");
        htmlEntities.put("&szlig;", "ß");
        htmlEntities.put("&ugrave;", "ů");
        htmlEntities.put("&Ugrave;", "Ů");
        htmlEntities.put("&ucirc;", "ű");
        htmlEntities.put("&Ucirc;", "Ű");
