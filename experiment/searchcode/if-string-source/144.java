...
public class TypeSpecimen extends NameUsageComponent {
   ...
   */
  @Nullable
  public String getTypeDesignationType() {
   ...
   */
  public void setTypeDesignationType(String typeDesignationType) {
  ...
  public int hashCode() {
    return Objects
      .hashCode(super.hashCode(), source, citation, typeStatus, typeDesignationType, typeDesignatedBy, scientificName,
        verbatimLabel, locality, recordedBy, verbatimEventDate, verbatimLongitude, verbatimLatitude, occurrenceId,
        taxonRank, institutionCode, collectionCode, catalogNumber);
  }
  ...
  public boolean equals(Object object) {
    if (object instanceof TypeSpecimen) {
      ...
      return Objects.equal(this.source, that.source) && Objects.equal(this.citation, that.citation)
             ...
             && Objects.equal(this.verbatimLabel, that.verbatimLabel) && Objects.equal(this.locality, that.locality)
             ...
             && Objects.equal(this.occurrenceId, that.occurrenceId) && Objects.equal(this.taxonRank, that.taxonRank)
             && Objects.equal(this.institutionCode, that.institutionCode)
             && Objects.equal(this.collectionCode, that.collectionCode) && Objects
        .equal(this.catalogNumber, that.catalogNumber);
    }
    return false;
  }
  ...
  public String toString() {
    return Objects.toStringHelper(this).add("super", super.toString()).add("source", source).add("citation", citation)
      .add("typeStatus", typeStatus).add("typeDesignationType", typeDesignationType)
      .add("typeDesignatedBy", typeDesignatedBy).add("scientificName", scientificName)
      .add("verbatimLabel", verbatimLabel).add("locality", locality).add("recordedBy", recordedBy)
      .add("verbatimEventDate", verbatimEventDate).add("verbatimLongitude", verbatimLongitude)
      .add("verbatimLatitude", verbatimLatitude).add("occurrenceId", occurrenceId).add("taxonRank", taxonRank)
