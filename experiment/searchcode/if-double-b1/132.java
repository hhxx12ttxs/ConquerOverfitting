...
import com.codenvy.ide.ext.java.jdt.core.dom.IPackageBinding;
...
public class Bindings {
     ...
     * @see com.codenvy.ide.ext.java.jdt.internal.corext.codemanipulation.StubUtility#getVariableNameSuggestions(int, IJavaProject, ITypeBinding, Expression, java.util.Collection)
     * @since 3.5
     */
