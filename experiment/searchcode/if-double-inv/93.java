...
public class TarifaEdit extends javax.swing.JDialog {
    ...
    public TarifaEdit(javax.swing.JDialog parent, boolean modal, int id) {
        ...
        if (this.isNuevo) {
            this.setTitle("FlyTrack - Administraciรณn - Tarifa - Agregar");
        } else {
            this.setTitle("FlyTrack - Administraciรณn - Tarifa - Modificar");
        }
...
//            }
            ...
            if (!CValidator.isDouble(txtMonto.getText())) {
                ...
                error_message = "El monto es invรกlido\n";
            ...
            if (fechaact.after(fechades)) {
                error_message = error_message + "La fecha de activaciรณn no puede ser menor a la de desactivaciรณn\n";
            }
