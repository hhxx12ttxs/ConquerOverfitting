...
public class ConnectionSql{
	...
	/**
	 * Legger inn rette brukernavn og passord til ĺ kunne koble seg opp til databasen vĺr
	 * @throws SQLException
	...
	/**
	 * Sjekker om id p en film finnes i databasen. 
	...
	public void addUser() throws SQLException{
		...
		try{
			//Legger til řnsket informasjon i tabellen "User"
	...
	/**
	 * Metode for ĺ logge inn med en eksisterende bruker
	 * @return returnerer "true" kun dersom bĺde brukernavn og passord stemmer overens
	...
	/**
	 * Henter ut filmene til den personen som blir trykket p i lista over brukere
	 * @param string
	 * @throws SQLException
