...
*/
	...
	/** Diese Methode fьgt durch String-Manipulation in jtpSource
	...
	/** Diese Methode lцscht durch Stringmanipulation in jtpSource das ьbergebene Element,
	  * Alternative fьr removeElement in ExtendedHTMLDocument, mit closingTag wird angegeben
	  * ob es ein schlieяenden Tag gibt
	  */
	...
	/** Diese Methode gibt jeweils den Start- und Endoffset des Elements
	  * sowie dem entsprechenden schlieяenden Tag zurьck
	  */
	private int[] getPositions(Element element, String source, boolean closingTag, String idString)
	{
		...
		if(closingTag)
		{
			...
			// Schleife lдuft solange, bis keine neuen StartTags mehr gefunden werden
			...
			do
			{
				...
				// hitUp enthдlt die Anzahl der neuen Start-Tags
				if(hitUp == 0)
				{
					end = true;
				}
	...
	/* Diese Methode prьft ob der ьbergebene Tag sich in der Hierachie nach oben befindet */
	...
	/* Diese Methoden geben das erste gefundende dem ьbergebenen tags entsprechende Element zurьck */
	...
	/* Diese Methoden entfernen Attribute aus dem SimpleAttributeSet, gemдя den ьbergebenen Werten, und
		geben das Ergebnis als SimpleAttributeSet zurьck*/
	...
	/* liefert den entsprechenden HTML.Tag zum Element zurьck */
