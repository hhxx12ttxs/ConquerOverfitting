...
public class WavePanel extends javax.swing.JPanel implements Runnable {
    ...
    File fichierSon = null; //Le fichier son qu'on se prépare ŕ lire/timer
    ...
    double t=0.0; //Temps ŕ l'instant t
    ...
    int displayZone = 0; //Pixel de la vue actuel par rapport ŕ la scrollbar (valeur absolue de la scrollbar)
    ...
    public void new_wav2(String imagePath){
        ...
        //Cache de l'image; ŕ écrire dans le flux
        BufferedImage bi = null;
        
        //Outil de dessin dans l'image
        Graphics2D g2 = null;
        
        //On cherche ŕ déterminer combien d'images générer en fonction des
        ...
        System.out.println("Largeur de la derničre image : "+tailleDerniereImage);
        ...
        for(int tab=0;tab<=nbTableau;tab++){
            ...
            try {
                ...
                System.out.println("Erreur monumentale"); //Cŕ bloque lŕ
                return;
            }

            //Renseignement sur la zone graphique ŕ peindre
            ...
            int maValeur = 0;
            //Le nombre de samples ŕ traiter
...
//            sb2.setMaximum(nbPixelsInImage-90);
    ...
    private String timeToTiming(double time){
        ...
        time=time*100; //Support des centičmes de secondes
    ...
    private String pixelToTiming(int px){
        ...
        ptx=ptx*100; //Support des centičmes de secondes
