...
import com.liferay.portal.util.TestSAXReaderImpl;
import com.liferay.portal.util.XMLFormatter;
...
public class ElementImpl extends BranchImpl implements Element {
	...
	public List<Namespace> additionalNamespaces() {
		return TestSAXReaderImpl.toNewNamespaces(_element.additionalNamespaces());
	}
	...
	public List<Attribute> attributes() {
		return TestSAXReaderImpl.toNewAttributes(_element.attributes());
	}
	...
	public List<Namespace> declaredNamespaces() {
		return TestSAXReaderImpl.toNewNamespaces(_element.declaredNamespaces());
	}
	...
	public List<Element> elements() {
		return TestSAXReaderImpl.toNewElements(_element.elements());
	}

	public List<Element> elements(QName qName) {
		QNameImpl qNameImpl = (QNameImpl)qName;

		return TestSAXReaderImpl.toNewElements(
			_element.elements(qNameImpl.getWrappedQName()));
	}

	public List<Element> elements(String name) {
		return TestSAXReaderImpl.toNewElements(_element.elements(name));
	}
	...
	public List<Namespace> getNamespacesForURI(String uri) {
		return TestSAXReaderImpl.toNewNamespaces(_element.getNamespacesForURI(uri));
	}
	...
	public void setAttributes(List<Attribute> attributes) {
		_element.setAttributes(TestSAXReaderImpl.toOldAttributes(attributes));
	}
