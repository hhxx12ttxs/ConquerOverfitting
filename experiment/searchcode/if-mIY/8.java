...
public class Rectangle implements Serializable {
	 ...
	 *            (see x2)
	 */
	public Rectangle(final float x1, final float y1, final float x2, final float y2) {
		set(x1, y1, x2, y2);
	}
	 ...
	 */
	public static boolean intersects(final float r1MinX, final float r1MinY, final float r1MaxX, final float r1MaxY, final float r2MinX, final float r2MinY, final float r2MaxX, final float r2MaxY) {
	 ...
	 */
	public static boolean contains(final float r1MinX, final float r1MinY, final float r1MaxX, final float r1MaxY, final float r2MinX, final float r2MinY, final float r2MaxX, final float r2MaxY) {
	 ...
	 * @return distance beween this rectangle and the passed point.
	 */
	public static float distance(final float minX, final float minY, final float maxX, final float maxY, final float pX, final float pY) {
		return (float) Math.sqrt(distanceSq(minX, minY, maxX, maxY, pX, pY));
	}

	public static float distanceSq(final float minX, final float minY, final float maxX, final float maxY, final float pX, final float pY) {
		float distanceSqX = 0;
		float distanceSqY = 0;
	 ...
	 * @return enlargement
	 */
	public static float enlargement(float r1MinX, float r1MinY, float r1MaxX, float r1MaxY, final float r2MinX, final float r2MinY, final float r2MaxX, final float r2MaxY) {
	 ...
	 */
	public static float area(final float minX, final float minY, final float maxX, final float maxY) {
		return (maxX - minX) * (maxY - minY);
	}
	...
	@Override
	public int hashCode(){
		final int mix = Float.floatToRawIntBits(minX);
		final int max = Float.floatToRawIntBits(maxX);
		final int miy = Float.floatToRawIntBits(minY);
		final int may = Float.floatToRawIntBits(maxY);
