				...
				public void run() {
					...
					try {
						if (rtp_socket == null) {
							...
							boolean encSend = PreferenceManager
									.getDefaultSharedPreferences(
											Receiver.mContext)
									.getBoolean(
											org.sipdroid.sipua.ui.Settings.PREF_SENDENC,
											false);
							boolean decRec = PreferenceManager
									.getDefaultSharedPreferences(
											Receiver.mContext)
									.getBoolean(
											org.sipdroid.sipua.ui.Settings.PREF_RECIEVEDEC,
											false);
