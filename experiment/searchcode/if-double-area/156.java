...
public class RettangoloConInput {
	...
	public static void main(String[] args) {
		...
		double altezza = Input.getDouble("Inserire l'altezza del rettangolo: ");
		double base = Input.getDouble("Inserire la base del rettangolo: ");
		setAltezza(altezza);
		setBase(base);
