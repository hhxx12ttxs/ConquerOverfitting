...
public class Area extends Line
{
			...
			AreaDataPointsRenderer2DStacked
	{
		...
		private static class Envelop
		{
			...
			private List<IndexedPoint> merge( List<IndexedPoint> list, int index,
		...
		protected void processDataPoint( DataPointsSeeker seeker )
		{
			...
			// ------ Render the top tape.
			List<Location[]> tops = envelops[index].getTopChanges( iSeriesIndex,
					dTapeWidth );
			...
			List<Location[]> bottoms = envelops[index].getBottomChanges( iSeriesIndex,
					dTapeWidth );
