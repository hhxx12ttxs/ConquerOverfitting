...
public class SVGParser {
	...
	/** The Constant TAG. */
	static final String TAG = LogUtility.setLOGTAG("SVGParser");
	 ...
	 *
	 * @param in the in
	 * @param searchColor the search color
	 * @param replaceColor the replace color
	 * @param whiteMode the white mode
	 * @return the SVG
	 * @throws SVGParseException the SVG parse exception
	 */
	...
	/**
	 * Gets the number parse attr.
	 *
	 * @param name the name
	 * @param attributes the attributes
	 * @return the number parse attr
	 */
	...
	private static class IDHandler extends DefaultHandler {
		 ...
		 * @param atts the atts
		 * @see{@link org.xml.sax.helpers.DefaultHandler#startElement(java.lang.String, java.lang.String, java.lang.String, org.xml.sax.Attributes)}
		 */
		@Override
		 ...
		 * @param localName the local name
		 * @param qName the q name
		 * @see{@link  org.xml.sax.helpers.DefaultHandler#endElement(java.lang.String, java.lang.String, java.lang.String)}
		 */
	@Override
	...
	private static class SVGHandler extends DefaultHandler {
		 ...
		 * Start document.
		 *
		 * @see{@link org.xml.sax.helpers.DefaultHandler#startDocument()}
		 */
		@Override
		 ...
		 * End document.
		 *
		 * @see{@link  org.xml.sax.helpers.DefaultHandler#endDocument()}
		 */
		@Override
		 ...
		 * @see{@link org.xml.sax.helpers.DefaultHandler#characters(char[], int, int)}
		 */
		@Override
		...
		private class SvgText {
			...
			/**
			 * Checks if is in text.
			 *
			 * @return true, if checks if is in text
			 */
