...
/**
 * 
 * DormandPrince45 implements a RKF 4/5 ODE solver with variable step size using
...
public class DormandPrince45 implements ODEAdaptiveSolver {
	...
	static final double[][] a = {
			...
			{ -181.0 / 270.0, 5.0 / 2.0, -266.0 / 297.0, -91.0 / 27.0,
					189.0 / 55.0 } };
	// ch contains the 5th order coefficients
	static final double[] b5 = { 19.0 / 216.0, 0.0, 1000.0 / 2079.0,
			-125.0 / 216.0, 81.0 / 88.0, 5.0 / 56.0 };
	// er array contains the error coefficients; the difference between the 4th
	// and 5th order coefficients
	// er[0] is computed to be -11/360 = 31/540-19/216
	static final double[] er = { -11.0 / 360.0, 0.0, 10.0 / 63.0, -55.0 / 72.0,
			27.0 / 40.0, -11.0 / 280.0 };
	...
	/**
	 * Constructs the DormandPrince45 ODESolver for a system of ordinary
	 * differential equations.
	 * 
	 * @param _ode
	 *            the system of differential equations.
	 */
	public DormandPrince45(final ODE _ode) {
		ode = _ode;
		initialize(stepSize);
	}
