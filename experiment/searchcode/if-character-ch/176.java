...
if (regexp.anchorCh >= 0) {
    ...
    {
        return org.not.java.Character.isLetter(c) || isDigit(c) || c == '_';
    }
    ...
    private static boolean isREWhiteSpace(int c)
    {
        return (c == '\u0020' || c == '\u0009'
                ...
                || c == '\u000C' || c == '\u000B'
                || c == '\u00A0'
                || org.not.java.Character.getType((char)c) == org.not.java.Character.SPACE_SEPARATOR);
    }
        ...
        while (index != end) {
            ...
            case '\\':
                ...
                case 'v':
                    ...
                    break;
                case 'c':
                    if (((index + 1) < end) && org.not.java.Character.isLetter(src[index + 1]))
 ...
 */
                ...
                case 'c':
                    if (((state.cp + 1) < state.cpend) &&
                    		org.not.java.Character.isLetter(src[state.cp + 1]))
            ...
            if (!result) {
                ...
                if (backTrackData != null) {
                    ...
                    if (backTrackData.parens != null) {
                        gData.parens = org.not.java.HelpObject.clone(backTrackData.parens);
                    }
...
class REBackTrackData {
    ...
    REBackTrackData(REGlobalData gData, int op, int pc)
    {
        ...
        if (gData.parens != null) {
            parens = org.not.java.HelpObject.clone(gData.parens);
        }
        cp = gData.cp;
