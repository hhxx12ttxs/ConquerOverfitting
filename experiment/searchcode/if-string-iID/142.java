...
public class StateWrapper implements Comparable<StateWrapper> {
	...
	private final List<UID> lstReachable;
	private Color color;
	private final ResourceVO resButtonIcon;
	
	public StateWrapper(UID iId, Integer iNumeral, String sName, NuclosImage icon, String sDescription, String color, ResourceVO resButtonIcon) {
		this(iId, iNumeral, sName, icon, sDescription, color, resButtonIcon, false, new LinkedList<UID>());
	}
	public StateWrapper(UID iId, Integer iNumeral, String sName, NuclosImage icon, String sDescription, String color, ResourceVO resButtonIcon, boolean bFromAutomatic, List<UID> lstReachable) {
		this.iId = iId;
	...
	public List<UID> getStatesBefore() {
		return lstReachable;
	}
