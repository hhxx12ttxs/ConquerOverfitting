...
/**
 * General value object template for Nucleus.
 * <br>
 ...
 * @version 01.00.00
 */
public class NuclosValueObject<PK> extends AbstractNuclosValueObject<PK> {
	private static final long	serialVersionUID	= 6637996725938917463L;
	
	private final PK iId;
	 ...
	 */
	public NuclosValueObject(PK iId, Date dateCreatedAt, String sCreatedBy, Date dateChangedAt, String sChangedBy, Integer iVersion) {
	 ...
	 */
	public NuclosValueObject(Collectable<PK> clct) {
		this(clct.getId(), (Date) clct.getValue(SF.CREATEDAT.getUID(clct.getEntityUID())), (String) clct.getValue(SF.CREATEDBY.getUID(clct.getEntityUID())),
				(Date) clct.getValue(SF.CHANGEDAT.getUID(clct.getEntityUID())), (String) clct.getValue(SF.CHANGEDBY.getUID(clct.getEntityUID())), clct.getVersion());
	}
	 ...
	 */
	protected NuclosValueObject(NuclosValueObject<PK> that) {
		super(that);
		this.iId = that.getId();
	 ...
	 */
	@Override
	public NuclosValueObject<PK> clone() {
		return (NuclosValueObject<PK>) super.clone();
	}
	 ...
	 */
	public static class GetId<PK> implements Transformer<NuclosValueObject<PK>, PK> {
		@Override
		public PK transform(NuclosValueObject<PK> vo) {
			return vo.getId();
		}
	}
