 ...
 * the user.  It containes other instance methods and instance variables to 
...
public class MosaicDrawController {
   ...
   /**
    * Applys the current drawing color to the square in a given row and column.
    ...
    * the user by looking at the action command associtated with the ActionEvent.
