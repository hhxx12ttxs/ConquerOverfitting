...
MouseWheelListener, ActionListener {
    ...
    GUIMap(GUI gui, AbstractButterfly bfly, Tile[][] tiles) {
        ...
        setBackground(Common.MARGIN_COLOR);
    ...
    /** Paint the map, tiles, and butterfly using g*/
    ...
    /** Retile the map given by tiles. <br><br>
     * 
    ...
    /** Return true iff a map entity is within the real map.
     * 
    ...
    /** Return the phantom position of the top left corner of an entity if it 
    ...
    /** Return the current width of the camera, in pixels. */
    ...
    /** Update the butterfly's fpm. */
    public void updateFPM() {
        butterfly.updateFPM(fpm);
    }

    /** Begin the move process for a butterfly.*/
    ...
    /** Return the current width of the map, in pixels.
     * 
    ...
    /* * Return the current height of the map, in pixels.
     * 
    ...
    /** Return the column and row of the tile at relative position (relx, rely)
