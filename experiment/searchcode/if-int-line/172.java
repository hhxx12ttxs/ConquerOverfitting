...
public class CodeArea extends JEditorPane implements UndoableEditListener {
    ...
    static {
        ...
        defaultInputMap.put(Platform.getKeyStroke(KeyEvent.VK_UP), DefaultEditorKit.beginAction);
        ...
        defaultInputMap.put(Platform.getKeyStroke('['), PythonEditorKit.dedentAction);
        defaultInputMap.put(Platform.getKeyStroke(']'), PythonEditorKit.indentAction);

        defaultInputMap.put(Platform.getKeyStroke(KeyEvent.VK_DOWN), DefaultEditorKit.endAction);
        defaultInputMap.put(Platform.getKeyStroke(KeyEvent.VK_UP, Event.SHIFT_MASK), DefaultEditorKit.selectionBeginAction);
        defaultInputMap.put(Platform.getKeyStroke(KeyEvent.VK_DOWN, Event.SHIFT_MASK), DefaultEditorKit.selectionEndAction);
    }
    ...
    private void init() {
        ...
        defaultInputMap.put(Platform.getKeyStroke(KeyEvent.VK_Z), new UndoAction());
        defaultInputMap.put(Platform.getKeyStroke(KeyEvent.VK_Z, Event.SHIFT_MASK), new RedoAction());
    ...
    public class DragDetector implements MouseListener, MouseMotionListener {
        ...
        public void mousePressed(MouseEvent e) {
            ...
            String text = getText();
            int[] range = numberRange(text, index);
            if (range == null) return;
            int left = range[0];
            int right = range[1];
            String number = numberForRange(text, range);
