...
/**
 * XAnnotationParseError is thrown when illegal input is parsed by the Annotation parser.
 * 
 * @author bcorne
 */
public class XAnnotationParseError extends Exception {

	private static final long serialVersionUID = 3910243526236096497L;
