 ...
 * Numerical Methods by Didier H. Besset. The code has been adapted to the OSP
 * framework by Wolfgang Christian.
 */
public class Polynomial implements Function {
	 ...
	 * @return Polynomial
	 */
	public Polynomial add(final double r) {
	 ...
	 * @version 1.2
	 */
	public double coefficient(final int n) {
	 ...
	 * @return Polynomial
	 */
	public Polynomial divide(final double r) {
		return multiply(1 / r);
	}
	 ...
	 * @return Polynomial
	 */
	public Polynomial divide(final Polynomial p) {
	 ...
	 */
	public Polynomial[] divideWithRemainder(final Polynomial p) {
	...
	/**
	 * Gets a clone of the polynomial coefficients c: c[0] + c[1] * x + c[2] *
	 * x^2 + ....
	 * 
	 * @return double[]
	 */
	 ...
	 * @return Polynomial the integral.
	 */
	public Polynomial integral(final double value) {
	 ...
	 * @return Polynomial
	 */
	public Polynomial multiply(final double r) {
		int n = coefficients.length;
		double coef[] = new double[n];
		for (int i = 0; i < n; i++) {
	 ...
	 * @return Polynomial
	 */
	public Polynomial subtract(final double r) {
		return add(-r);
	}
	...
	/**
	 * Returns the value and the derivative of this polynomial for the specified
	 ...
	 */
	public double[] valueAndDerivative(final double x) {
		int n = coefficients.length;
