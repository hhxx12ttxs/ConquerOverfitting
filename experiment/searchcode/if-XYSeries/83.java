 ...
 *
 */
public class CompassLoggerGUI extends ApplicationFrame {
...
//        series1.add(9.0, 8.0);
    ...
    private JFreeChart createChart(final XYDataset dataset) {
        ...
        final JFreeChart chart = ChartFactory.createXYLineChart(
            "Proteus Robot Compass Measurements",      // chart title
            "Time (s)",                      // x axis label
...
//        rangeAxis.setStandardTickUnits(NumberAxis.createIntegerTickUnits());
    ...
    public static void main(final String[] args) {
        ...
        final CompassLoggerGUI demo = new CompassLoggerGUI("Proteus Compass Data");
        demo.pack();
