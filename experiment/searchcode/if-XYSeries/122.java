package com.hammer_inc.nonninz.android.sensorlogger;
...
public class RecorderActivity extends Activity implements Runnable {
	public static final String INTENT_ACCELERATOR = "com.hammer_inc.nonninz.android.sensorlogger.Activity.accelerator";
	public static final String INTENT_ORIENTATION = "com.hammer_inc.nonninz.android.sensorlogger.Activity.orientation";
	public static final String INTENT_MAGNETIC = "com.hammer_inc.nonninz.android.sensorlogger.Activity.magnetic";
	public static final String INTENT_LIGHT = "com.hammer_inc.nonninz.android.sensorlogger.Activity.light";
	public static final String INTENT_SAMPLING_RATE = "com.hammer_inc.nonninz.android.sensorlogger.Activity.samplingrate";
	private static final int THREAD_UPDATE_GRAPH_DELAY = 250;
	
	private SensorRecorder mRecorder;
	private boolean mAccelerator, mOrientation, mMagnetic, mLight;
	...
	private void startRecording() {
		try {
			mRecorder.startRecording(mAccelerator, mOrientation, mMagnetic, mLight, mSamplingRate);
