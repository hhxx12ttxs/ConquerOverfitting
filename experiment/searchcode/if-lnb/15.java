...
public class LineNumberedBorder extends AbstractBorder {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3917194258332100443L;
	...
	public static void main(final String[] args) {
		...
		int[] sides = { LineNumberedBorder.LEFT_SIDE, LineNumberedBorder.LEFT_SIDE, LineNumberedBorder.RIGHT_SIDE, LineNumberedBorder.RIGHT_SIDE };

		int[] justified = { LineNumberedBorder.LEFT_JUSTIFY, LineNumberedBorder.RIGHT_JUSTIFY, LineNumberedBorder.LEFT_JUSTIFY,
				LineNumberedBorder.RIGHT_JUSTIFY };

		String[] labels = { "Left Side/Left Justified", "Left Side/Right Justified", "Right Side/Left Justified", "Right Side/Right Justified" };
		...
		for (int idx = 0; idx < labels.length; idx++) {
			...
			if (useMultipleBorders) {
				textArea.setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createEmptyBorder(5, 5, 5, 5),
						javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createLineBorder(java.awt.Color.red, 1),
								javax.swing.BorderFactory.createCompoundBorder(lnb, javax.swing.BorderFactory.createLineBorder(java.awt.Color.blue, 1)))));
			} else {
	 ...
	 */
	private static String padLabel(final int lineNumber, final int length, final boolean addSpace) {
	...
	public LineNumberedBorder(final int location, final int justify) {
	 ...
	 */
	private int lineNumberWidth(final JTextArea textArea) {
		//
	...
	public void setLineNumberJustification(final int justify) {
...
// corelyzer.ui.LineNumberedBorder
