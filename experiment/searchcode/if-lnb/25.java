...
public class AltaEq extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(cete.CeteApp.class).getContext().getResourceMap(AltaEq.class);
        ...
        tipoparte.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Aire acondicionado", "Amplificador", "Antena de radio", "Antena edusat", "Bocinas", "Calculadora", "Ca?on", "Concentrador", "CPU", "Decodificador", "DVD player", "Fotopuente", "ID-card", "Impresora", "Interface", "LNB", "Mesa A", "Mesa B", "Mesa Cz", "Mesa Dz", "Mesa E", "Monitor", "Mouse", "UPS", "Pizarra interactiva", "Radio", "Regulador", "Sensor Fuerza", "Sensor luz", "Sensor movimiento", "Sensor polea", "Sensor temp", "Sensor Voltaje", "Sonido", "Teclado", "Telefono ip", "VHS player" }));
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(reporte, javax.swing.GroupLayout.DEFAULT_SIZE, 147, Short.MAX_VALUE))
                            .addGroup(layout.createSequentialGroup()
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(serie, javax.swing.GroupLayout.DEFAULT_SIZE, 202, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jLabel14))
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(jLabel7)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(inv, javax.swing.GroupLayout.DEFAULT_SIZE, 201, Short.MAX_VALUE))
                            .addGroup(layout.createSequentialGroup()
    ...
    private boolean validar() {
        ...
        if (marca.getText().equals("") == true) {
            ...
            ban = false;
                ...
                unete.isSelected() || moder.isSelected() || video.isSelected())) {
            ban = false;
        } else {
            ban = true;
        }
            ...
            try {
                ...
                if (noexiste == true) {
                    ...
                    int a = stmt.executeUpdate("insert into equipos (cct, folio, tipo," +
                            ...
                            "('" + header.substring(5, 15) + "','" + folio.getText() + "','" + tipoparte.getSelectedItem() + "','" + marca.getText() + "'," +
