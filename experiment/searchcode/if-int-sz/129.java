 ...
 * for details.
 */
public final class Form55ci extends InsnFormat {
    /** {@code non-null;} unique instance of this class */
    public static final InsnFormat THE_ONE = new Form55ci();
    ...
    @Override
    public int codeSize() {
        return 5; // short short int short
    }
    ...
    public void writeTo(AnnotatedOutput out, DalvInsn insn) {
        CstIndyInsn indyInsn = (CstIndyInsn) insn;
        RegisterSpecList regs = explicitize(insn.getRegisters());
        int cpi = indyInsn.getIndex();
        int sz = regs.size();
        ...
        int callSiteNumber = indyInsn.getCallSiteNumber();

        write(out, opcodeUnit(insn, makeByte(r4, sz)), // encode the fifth operand here
                (short) cpi,
                (short) callSiteNumber,
                (short) (callSiteNumber >> 16),
