...
public class HW2RLforHW3 extends AdvancedRobot implements LUTInterface {
	...
	static File winRate = new File ("d:\\winRateLUT.txt");
...
//		}
	...
	// save state-action pair and q-value
	@Override
...
//			if (tmpMax > max) {
//				// here is the key
//				// q-value is no longer from qtable, but from NN approximation
//				max = tmpMax;
//				//original max
//				//max = qtable[actionMaxQValue][i];
//				action = i;
//			}
//
//		}
