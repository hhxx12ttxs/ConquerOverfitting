...
public class branchBoundCota {
    ...
    /**
     * Calcula el cost de el vector de assignacion de un possible soluci贸
     * @param b Vector de assignacion de un node
     * @param n Posici贸 de la assignacio realitzada
    ...
    /** 
     *  Metode que calcula de forma aleatoria una possible soluci贸 i el seu cost
     */
    public void greedy() {
