...
public class HistoEqualizationForRBG
{
	...
	public static void main (String args[]) throws IOException
	{
		...
		HistoEqualizationForRBG	 he = new HistoEqualizationForRBG();
		...
		for(int h = 0;h<height;h++)
		{
			...
			System.out.println("-----------------------------------");
			System.out.println(storePixelRed[h][w]);
			System.out.println(storePixelGreen[h][w]);
			System.out.println(storePixelBlue[h][w]);
