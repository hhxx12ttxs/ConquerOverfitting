...
public class LatvianStemmer {
  ...
  static final Affix affixes[] = {
    ...
    new Affix("?",     1, false), new Affix("?",     1, false),
    new Affix("?",     1, false), new Affix("o",     1, false),
    new Affix("s",     0, false), new Affix("",     0, false),
  };
