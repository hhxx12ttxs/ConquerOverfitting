...
/**
 * @author dcollins
 * @version $Id: AnalyticSurfaceLegend.java 13015 2010-01-18 21:50:50Z tgaskins $
 */
public class AnalyticSurfaceLegend implements Renderable
{
    ...
    {
        return this.screenImage.getScreenLocation();
    }
    ...
    protected void drawLabel(DrawContext dc, LabelAttributes attr, double x, double y, String halign, String valign)
    {
        ...
        Point location = this.getScreenLocation();
        if (location != null)
        {
