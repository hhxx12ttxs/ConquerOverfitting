...
public class WekaJ48TreeParser extends TreeNodeParser 
{
	 ...
	 * 
	 * @param id Node ID to be turned into a TreeNode.
	 * 
	 * @return TreeNode encoded with the relevant node details, including 
	 *         descendants.
	 *         
	 * @throws TreeNodeException Thrown on errors constructing the node.
	 */
					...
					for (String edgeLine : this._lines)
					{
						...
						if (edgeLine.startsWith(id + "->"))
						{
							...
							if ("=".equals(comparison))
							{
								...
								{
									// Looking for a specific value. Associate the 
									// node with a normal priority "equals" condition.
	 ...
	 * 
	 * @param line Line representing the leaf node.
	 * 
