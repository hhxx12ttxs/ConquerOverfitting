 ...
 * 
 * @version $Id: GpxCreator.java 888 2011-03-14 19:44:44Z rcgroot@gmail.com $
      ...
      try
      {
         ...
         if( waypointsCursor.moveToFirst() )
         {
            do
            {
               ...
               int signalstrength = waypointsCursor.getInt( 8 );
               if( speed > 0.0 )
               {
               ...
               quickTag( serializer, NS_GPX_10, "signal_strength", Integer.toString( signalstrength ) );
