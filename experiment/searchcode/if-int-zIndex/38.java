...
public class FloatingDiv {
	 ...
	 *            a z-index.
	 * @param anOpacity
	 *            an opacity. Negative number means no opacity will be set.
	 */
	 ...
	 *            a rectangle.
	 * @param aBackgroundColor
	 *            a background color. E.g. <code>#000000</code> or
	 *            <code>silver</code>.
	 * @param aBorderColor
	 *            a border color. E.g. <code>#000000</code> or
	 *            <code>silver</code>.
	 * @param aZIndex
	 *            a z-index.
	 * @param anOpacity
	 ...
	 * 
	 * <p>
	 * It also updates the inserted floating div.
	 * </p>
	 * 
	 * @param document
	 *            a document where the floating div will be created.
	 * @param aParentElement
	 *            an element where the floating div will be inserted.
	 * @param id
	 *            an id.
	 * 
	...
	/**
	 * 
	 * Updates the specified floating div element with new rectangle
	 * coordinates.
	 * 
	 * @param divElement
	 *            a floating div element.
	 * @param newRectangle
	 *            a new rectangle.
	 * 
	 * @throws NoFloatingDivElement
	 *             if no element has been inserted.
	 * 
	 * @see #update()
		...
		divElement
				.setAttribute(
						...
						"position: absolute;" + "z-index: "
								...
								+ "overflow: visible;"
								+ "background-color: "
								+ (backgroundColorText == null ? colorToHTMLColor(backgroundColor)
										: backgroundColorText)
								+ ";"
								+ "/*background-color: transparent;*/"
								+ "border: "
								+ (borderColorText == null ? colorToHTMLColor(borderColor)
										: borderColorText)
								+ " 1px solid;"
								+ "padding: 0px;"
