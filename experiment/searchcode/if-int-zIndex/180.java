...
public class Layer extends OpenLayersEObjectWrapper {
    ...
    public void setIsBaseLayer(boolean isBaseLayer) {
        LayerImpl.IMPL.setIsBaseLayer(isBaseLayer, getJSObject());
    }
    ...
    public boolean isBaseLayer() {
        return LayerImpl.IMPL.isBaseLayer(getJSObject());
    }

    public String getId() {
        return LayerImpl.IMPL.getId(getJSObject());
    }

    public float getOpacity() {
        return LayerImpl.IMPL.getOpacity(getJSObject());
    }

    public void setOpacity(float opacity) {
        LayerImpl.IMPL.setOpacity(opacity, getJSObject());
    }
    ...
    public boolean displayInLayerSwitcher() {
        return LayerImpl.IMPL.displayInLayerSwitcher(getJSObject());
    }

    public void setDisplayInLayerSwitcher(boolean display) {
        LayerImpl.IMPL.setDisplayInLayerSwitcher(display, getJSObject());
    }
    ...
    public String getName() {
        return LayerImpl.IMPL.getName(getJSObject());
    }
    ...
    public boolean isVisible() {
        return LayerImpl.IMPL.isVisible(getJSObject());
    }

    public void setIsVisible(boolean isVisible) {
        LayerImpl.IMPL.setIsVisible(isVisible, getJSObject());
    }

    public boolean redraw() {

        /* super class redraw doesn't have a force.  But we'll pass through a value since the JSNI expects one */
        return LayerImpl.IMPL.redraw(getJSObject(), true);
    }
    ...
    public void setZIndex(int zIndex) {
        LayerImpl.IMPL.setZIndex(getJSObject(), zIndex);
    }
    ...
    public void destroy(boolean setNewBaseLayer) {
        LayerImpl.IMPL.destroy(getJSObject(), setNewBaseLayer);
    }
    ...
    public Object getZIndex() {
        return LayerImpl.IMPL.getZIndex(getJSObject());
    }

    public void addOptions(LayerOptions layerOptions) {
        LayerImpl.IMPL.addOptions(getJSObject(), layerOptions.getJSObject());
    }

    public Layer clone() {
        return narrowToLayer(LayerImpl.IMPL.clone(getJSObject()));
    }
    ...
    public double getResolutionForZoom(double zoom) {
        double result = -1;
        if (this.isBaseLayer()) {
            result = LayerImpl.IMPL.getResolutionForZoom(getJSObject(), zoom);
        }
        return result;
    }

    public Projection getProjection() {
        return Projection.narrowToProjection(LayerImpl.IMPL.getProjection(getJSObject()));
    }
}
