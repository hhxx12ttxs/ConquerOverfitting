 ...
 * @author epp2115
 */
public class SupervisorPie extends ApplicationFrame {
    ...
    public SupervisorPie(String js) {
        super("");
    ...
    private PieDataset createDataset(String js) {
        ...
        try {
            ...
            Logger.getLogger(SupervisorPie.class.getName()).log(Level.SEVERE, null, ex);
        }
  ...
  if (filename_png != null) {
            ...
            filename_png = new File(path +  "\\web\\img\\graphs\\supervisorPie.png");//"/web/supervisorPie.png");
