...
public class Constants {
    ...
    public static final String PROCEDURE_SYNC_PATTERN = "/json/procedure/sync/";
    ...
    public static final String DEFAULT_XML_PROCEDURE_PATH = "/sdcard/sana/"; // used for loading xml procedures from the sd card
