...
public class Constants {
    ...
    public static final String VALIDATE_CREDENTIALS_PATTERN = "/api/status/";
    public static final String PROCEDURE_SUBMIT_PATTERN = "/api/case/";
    public static final String BINARYCHUNK_SUBMIT_PATTERN = "/api/binary/";
    public static final String BINARYCHUNK_HACK_SUBMIT_PATTERN = "/api/text/";
    public static final String DATABASE_DOWNLOAD_PATTERN = "/api/patient/";
    public static final String USERINFO_DOWNLOAD_PATTERN = "/api/patient/";
    public static final String PROCEDURELIST_DOWNLOAD_PATTERN = "/api/procedure/";
    
    public static final String AUDIO_TEMP_PATH = "/sdcard/temp.mp4";
    ...
    public static final String DEFAULT_DISPATCH_SERVER = "http://moca.media.mit.edu/mds-demo";
    public static final String DEFAULT_USERNAME = "admin";
    public static final String DEFAULT_PASSWORD = "Mocamobile1";
