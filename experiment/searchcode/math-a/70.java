...
import org.moca.R;
import org.moca.activity.SavedProcedureList;
...
public class Settings extends PreferenceActivity {
	...
	private PreferenceScreen createPreferenceHierarchy() {
		...
		emrUsername.setDefaultValue(getString(R.string.app_username));
		...
		emrPassword.setDefaultValue(getString(R.string.app_password));
        ...
        // Manage saved procedures
        PreferenceScreen encounterMgr = getPreferenceManager()
        								.createPreferenceScreen(this);
        encounterMgr.setIntent(new Intent(Settings.this, 
        		SavedProcedureList.class)
        		.setDataAndType(SavedProcedureSQLFormat.CONTENT_URI,
        						SavedProcedureSQLFormat.CONTENT_TYPE));
        encounterMgr.setTitle(getString(R.string.setting_manage_data));
        encounterMgr.setSummary(getString(R.string.setting_manage_data_summary));
        dialogBasedPrefCat.addPreference(encounterMgr);
        
        // SD card loading procedures
        /*
        PreferenceScreen dbBackup = getPreferenceManager()
        								.createPreferenceScreen(this);
        dbBackup.setOnPreferenceClickListener(
        	new Preference.OnPreferenceClickListener() {
        		public boolean onPreferenceClick(Preference preference) {
        			try {
						MocaUtil.backupDB(getApplicationContext());
					} catch (IOException e) {
						e.printStackTrace();
						return false;
					}
        ...
        dbBackup.setTitle("Back up data");
        dbBackup.setSummary("Copies Application sqlite db to SD card");
        dialogBasedPrefCat.addPreference(dbBackup);
        */
