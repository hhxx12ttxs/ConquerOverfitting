...
/**
 * An ADFArgument is a GPNode which represents an ADF's <i>argument
 * terminal</i>, its counterpart which returns argument values in its associated
 * function tree. In lil-gp this is called an ARG node.
 * 
 * <p>
 * Obviously, if you have Argument Terminals in a tree, that tree must be only
 * callable by ADFs and ADMs, otherwise the Argument Terminals won't have
 * anything to return. Furthermore, you must make sure that you don't have an
 * Argument Terminal in a tree whose number is higher than the smallest arity
 * (number of arguments) of a calling ADF or ADM.
 * 
 * <p>
 * <b>Parameters</b><br>
 * <table>
 * <tr>
 * <td valign=top><i>base</i>.<tt>arg</tt><br>
 * <font size=-1>int &gt;= 0</font></td>
 * <td valign=top>(The related argument position for the ADF Argument Node in
 * the associated ADF)</td>
 * </tr>
 * </table>
 * 
 * <p>
