...
class Entities
{
	...
	{
		private Hashtable<String, Integer> mapNameToValue = new Hashtable<String, Integer>();
		private Hashtable<Integer, String> mapValueToName = new Hashtable<Integer, String>();
