...
import com.cluster.beatrice.MusicUtils.ServiceToken;
        ...
        implements View.OnCreateContextMenuListener, MusicUtils.Defs, ServiceConnection
{
    ...
    {
            finish();
            overridePendingTransition(R.anim.recent_enter, R.anim.lock_screen_exit);
    }
    ...
    public void onCreate(Bundle icicle)
    {
        ...
        if (mEditMode) {
            ...
            mTrackList.setBackgroundResource(R.drawable.listview_background);
