...
public class Main {
	...
	public static Coordonnee ask() {
		...
		System.out.print("Entrer la latitude (0 ŕ 200):");
		int latitude = sc.nextInt();
		System.out.print("Entrer la longitude (0 ŕ 250):");
	...
	//Methode clearTroncons qui va supprimer les troncons oů il y a un incident de la liste des troncons
	...
	public static void main(String[] args) {
		...
		while(choix!=1 && choix!=2 && choix!=3 && choix!=4){
			...
			case 1 :
				...
				System.out.println("\nVeuillez vous rendre ŕ la station : "+proche.getNom());
				...
				System.out.println("\nVotre arrivee se fera a l'arręt : "+arrivee.getNom());
				
				//Recherche d'un chemin a partir du depart voulu par l'utilisateur de maničre la plus rapideZ
				path = dijkstraAlgorithm.getPath(arrivee);
				System.out.println("\nVoici les stations ŕ suivre pour arriver ŕ la station "+arrivee.getNom()+": ");
			...
			case 4 :
				System.out.println("Mise ŕ jour des Stations UnE, CinqA, DeuxF, TroisG, et SeptF");
