...
public class CIMDateTimeInterval extends CIMDateTime {
	...
	/**
	 * Determines whether the <code>CIMDateTimeInterval</code> that is passed in
	 * is equal to the current <code>CIMDateTimeInterval</code> object.
	 * 
	 * @param pObj
	 *            The <code>CIMDateTimeInterval</code> object to compare to.
	 * @return <code>true</code> if this <code>CIMDateTimeInterval</code> object
	 *         is equal to the one that was passed in, otherwise
	 *         <code>false</code>.
	 */
	@Override
	public boolean equals(Object pObj) {
		if (!(pObj instanceof CIMDateTimeInterval)) return false;
		CIMDateTimeInterval that = (CIMDateTimeInterval) pObj;
