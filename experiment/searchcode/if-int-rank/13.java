...
public class L2Clan
{
	...
	public static final int CP_STANDARD_ALL = 0x00FFFFFF;
	public static final int CP_CL_WITHDRAWL = 0x1000000;
	/** Privilege to manage all clan activity */
	public static final int CP_ALL = 0x7FFFFFFF;
	...
	public boolean levelUpClan(L2PcInstance player)
	{
		...
		switch (getLevel())
		{
			...
			{
				// Upgrade to 1
				if (player.getSp() >= 20000 && player.getAdena() >= (long)(650000 * Config.RATE_COST_EVERYTHING))
				{
					if (player.reduceAdena("ClanLvl", (long)(650000 * Config.RATE_COST_EVERYTHING), player.getTarget(), true))
					{
			...
			{
				// Upgrade to 2
				if (player.getSp() >= 100000 && player.getAdena() >= (long)(2500000 * Config.RATE_COST_EVERYTHING))
				{
					if (player.reduceAdena("ClanLvl", (long)(2500000 * Config.RATE_COST_EVERYTHING), player.getTarget(), true))
					{
