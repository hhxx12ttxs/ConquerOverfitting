...
public class NSGA2Evaluator extends SimpleEvaluator {
     ...
     * create the archive (it's the size of the original population -- keep in
     * mind that NSGA2Breeder had made the population larger to include the
     * children.
     */
    ...
    /**
     * Evaluates the population, then builds the archive and reduces the
     * population to just the archive.
     */
        ...
        for (int i = 0; i < numObjectives; i++) {
            ...
            ec.util.QuickSort.qsort(front, new SortComparator() {
                public boolean lt(Object a, Object b) {
                    Individual i1 = (Individual) a;
                    Individual i2 = (Individual) b;
                    return (((NSGA2MultiObjectiveFitness) i1.fitness).getObjective(o) < ((NSGA2MultiObjectiveFitness) i2.fitness)
                            .getObjective(o));
                }
