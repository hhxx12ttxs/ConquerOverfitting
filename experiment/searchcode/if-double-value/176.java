...
//                }
              throw new UnsupportedOperationException("NativeJavaObject");
            }
            else {
                if (to == ScriptRuntime.StringClass) {
...
//                }
        ...
        case JSTYPE_JAVA_ARRAY:
            ...
            else if (isPrimitive(to) ) {// && to != boolean.class) {
...
//                    }
    ...
    private static boolean isPrimitive(Class to) {
        throw new UnsupportedOperationException("ScriptRuntime isPrimitive");
	}
...
//            return 8;
//        }
        throw new UnsupportedOperationException("NativeJavaObject - toDouble");
    }
    ...
    static Object coerceTypeImpl(Class type, Object value)
    {
        ...
        case JSTYPE_NUMBER:
            ...
            else if ((isPrimitive(type)) && //type != boolean.class) ||
...
throw new UnsupportedOperationException("NativeJavaObject");
    ...
    private static Object coerceToNumber(Class type, Object value)
    {
        ...
        // Character
        if (type == ScriptRuntime.CharacterClass) { //|| type == char.class
        ...
        if (type == ScriptRuntime.ObjectClass ||
            type == ScriptRuntime.DoubleClass ){//|| type == double.class) {
