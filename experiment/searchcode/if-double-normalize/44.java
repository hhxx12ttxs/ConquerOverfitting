...
//		);
	...
	public void updateProjectionInfos(){
		...
		_myGraphics.gl.glGetDoublev(GL.GL_PROJECTION_MATRIX, proj, 0);

		// get modelview matrix
		_myGraphics.gl.glGetDoublev(GL.GL_MODELVIEW_MATRIX, model, 0);
	}
	...
	public CCVector3f screenToModel(final int theMouseX, final int theMouseY) {
		...
		_myGraphics.gl.glReadPixels(theMouseX, _myGraphics.height - theMouseY, 1, 1, GL.GL_DEPTH_COMPONENT, GL.GL_FLOAT, myFloatBuffer);
