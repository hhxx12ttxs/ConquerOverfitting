...
public class viewBalanceSheet extends Composite {
	 ...
	 public viewBalanceSheet(Composite parent, int style) 
	{
		...
		lblviewBalanceSheet.setFont(new Font(display, "Times New Roman", 20, SWT.BOLD));
		layout = new FormData();
		layout.top = new FormAttachment(lblLine,40);
		...
		lblperiod.setFont( new Font(display,"Times New Roman", 16, SWT.NORMAL ) );
		lblperiod.setText("\n\n"+"Period: "+" From: "+globals.session[2]);
		layout = new FormData();
		layout.top = new FormAttachment(lblviewBalanceSheet,30);
		layout.left = new FormAttachment(35);
		//layout.right = new FormAttachment(53);
		//layout.bottom = new FormAttachment(18);
		...
		lblto.setFont(new Font(display,"Times New Roman", 16, SWT.NORMAL ));
		lblto.setText("T&o:");
		layout = new FormData();
		...
		lblbalsheettype.setText("&Balance Sheet Type:");
		lblbalsheettype.setFont(new Font(display, "Times New Roman", 16, SWT.NORMAL));
		layout = new FormData();
		layout.top = new FormAttachment(txtyrdate,15);
		layout.left = new FormAttachment(31);
		...
		drpdwnBalanceSheet.add("Sources & Application of fund");
		...
		layout = new FormData();
		layout.top = new FormAttachment(drpdwnBalanceSheet,80);
