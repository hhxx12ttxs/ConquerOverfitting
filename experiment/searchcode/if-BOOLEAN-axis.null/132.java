...
public abstract class Texture implements Savable {
    ...
    public Transform getTransform(final Transform store) {
        return store.set(_transform);
    }
    ...
    public void getTransform(final FloatBuffer store, final boolean rowMajor) {
        final Matrix4 mat4 = _transform.getHomogeneousMatrix(Matrix4.fetchTempInstance());
        mat4.toFloatBuffer(store, rowMajor);
        Matrix4.releaseTempInstance(mat4);
    }
    ...
    public void write(final Ardor3DExporter e) throws IOException {
        ...
        capsule.write(_transform, "transform", new Transform(Transform.IDENTITY));
    ...
    public void read(final Ardor3DImporter e) throws IOException {
        ...
        _transform.set((Transform) capsule.readSavable("transform", new Transform(Transform.IDENTITY)));
