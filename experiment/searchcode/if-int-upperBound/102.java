 ...
 * RandomRestarts has two ways of determining when to perform a restart. If the
 * restart type is "fixed", then the restart will occur precisely when the
 * generation is a multiple of restart-upper-bound, minus one. (That's hardly
 * random, of course). If the restart type is "random", then at the beginning of
 * the run, and after every restart, a new restart is chosen randomly from one
 * to restart-upper-bound.
 * 
 * <p>
 ...
 *         <table>
 *         <tr>
 *         <td valign=top><i>base</i>.<tt>restart-type</tt><br>
 *         <font size=-1>random or fixed</font></td>
 *         <td valign=top>Either initiates clock at a random value or a fixed
 *         one.</td>
 *         </tr>
 *         <tr>
 *         <td valign=top><i>base</i>.<tt>restart-upper-bound</tt><br>
 *         <font size=-1>1 &lt; int &lt; \inf</font></td>
 *         <td valign=top>Maximum time clock can initiate with.</td>
 *         </tr>
 *         </table>
 */
