...
public abstract class Tools {
    ...
    public static Section.MAP getUseSectionMap( Expression e, RangeDomain rd, Set<Symbol> def_vars ) {
        ...
        if ( expr instanceof ArrayAccess ) {
            ...
            Set use_set = Tools.getUseSet( expr );
            if ( use_set.size() == 1 ) {
     ...
     */
    public static void replaceSymbolIn
    ( Traversable t, Symbol var, Expression e ) {
    ...
    */
    ...
    containsExprs( Traversable t, Collection<? extends Expression> es ) {
        for ( Expression e : es )
            if ( containsExpr( t, e ) )
                return true;
        return false;
    ...
    public static boolean containsIO( Traversable t ) {
        ...
        Set<String> io = new HashSet( Arrays.asList(
    ...
    public static boolean isStdLibCall( FunctionCall fc ) {
        Set<String> stdlib = new HashSet( Arrays.asList(
    ...
    */
     ...
     */
    public static List<Traversable> getDescendentsOfType
    ( Traversable t, Class type ) {
