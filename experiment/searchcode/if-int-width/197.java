...
public class LwjglRenderer extends Renderer {
     ...
     */
    public LwjglRenderer(final int width, final int height) {
        if (width <= 0 || height <= 0) {
        ...
        logger.fine("LwjglRenderer created. W:  " + width + "H: " + height);
    ...
    public void clearBuffers() {
        ...
        // XXX: This is not quite right in multi-context situations. Need to revisit.
        if (defaultStateList.containsKey(RenderState.StateType.ZBuffer)) {
