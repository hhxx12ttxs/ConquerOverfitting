...
public class ImageReconstruction 
{
	...
	public void reconstruction(int storePixelRedSp[][],int storePixelGreenSp[][],int storePixelBlueSp[][],int cdfRedSp[],int cdfGreenSp[],int cdfBlue[],int height,int width) throws IOException
	{
