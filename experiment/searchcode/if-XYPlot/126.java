...
public class ImperialWithUI extends GUIState{
    ...
    private CategoryDataset createDataset(String label) {
        ...
        String name1 = (new Kull(2,2)).getName();
        String name2 = (new Guevara(2,2)).getName();
        String name3 = (new aMyYourLord(2,2)).getName();
        String name4 = (new WhenIamKing(2,2)).getName();
    ...
    private XYDataset createSeriesDataset() {
        ...
        E1 = new TimeSeries((new Kull (2,2)).getName());
        E2 = new TimeSeries((new Guevara(2,2)).getName());
        E3 = new TimeSeries((new aMyYourLord(2,2)).getName());
        E4 = new TimeSeries((new WhenIamKing(2,2)).getName());
