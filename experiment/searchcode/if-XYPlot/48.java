...
public class HistogramPlotPane extends JPanel {
	...
	xyplot.setNoDataMessage("Not enough data");
	...
	if (argv.length == 0) {
	    System.out.println("Usage: HistogramPlotPane TARGET_CLASS");
	    System.exit(1);
	}

	URL url = new URL ("http://tripod.nih.gov/chembl/fragment-activity/"
			   + argv[0]);

	java.util.List<Double> activities = new ArrayList<Double>();
