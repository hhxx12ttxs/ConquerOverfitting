 ...
 */
package net.sf.fspdfs.chartthemes.spring;
...
import net.sf.fspdfs.charts.ChartContext;
import net.sf.fspdfs.charts.ChartTheme;
import net.sf.fspdfs.charts.JRAreaPlot;
import net.sf.fspdfs.charts.JRBar3DPlot;
import net.sf.fspdfs.charts.JRBarPlot;
import net.sf.fspdfs.charts.JRBubblePlot;
import net.sf.fspdfs.charts.JRCandlestickPlot;
import net.sf.fspdfs.charts.JRChartAxis;
import net.sf.fspdfs.charts.JRDataRange;
import net.sf.fspdfs.charts.JRHighLowPlot;
import net.sf.fspdfs.charts.JRItemLabel;
import net.sf.fspdfs.charts.JRLinePlot;
import net.sf.fspdfs.charts.JRMeterPlot;
import net.sf.fspdfs.charts.JRPie3DPlot;
import net.sf.fspdfs.charts.JRPiePlot;
import net.sf.fspdfs.charts.JRScatterPlot;
import net.sf.fspdfs.charts.JRThermometerPlot;
import net.sf.fspdfs.charts.JRTimeSeriesPlot;
import net.sf.fspdfs.charts.JRValueDisplay;
import net.sf.fspdfs.charts.type.EdgeEnum;
import net.sf.fspdfs.charts.type.MeterShapeEnum;
import net.sf.fspdfs.charts.type.ScaleTypeEnum;
import net.sf.fspdfs.charts.type.ValueLocationEnum;
import net.sf.fspdfs.charts.util.JRMeterInterval;
import net.sf.fspdfs.engine.JRChart;
import net.sf.fspdfs.engine.JRChartDataset;
import net.sf.fspdfs.engine.JRChartPlot;
import net.sf.fspdfs.engine.JRException;
import net.sf.fspdfs.engine.JRExpression;
import net.sf.fspdfs.engine.JRFont;
import net.sf.fspdfs.engine.JRLineBox;
import net.sf.fspdfs.engine.JRRuntimeException;
import net.sf.fspdfs.engine.JRChartPlot.JRSeriesColor;
import net.sf.fspdfs.engine.base.JRBaseFont;
import net.sf.fspdfs.engine.fill.DefaultChartTheme;
import net.sf.fspdfs.engine.type.ModeEnum;
import net.sf.fspdfs.engine.util.JRFontUtil;
...
//				);
	...
	/**
	 * Converts a fspdf data range into one understood by JFreeChart.
	 *
	 * @param dataRange the fspdf version of the range
