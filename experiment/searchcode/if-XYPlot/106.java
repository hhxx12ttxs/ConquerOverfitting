...
//Esta clase permite Representar las seńales y realizar muchos tratamientos sobre ellas
...
public class Representar extends ListFicheros implements OnTouchListener{
	...
	double[] data;
	//Declaración de variables necesarias para trabajar con la seńal
	...
	//Método que permite hacer touch con los dedos para el zoom y el scroll de la seńal
	...
	public boolean onOptionsItemSelected(MenuItem item)
	{
		...
		case R.id.filtroau:
			...
			//Seleccionar si se redibuja la seńal con o sin los puntos que la forman
			SeleccionarModoRepintado();
			
			Toast.makeText(getApplicationContext(),"Seńal filtrada correctamente", Toast.LENGTH_LONG).show();
		...
		case R.id.interpolacion:
			//Calcular interpolación de la seńal
			double frec=4;
			double fr = 1/frec;
			...
			Toast.makeText(getApplicationContext(),"Seńal interpolada correctamente", Toast.LENGTH_LONG).show();
		...
		case R.id.exportarjpeg:
			//Lanzar activity para recoger el nombre con el que exportar la imagen de la seńal
		...
		case R.id.restaurarimg:
			//Restaurar la seńal a la posición inicial
			setContentView(R.layout.representar);
			...
			Toast.makeText(getApplicationContext(), "La seńal ha sido restaurada correctamente", Toast.LENGTH_LONG).show();
			return true;

		case R.id.restaurarsen:
			comprobacion=0;
			//Restaurar la seńal al estado inicial
			setContentView(R.layout.representar);
		...
		case R.id.verdel:
			//Validaciones del color de la seńal
		...
		case R.id.verdep:
			//Validaciones del color de los puntos de la seńal
			color3=0;
			color4=200;
			color5=0;
			mySimpleXYPlot.clear();
	...
	//Método que establece la configuración inicial de la seńal
	public void ConfigurarSeńal()
	{
	...
	//Método que permite realizar zoom y scroll sobre la seńal haciendo touch sobre la pantalla
	...
	//Función que selecciona si se redibuja la seńal con o sin los puntos que la conforman
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		//Si el caso es 1, es el caso de editar la seńal
		if (requestCode == 1) {
			...
			if(resultCode == RESULT_OK){  
				...
				mySimpleXYPlot = (XYPlot) findViewById(R.id.mySimpleXYPlot);
				//Permite el zoom y scroll de la seńal haciendo touch en la pantalla
				Touchable();

				mySimpleXYPlot.clear();
				//Repintar la seńal con o sin los puntos que la forman
				SeleccionarModoRepintado();
				
				Toast.makeText(getApplicationContext(),"Seńal editada correctamente", Toast.LENGTH_LONG).show();
		...
		//Si el caso es 3 es el modo de exportar imagen en formato JPEG
			...
			{  
				...
				try{
					...
					Toast.makeText(Representar.this, "Seńal exportada en formato JPEG", Toast.LENGTH_LONG).show();
		...
		//Si el caso es 4
			...
			{  
				...
				try{
					...
					Toast.makeText(Representar.this, "Seńal exportada en formato PNG", Toast.LENGTH_LONG).show();
