	...
	protected ItemView getView(ItemView viewType, Style viewStyle)
	{
		if (this.view == null || this.view.getClass() != viewType.getClass()) {
			try {
				...
				//#debug error
de.enough.polish.util.Debug.debug("error", "de.enough.polish.ui.Item", 1258, "Container: Unable to init view-type ", e );
			}
		}
		return this.view;
	}
	...
	public void notifyStateChanged()
	{
		if (this.itemStateListener != null) {
			try {
				...
				//#debug error
de.enough.polish.util.Debug.debug("error", "de.enough.polish.ui.Item", 2246, "Unable to forward ItemStateChanged event to listener " + this.itemStateListener, e );
			}
		}
...
//	}
	...
	protected boolean handleCommand( Command cmd ) {
		...
		try {
			...
			//#debug error
de.enough.polish.util.Debug.debug("error", "de.enough.polish.ui.Item", 3728, "Unable to handle command " + cmd.getLabel(), e );
		}
		return false;
	}
