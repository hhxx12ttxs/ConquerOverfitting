...
public class TestUtils {
    ...
    static Product createProduct(DataPeriod dataPeriod, DataPeriod.Membership firstPeriod, DataPeriod.Membership lastPeriod) {
        ...
        switch (firstPeriod) {
            ...
            case CURRENT_PERIOD: {
                // for first pixel in current period: create a product that crosses -180째 after T0 + 10 * H and before T0 + (10 + 24) * H
            ...
            case SUBSEQUENT_PERIODS: {
                // for first pixel in current period: create a product that crosses -180째 after T0 + (10 + 24) * H
