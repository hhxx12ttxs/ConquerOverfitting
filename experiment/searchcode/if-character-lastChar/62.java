...
class ParserState
{
     ...
     *
     * @throws Exception if the date cannot be set for some
     *                                 reason
     */
        ...
        if (year != UNSET && month != UNSET && day != UNSET) {
            ...
            if (!ignoreChanges) {
                ...
                if (calYear != year || (calMonth + 1) != month ||
                    calDay != day)
                {
                    throw new Exception("Date was set to " +
                                                      calYear + "/" +
                                                      (calMonth + 1) + "/" +
                                                      calDay +
                                                      " not requested " +
     ...
     *
     * @throws Exception if the value is not a valid day of month
     */
     ...
     *
     * @throws Exception if the value is not a valid hour
     */
     ...
     *
     * @throws Exception if the value is not a valid millisecond
     */
     ...
     *
     * @throws Exception if the value is not a valid minute
     */
     ...
     *
     * @throws Exception if the value is not a valid month
     */
     ...
     *
     * @throws Exception if the value is not a valid second
     */
     ...
     *
     * @throws Exception if the value is not a valid year
     */
...
public class CalendarParser
{
        ...
        throws Exception
    {
        ...
        if (token.indexOf(':') > 0) {
            ...
            if (Character.isDigit(firstChar)) {
                ...
                throw new Exception("Unrecognized time \"" +
                                                  token + "\" in date \"" +
                                                  dateStr + "\"");
            }
        }
        ...
        if (tmpMon != UNSET) {
            ...
            throw new Exception("Too many numbers in" +
                                              " date \"" + dateStr + "\"");
        }
        ...
        if (val == UNSET) {
            ...
            throw new Exception("Unknown string \"" + token +
                                              "\" in date \"" + dateStr +
                                              "\"");
        }
        ...
        throw new Exception("Cannot assign ordinal in \"" +
                                          dateStr + "\"");
    }
        ...
        throws Exception
    {
        ...
        if (state.isYearSet() && state.isMonthSet() && state.isDateSet()) {
            ...
            throw new Exception("Extra value \"" + val +
                                              "\" in date \"" + dateStr +
                                              "\"");
        }
        ...
        if (val < 0) {
            ...
            throw new Exception("Found negative number in" +
                                              " date \"" + dateStr + "\"");
        }
        ...
        if (val > 31) {
            ...
            if (state.getYear() > 12) {
                ...
                throw new Exception("Bad number " + val +
                                                  " found in date \"" +
                                                  dateStr + "\"");
            }
     ...
     * @return parsed date
     *
     * @throws Exception if no valid date was found.
     */
        ...
        throws Exception
    {
        ...
        if (!state.isDateSet()) {
            if (!state.isMonthSet()) {
                if (!state.isYearSet()) {
                    throw new Exception("No date found in \"" +
                                                      dateStr + "\"");
                } else {
                    throw new Exception("Day and month missing" +
                                                      " from \"" + dateStr +
                                                      "\"");
                }
            } else {
                throw new Exception("Day missing from \"" +
                                                  dateStr + "\"");
            }
        } else if (!state.isMonthSet()) {
            if (!state.isYearSet()) {
                throw new Exception("Year and month missing" +
                                                  " from \"" + dateStr + "\"");
            } else {
                throw new Exception("Month missing from \"" +
                                                  dateStr + "\"");
            }
        } else if (!state.isYearSet()) {
            throw new Exception("Year missing from \"" +
                                              dateStr + "\"");
        }
     ...
     *
     * @throws Exception if there is a problem with the time
     */
        ...
        throws Exception
    {
        ...
        if (lastChar != 'm' && lastChar != 'M') {
            ...
            if (preLast == 'a' || preLast == 'A') {
                ...
                throw new Exception("Bad time \"" + timeStr +
                                                  "\" in date \"" + dateStr +
                                                  "\"");
            }
        ...
        for (int i = 0; i < tList.length; i++) {
            ...
            case PLACE_MILLI:
                ...
                break;
            default:
                throw new Exception("Unexpected place value " +
                                                  place);
            }
        }
    }
        ...
        throws Exception
    {
        ...
        if (!isNegative && zoneStr.charAt(0) != '+') {
            throw new Exception("Bad time zone offset \"" +
                                              zoneStr + "\" in date \"" +
                                              dateStr + "\"");
        }
        ...
        for (int i = 0; i < tList.length; i++) {
            ...
            try {
                ...
                throw new Exception("Bad time zone " +
                                                  getTimePlaceString(place) +
                                                  " offset \"" + token +
                                                  "\" in \"" + dateStr + "\"");
            }
