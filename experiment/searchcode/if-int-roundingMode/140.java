...
public class Doc_PPCostCollector extends Doc
{
	 ...
	 * 	@param trxName trx
	 */
	public Doc_PPCostCollector (MAcctSchema as, ResultSet rs, String trxName)
	{
		super(as, MPPCostCollector.class, rs, MDocType.DOCBASETYPE_ManufacturingCostCollector, trxName);
	}   //Doc Cost Collector
