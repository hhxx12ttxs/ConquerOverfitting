...
/**
 * Similar to FitProportionateSelection, but with adjustments to scale
 * up/exaggerate differences in fitness for selection when true fitness values
 * are very close to eachother across the population. This addreses a common
 * problem with FitProportionateSelection wherein selection approaches random
 * selection during late runs when fitness values do not differ by much.
 * 
 * <p>
 * Like FitProportionateSelection this is not appropriate for steady-state
 * evolution. If you're not familiar with the relative advantages of selection
 * methods and just want a good one, use TournamentSelection instead. Not
 * appropriate for multiobjective fitnesses.
 * 
 * <p>
 * <b><font color=red> Note: Fitnesses must be non-negative. 0 is assumed to be
 * the worst fitness. </font></b>
 * 
 * <p>
 ...
 * <table>
 * <tr>
 * <td valign=top><i>base.</i><tt>scaled-fitness-floor</tt><br>
 ...
 * This is unacceptable for fitness proportionate style selection so we must
 * substitute the fitnessFloor (some value >= 0) for the sigma scaled fitness
 * when that sigma scaled fitness <= fitnessFloor.)</td>
 * </tr>
 * </table>
 * 
 * 
