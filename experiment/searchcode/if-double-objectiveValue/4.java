 ...
 * @author hmedal
 */
public class nCenterCyclicNetwork {
    ...
    public nCenterCyclicNetwork(double[][] distance,int n){
        this.n=n;
    ...
    public void runIterations(double coverDistanceLB,double coverDistanceUB){
        ...
        SetCoverCyclic sc = new SetCoverCyclic(distance,coverDistance);
        sc.createModel();
        sc.solve();
        centers = sc.getAssignments();
        double setCoverObjectiveValue = sc.getObjectiveValue();
    ...
    public static void exampleInNotes(){
       ...
       nCenterCyclicNetwork p = new nCenterCyclicNetwork(distances, 2);
       p.solve();
    ...
    public static void problem8EandF(){
       ...
       double[][] distances = getShortestDistances(edgesArray);
       for(int n=2;n<=3;n++){
           nCenterCyclicNetwork p = new nCenterCyclicNetwork(distances, n);
           p.solve();
           ArrayList<Integer> centers = p.getCenters();
           System.out.println(centers);
           double obj = p.getObjectiveValue();
