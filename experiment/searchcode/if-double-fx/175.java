...
public abstract class RootFinder extends FunctionalIterator {
     ...
     * @param x
     * @return
     * @see jsl.utilities.optimize.rootfinding.Interval#contains(double)
     */
     ...
     *
     * @return
     * @see jsl.utilities.optimize.rootfinding.Interval#getLowerLimit()
     */
     ...
     *
     * @return
     * @see jsl.utilities.optimize.rootfinding.Interval#getUpperLimit()
     */
