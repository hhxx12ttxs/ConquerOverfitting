...
public class UtilValidate {
	...
	public static boolean isEmpty(Object o) {
         ...
         if (o instanceof String) return UtilValidate.isEmpty((String) o);
         if (o instanceof Collection) return UtilValidate.isEmpty((Collection<? extends Object>) o);
         if (o instanceof Map) return UtilValidate.isEmpty((Map<? extends Object, ? extends Object>) o);
         if (o instanceof CharSequence) return UtilValidate.isEmpty((CharSequence) o);
    ...
    public static boolean isAlphanumeric(String s) {
        ...
        for (int i = 0; i < s.length(); i++) {
            ...
            if (!isLetterOrDigit(c) || ! String.valueOf(c).equalsIgnoreCase(" ")) return false;
        }
    ...
    public static boolean areEmpty (Object... objects) {
    	return !areNotEmpty(objects);
    }
    
    public static boolean isErrorFree (List<Constants.errorCodes> errors) {
