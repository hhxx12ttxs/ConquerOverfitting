...
public class RangeSeekBar extends View {
    ...
    public RangeSeekBar(Context context, AttributeSet attrs) {
        ...
        String s = a.getString(R.styleable.RangeSeekBar_orientationme);
        if(s != null)
        ...
        thumb = a.getDrawable(R.styleable.RangeSeekBar_thumbme);
        
        range = a.getDrawable(R.styleable.RangeSeekBar_range);
        
        track = a.getDrawable(R.styleable.RangeSeekBar_trackme);
