...
public class ConstantTest extends TestCase
{
	public RowMetaInterface createResultRowMetaInterface()
	{
		...
		ValueMetaInterface valuesMeta[] = { new ValueMeta("boolean1", ValueMetaInterface.TYPE_BOOLEAN), new ValueMeta("boolean2", ValueMetaInterface.TYPE_BOOLEAN), new ValueMeta("boolean3", ValueMetaInterface.TYPE_BOOLEAN),
			new ValueMeta("boolean4", ValueMetaInterface.TYPE_BOOLEAN), new ValueMeta("boolean5", ValueMetaInterface.TYPE_BOOLEAN), new ValueMeta("boolean6", ValueMetaInterface.TYPE_BOOLEAN), new ValueMeta("boolean7", ValueMetaInterface.TYPE_BOOLEAN),
			new ValueMeta("string1", ValueMetaInterface.TYPE_STRING), new ValueMeta("string2", ValueMetaInterface.TYPE_STRING), new ValueMeta("string3", ValueMetaInterface.TYPE_STRING), new ValueMeta("integer1", ValueMetaInterface.TYPE_INTEGER),
			new ValueMeta("integer2", ValueMetaInterface.TYPE_INTEGER), new ValueMeta("integer3", ValueMetaInterface.TYPE_INTEGER), new ValueMeta("integer4", ValueMetaInterface.TYPE_INTEGER), new ValueMeta("number1", ValueMetaInterface.TYPE_NUMBER),
			new ValueMeta("number2", ValueMetaInterface.TYPE_NUMBER), new ValueMeta("number3", ValueMetaInterface.TYPE_NUMBER), new ValueMeta("number4", ValueMetaInterface.TYPE_NUMBER), };
	...
	public void testConstant1() throws Exception
	{
		...
		String fieldName1[] = { "boolean1", "boolean2", "boolean3", "boolean4", "boolean5", "boolean6", "boolean7", "string1", "string2", "string3", "integer1", "integer2", "integer3", "integer4", "number1", "number2", "number3", "number4", };
		String type1[] = { "boolean", "Boolean", "bOOLEAN", "BOOLEAN", "boolean", "boolean", "boolean", "string", "string", "String", "integer", "integer", "integer", "integer", "number", "number", "number", "number" };
		String value1[] = { "Y", "T", "a", "TRUE", "0", "9", "", "AAAAAAAAAAAAAA", "   ", "", "-100", "0", "212", "", "-100.2", "0.0", "212.23", "" };
		String fieldFormat1[] = { "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "" };
		String group1[] = { "", "", "", "", "", "", "", "", "", "", "", "", "", "", ",", ",", ",", "," };
		String decimal1[] = { "", "", "", "", "", "", "", "", "", "", "", "", "", "", ".", ".", ".", "." };
		String currency[] = { "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "" };
