...
public final static String BusyHours3 ="busyHours";
	@Override
...
public String busyHours(){
	...
	String hours = intent.getStringExtra(Tuesday.BusyHours2);
	if (eighta.isChecked()){
		hours = hours + "1";
	}
	else{
