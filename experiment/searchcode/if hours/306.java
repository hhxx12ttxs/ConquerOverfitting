...
public class Sunday extends ActionBarActivity {
...
public final static String BusyHours7 ="busyHours";
	@Override
...
public void addListenerOnButton() {
	...
	btnDisplay.setOnClickListener(new OnClickListener() {
	  ...
	  public void onClick(View v) {
		...
		busyHours();
		Intent intent = new Intent(Sunday.this, MainPage.class);
		String message = busyHours();
		intent.putExtra(BusyHours7, message);
...
public String busyHours(){
	...
	String hours = intent.getStringExtra(Saturday.BusyHours6);
