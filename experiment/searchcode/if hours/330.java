...
public final static String BusyHours4 ="busyHours";
	@Override
...
public void addListenerOnButton() {
	...
	btnDisplay.setOnClickListener(new OnClickListener() {
	  ...
	  public void onClick(View v) {
		...
		Toast.makeText(Thursday.this, result.toString(),
				Toast.LENGTH_LONG).show();
		busyHours();
		Intent intent = new Intent(Thursday.this, Friday.class);
		String message = busyHours();
		intent.putExtra(BusyHours4, message);
...
public String busyHours(){
	...
	String hours = intent.getStringExtra(Wednesday.BusyHours3);
	if (eighta.isChecked()){
		hours = hours + "1";
	}
	else{
