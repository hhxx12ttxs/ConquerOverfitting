...
public final static String BusyHours5 ="busyHours";
...
public void addListenerOnButton() {
	...
	btnDisplay.setOnClickListener(new OnClickListener() {
	  ...
	  public void onClick(View v) {
		...
		Toast.makeText(Friday.this, result.toString(),
				Toast.LENGTH_LONG).show();
		busyHours();
		Intent intent = new Intent(Friday.this, Saturday.class);
		String message = busyHours();
		intent.putExtra(BusyHours5, message);
...
public String busyHours(){
	...
	String hours = intent.getStringExtra(Thursday.BusyHours4);
	if (eighta.isChecked()){
		hours = hours + "1";
	}
	else{
