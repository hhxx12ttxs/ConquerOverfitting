...
//        }
    ...
    public void testGraphConstraints( String title, Expression constraint, String wanted )
     ...
     public void testGraphConstraints()
        ...
        testGraphConstraints( "tgs A", BoolConstantExpression.TRUE, "south flat badly" );
    ...
    public void testConstraint()
        {
        helpConstraint( "none", BoolConstantExpression.TRUE, 3 );
    ...
    */  
    ...
    protected static class PL extends FixedExpression implements PatternLiteral
        {
        ...
        @Override
        public String getPatternLanguage() { return null; }
        }
    ...
    private Expression constant( final Object it )
        { return new FixedExpression( it ); }

    private Expression dyadic( Expression l, String op, Expression r )
        {
        final String f = ExpressionFunctionUri.prefix + op;
    ...
    */
    public void testTripleSorting()
        {
        Graph g = dataGraph();
        Map<List<Node>, Integer> answer = getAnswer( g, TripleSorterUtil.dontSort );
        assertEquals( 1, answer.size() );
        assertEquals( new Integer(1), answer.get( Arrays.asList( nodeArray( "a d" ) ) ) );
    /* */
        assertEquals( answer, getAnswer( g, TripleSorterUtil.dontSort ) );
    ...
    public void testQueryOptimisation()
        {
        int dontCount = queryCount( TripleSorterUtil.dontSort );
