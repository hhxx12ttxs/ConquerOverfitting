...
import fr.smile.socialnetworking.model.MeetupsEntryModel;

/**
 * The base model implementation for the MeetupsEntry service. Represents a row in the &quot;SN_SMILE_MeetupsEntry&quot;
 * database table, with each column mapped to a property of this class.
 * 
 * <p>
 * This implementation and its corresponding interface {@link fr.smile.socialnetworking.model.MeetupsEntryModel} exist
 * only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all
 * application logic should be put in {@link MeetupsEntryImpl}.
 * </p>
 * 
 * @author Brian Wing Shun Chan
 * @see MeetupsEntryImpl
 * @see fr.smile.socialnetworking.model.MeetupsEntry
 * @see fr.smile.socialnetworking.model.MeetupsEntryModel
 * @generated
 */
public class MeetupsEntryModelImpl extends BaseModelImpl<MeetupsEntry> implements MeetupsEntryModel {

    public static final String     TABLE_NAME           = "SN_SMILE_MeetupsEntry";
    public static final Object[][] TABLE_COLUMNS        = { { "meetupsEntryId", Types.BIGINT },
            { "groupId", Types.BIGINT }, { "companyId", Types.BIGINT }, { "userId", Types.BIGINT },
            { "userName", Types.VARCHAR }, { "createDate", Types.TIMESTAMP }, { "modifiedDate", Types.TIMESTAMP },
            { "title", Types.VARCHAR }, { "description", Types.VARCHAR }, { "startDate", Types.TIMESTAMP },
            { "endDate", Types.TIMESTAMP }, { "totalAttendees", Types.INTEGER }, { "maxAttendees", Types.INTEGER },
            { "price", Types.DOUBLE }, { "thumbnailId", Types.BIGINT } };
    public static final String     TABLE_SQL_CREATE     = "create table SN_SMILE_MeetupsEntry (meetupsEntryId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,title VARCHAR(75) null,description STRING null,startDate DATE null,endDate DATE null,totalAttendees INTEGER,maxAttendees INTEGER,price DOUBLE,thumbnailId LONG)";
    public static final String     TABLE_SQL_DROP       = "drop table SN_SMILE_MeetupsEntry";
    public static final String     ORDER_BY_JPQL        = " ORDER BY meetupsEntry.startDate DESC";
    public static final String     ORDER_BY_SQL         = " ORDER BY SN_SMILE_MeetupsEntry.startDate DESC";
    ...
    public static final boolean    ENTITY_CACHE_ENABLED = GetterUtil
                                                                .getBoolean(
                                                                        com.liferay.util.service.ServiceProps
                                                                                .get("value.object.entity.cache.enabled.fr.smile.socialnetworking.model.MeetupsEntry"),
                                                                        true);
    public static final boolean    FINDER_CACHE_ENABLED = GetterUtil
                                                                .getBoolean(
                                                                        com.liferay.util.service.ServiceProps
                                                                                .get("value.object.finder.cache.enabled.fr.smile.socialnetworking.model.MeetupsEntry"),
                                                                        true);
    ...
    public static final long LOCK_EXPIRATION_TIME = GetterUtil
                                                          .getLong(com.liferay.util.service.ServiceProps
                                                                  .get("lock.expiration.time.fr.smile.socialnetworking.model.MeetupsEntry"));
    ...
    public MeetupsEntry toEscapedModel() {
        if (isEscapedModel()) {
            ...
            if (_escapedModelProxy == null) {
                _escapedModelProxy = (MeetupsEntry) Proxy.newProxyInstance(_classLoader, _escapedModelProxyInterfaces,
    ...
    public ExpandoBridge getExpandoBridge() {
        if (_expandoBridge == null) {
            _expandoBridge = ExpandoBridgeFactoryUtil.getExpandoBridge(getCompanyId(), MeetupsEntry.class.getName(),
                    getPrimaryKey());
        }
    ...
    public CacheModel<MeetupsEntry> toCacheModel() {
        ...
        meetupsEntryCacheModel.groupId = getGroupId();
    ...
    public String toXmlString() {
        ...
        sb.append("fr.smile.socialnetworking.model.MeetupsEntry");
        ...
        sb.append(getEndDate());
        sb.append("]]></column-value></column>");
        sb.append("<column><column-name>totalAttendees</column-name><column-value><![CDATA[");
        sb.append(getTotalAttendees());
        sb.append("]]></column-value></column>");
        sb.append("<column><column-name>maxAttendees</column-name><column-value><![CDATA[");
        sb.append(getMaxAttendees());
        sb.append("]]></column-value></column>");
        sb.append("<column><column-name>price</column-name><column-value><![CDATA[");
        sb.append(getPrice());
        sb.append("]]></column-value></column>");
        sb.append("<column><column-name>thumbnailId</column-name><column-value><![CDATA[");
        sb.append(getThumbnailId());
        sb.append("]]></column-value></column>");
    ...
    private static Class<?>[]       _escapedModelProxyInterfaces = new Class[] { MeetupsEntry.class };
