...
import com.nexj.njsdoc.org.mozilla.javascript.ast.FunctionNode;
import com.nexj.njsdoc.org.mozilla.javascript.v8dtoa.FastDtoa;
import com.nexj.njsdoc.org.mozilla.javascript.xml.XMLLib;
import com.nexj.njsdoc.org.mozilla.javascript.xml.XMLObject;
...
public class ScriptRuntime {
    ...
    public final static Class<?>
        ContextClass
            = Kit.classOrNull("com.nexj.njsdoc.org.mozilla.javascript.Context"),
        ContextFactoryClass
            = Kit.classOrNull("com.nexj.njsdoc.org.mozilla.javascript.ContextFactory"),
        FunctionClass
            = Kit.classOrNull("com.nexj.njsdoc.org.mozilla.javascript.Function"),
        ScriptableObjectClass
            = Kit.classOrNull("com.nexj.njsdoc.org.mozilla.javascript.ScriptableObject");
                                                       ...
                                                       boolean sealed)
    {
        ...
        new LazilyLoadedCtor(scope, "RegExp",
                "com.nexj.njsdoc.org.mozilla.javascript.regexp.NativeRegExp", sealed, true);
        new LazilyLoadedCtor(scope, "Packages",
                "com.nexj.njsdoc.org.mozilla.javascript.NativeJavaTopPackage", sealed, true);
        new LazilyLoadedCtor(scope, "getClass",
                "com.nexj.njsdoc.org.mozilla.javascript.NativeJavaTopPackage", sealed, true);
        new LazilyLoadedCtor(scope, "JavaAdapter",
                "com.nexj.njsdoc.org.mozilla.javascript.JavaAdapter", sealed, true);
        new LazilyLoadedCtor(scope, "JavaImporter",
                "com.nexj.njsdoc.org.mozilla.javascript.ImporterTopLevel", sealed, true);
        new LazilyLoadedCtor(scope, "Continuation",
                "com.nexj.njsdoc.org.mozilla.javascript.NativeContinuation", sealed, true);
    ...
    public static Object setObjectProp(Scriptable obj, String property,
                                       Object value, Context cx)
    {
        cx.storeLocation(obj, property, value);
    ...
    {
        // TODO: Get slot information here? 
        cx.storeLocation(null, null, value);
    ...
    public static Object name(Context cx, Scriptable scope, String name)
    {
        ...
        if (parent == null) {
            ...
            if (result == Scriptable.NOT_FOUND) {
                ScriptableObject.putProperty(scope, name, new LazyNativeObject());
    ...
    public static ScriptableObject getGlobal(Context cx) {
        final String GLOBAL_CLASS = "com.nexj.njsdoc.org.mozilla.javascript.tools.shell.Global";
    ...
    private static class DefaultMessageProvider implements MessageProvider {
        public String getMessage(String messageId, Object[] arguments) {
            final String defaultResource
                = "com.nexj.njsdoc.org.mozilla.javascript.resources.Messages";
