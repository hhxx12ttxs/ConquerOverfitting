...
public class Scene {
	public Scene(Graphics2D arg0, int arg1, int arg2, int arg3) {
		cm = 50;
		dm = new int[cm];
		em = new int[cm][256];
		hm = 5;
	...
	public int lh(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5,
			int arg6) {
		tn[sn] = arg0;
		un[sn] = arg1;
		vn[sn] = arg2;
		...
		yn[sn] = arg5;
		zn[sn] = 0;
		int k = ao.de(arg1, arg2, arg3);
		int l = ao.de(arg1, arg2 - arg5, arg3);
		int ai1[] = { k, l };
		ao.ne(2, ai1, 0, 0);
		ao.vh[sn] = arg6;
		ao.wh[sn++] = 0;
	...
	public void ei(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
		zm = arg2;
		an = arg3;
		bn = arg0;
		cn = arg1;
		ym = arg4;
		dn = arg5;
		to = new Scanline[arg3 + arg1];
		for (int k = 0; k < arg3 + arg1; k++)
			to[k] = new Scanline();
	}

	private void qh(r arg0[], int arg1, int arg2) {
		if (arg1 < arg2) {
			int k = arg1 - 1;
			int l = arg2 + 1;
			int i1 = (arg1 + arg2) / 2;
	...
	public void hh(int arg0, r arg1[], int arg2) {
		for (int k = 0; k <= arg2; k++) {
			arg1[k].lnb = false;
			arg1[k].mnb = k;
			arg1[k].nnb = -1;
		...
		do {
			...
			for (int k1 = j1; k1 >= i1 + 1; k1--) {
				r r2 = arg1[k1];
				if (r1.xmb < r2.zmb && r2.xmb < r1.zmb && r1.ymb < r2.anb
						&& r2.ymb < r1.anb && r1.mnb != r2.nnb && !ih(r1, r2) && gh(r2, r1)) {
					vi(arg1, i1, k1);
					if (arg1[k1] != r2)
						k1++;
					i1 = jp;
	...
	public boolean vi(r arg0[], int arg1, int arg2) {
		do {
			r r1 = arg0[arg1];
	...
	public void wi() {
		...
		if (h2.kh) {
			for (int i1 = 0; i1 < h2.wg; i1++) {
				...
				if (k7 > hm && k7 < jm) {
					int k8 = (xn[i1] << dn) / k7;
					int k9 = (yn[i1] << dn) / k7;
					if (j5 - k8 / 2 <= zm && j5 + k8 / 2 >= -zm && j6 - k9 <= an
							&& j6 >= -an) {
						r r3 = qn[pn];
						r3.dnb = h2;
						r3.enb = i1;
		...
		for (int k4 = 0; k4 < pn; k4++) {
			...
			if (h3 == ao) {
				...
				int j12 = l7 - k10 / 2;
				int l12 = (cn + l8) - i11;
				ro.dg(j12 + bn, l12, k10, i11, tn[j1], l11, (256 << dn) / l9);
				if (rm && um < vm) {
					j12 += (zn[j1] << dn) / l9;
					if (tm >= l12 && tm <= l12 + i11 && sm >= j12 && sm <= j12 + k10
							&& !h3.ai && h3.wh[j1] == 0) {
						wm[um] = h3;
						xm[um] = j1;
						um++;
				...
				for (int i12 = 0; i12 < j11; i12++) {
					...
					if (h3.rg[i3] >= hm) {
						...
						if (h3.rg[i10] >= hm) {
							...
							int k5 = h3.pg[i3]
									- ((h3.pg[i3] - h3.pg[i10]) * (h3.rg[i3] - hm)) / i8;
							int l6 = h3.qg[i3]
									- ((h3.qg[i3] - h3.qg[i10]) * (h3.rg[i3] - hm)) / i8;
							wo[i9] = (k5 << dn) / hm;
							xo[i9] = (l6 << dn) / hm;
							yo[i9] = l10;
							i9++;
						...
						if (h3.rg[i10] >= hm) {
							...
							int l5 = h3.pg[i3]
									- ((h3.pg[i3] - h3.pg[i10]) * (h3.rg[i3] - hm)) / j8;
							int i7 = h3.qg[i3]
									- ((h3.qg[i3] - h3.qg[i10]) * (h3.rg[i3] - hm)) / j8;
							wo[i9] = (l5 << dn) / hm;
							xo[i9] = (i7 << dn) / hm;
							yo[i9] = l10;
							i9++;
	...
	private void fh(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5[],
			int arg6[], int arg7[], Model arg8, int arg9) {
		if (arg4 == 3) {
			int k = arg6[0] + cn;
			int k1 = arg6[1] + cn;
			int k2 = arg6[2] + cn;
		...
		if (rm && um < vm && tm >= uo && tm < vo) {
			Scanline t2 = to[tm];
			if (sm >= t2.rnb >> 8 && sm <= t2.snb >> 8 && t2.rnb <= t2.snb
					&& !arg8.ai && arg8.wh[arg9] == 0) {
				wm[um] = arg8;
				xm[um] = arg9;
				um++;
			}
	...
	private void ph(int arg0, int arg1, int arg2, int arg3[], int arg4[],
		...
		if (arg6 >= 0) {
			...
			if (io[arg6] == 1) {
				...
				int i10 = l6 * l1 - i8 * i1 << (5 - dn) + 7 + 4;
				int k10 = i8 * k - k5 * l1 << (5 - dn) + 7;
				int i11 = k2 * i1 - i3 * k << 12;
				int k11 = i3 * l1 - k3 * i1 << (5 - dn) + 7 + 4;
				int i12 = k3 * k - k2 * l1 << (5 - dn) + 7;
				int k12 = i3 * k5 - k2 * l6 << 5;
				int i13 = k3 * l6 - i3 * i8 << (5 - dn) + 4;
				int k13 = k2 * i8 - k3 * k5 >> dn - 5;
				int i14 = i10 >> 4;
				int k14 = k11 >> 4;
				int i15 = i13 >> 4;
				int k15 = uo - cn;
				...
				if (arg7.sh) {
					for (arg0 = uo; arg0 < vo; arg0 += byte1) {
						...
						if (i20 <= 0) {
							...
							oi(so, ko[arg6], 0, 0, j9 + i14 * arg1, i11 + k14 * arg1, k12
									+ i15 * arg1, i10, k11, i13, i20, k16 + arg1, k21, i23 << 2);
							j9 += k10;
							i11 += i12;
							k12 += k13;
							k16 += i16;
				...
				if (!lo[arg6]) {
					for (arg0 = uo; arg0 < vo; arg0 += byte1) {
						...
						if (j20 <= 0) {
							...
							th(so, ko[arg6], 0, 0, j9 + i14 * arg1, i11 + k14 * arg1, k12
									+ i15 * arg1, i10, k11, i13, j20, k16 + arg1, l21, j23 << 2);
							j9 += k10;
							i11 += i12;
							k12 += k13;
							k16 += i16;
				...
				for (arg0 = uo; arg0 < vo; arg0 += byte1) {
					...
					if (k20 <= 0) {
						...
						ii(so, 0, 0, 0, ko[arg6], j9 + i14 * arg1, i11 + k14 * arg1, k12
								+ i15 * arg1, i10, k11, i13, k20, k16 + arg1, i22, k23);
						j9 += k10;
						i11 += i12;
						k12 += k13;
						k16 += i16;
			...
			int j10 = l6 * l1 - i8 * i1 << (5 - dn) + 6 + 4;
			int l10 = i8 * k - k5 * l1 << (5 - dn) + 6;
			int j11 = k2 * i1 - i3 * k << 11;
			int l11 = i3 * l1 - k3 * i1 << (5 - dn) + 6 + 4;
			int j12 = k3 * k - k2 * l1 << (5 - dn) + 6;
			int l12 = i3 * k5 - k2 * l6 << 5;
			int j13 = k3 * l6 - i3 * i8 << (5 - dn) + 4;
			int l13 = k2 * i8 - k3 * k5 >> dn - 5;
			int j14 = j10 >> 4;
			int l14 = l11 >> 4;
			int j15 = j13 >> 4;
			int l15 = uo - cn;
			...
			if (arg7.sh) {
				for (arg0 = uo; arg0 < vo; arg0 += byte2) {
					...
					if (l20 <= 0) {
						...
						xh(so, ko[arg6], 0, 0, k9 + j14 * arg1, j11 + l14 * arg1, l12 + j15
								* arg1, j10, l11, j13, l20, l16 + arg1, j22, l23);
						k9 += l10;
						j11 += j12;
						l12 += l13;
						l16 += j16;
			...
			if (!lo[arg6]) {
				for (arg0 = uo; arg0 < vo; arg0 += byte2) {
					...
					if (i21 <= 0) {
						...
						pi(so, ko[arg6], 0, 0, k9 + j14 * arg1, j11 + l14 * arg1, l12 + j15
								* arg1, j10, l11, j13, i21, l16 + arg1, k22, i24);
						k9 += l10;
						j11 += j12;
						l12 += l13;
						l16 += j16;
			...
			for (arg0 = uo; arg0 < vo; arg0 += byte2) {
				...
				if (j21 <= 0) {
					...
					sh(so, 0, 0, 0, ko[arg6], k9 + j14 * arg1, j11 + l14 * arg1, l12
							+ j15 * arg1, j10, l11, j13, j21, l16 + arg1, l22, j24);
					k9 += l10;
					j11 += j12;
					l12 += l13;
					l16 += j16;
	...
	private static void th(int arg0[], int arg1[], int arg2, int arg3, int arg4,
	...
	private static void oi(int arg0[], int arg1[], int arg2, int arg3, int arg4,
			int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11,
			int arg12, int arg13) {
		if (arg10 <= 0)
			return;
	...
	private static void ii(int arg0[], int arg1, int arg2, int arg3, int arg4[],
			int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11,
	...
	private static void pi(int arg0[], int arg1[], int arg2, int arg3, int arg4,
			int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11,
			int arg12, int arg13) {
		if (arg10 <= 0)
			return;
	...
	private static void xh(int arg0[], int arg1[], int arg2, int arg3, int arg4,
			int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11,
			int arg12, int arg13) {
		if (arg10 <= 0)
			return;
	...
	private static void sh(int arg0[], int arg1, int arg2, int arg3, int arg4[],
			int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11,
			int arg12, int arg13, int arg14) {
		if (arg11 <= 0)
			return;
	...
	private static void jh(int arg0[], int arg1, int arg2, int arg3, int arg4[],
			int arg5, int arg6) {
		if (arg1 >= 0)
			return;
		arg6 <<= 1;
	...
	private static void hi(int arg0[], int arg1, int arg2, int arg3, int arg4[],
			int arg5, int arg6) {
		if (arg1 >= 0)
			return;
		arg6 <<= 2;
	...
	private static void yh(int arg0[], int arg1, int arg2, int arg3, int arg4[],
			int arg5, int arg6) {
		if (arg1 >= 0)
			return;
		arg6 <<= 2;
	...
	public void ai(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5,
			int arg6) {
		arg3 &= 0x3ff;
		arg4 &= 0x3ff;
		arg5 &= 0x3ff;
	...
	private void xi(int arg0) {
		...
		if (i1 == -1) {
			i1 = 0;
			for (; l3 > 25000 || i4 > 25000 || j4 > 25000 || l3 < -25000
					|| i4 < -25000 || j4 < -25000; j4 >>= 1) {
				i1++;
				l3 >>= 1;
				i4 >>= 1;
			}
	...
	private boolean ih(r arg0, r arg1) {
		...
		for (int i5 = 0; i5 < i1; i5++) {
			int k1 = ai1[i5];
			int k2 = (i3 - h1.pg[k1]) * l3 + (j3 - h1.qg[k1]) * i4 + (k3 - h1.rg[k1])
					* j4;
		...
		for (int j5 = 0; j5 < j1; j5++) {
			int l1 = ai2[j5];
			int l2 = (i3 - h2.pg[l1]) * l3 + (j3 - h2.qg[l1]) * i4 + (k3 - h2.rg[l1])
					* j4;
	...
	private static boolean gh(r arg0, r arg1) {
		Model h1 = arg0.dnb;
		Model h2 = arg1.dnb;
		int k = arg0.enb;
		int l = arg1.enb;
		...
		for (int k4 = 0; k4 < i1; k4++) {
			int k1 = ai1[k4];
			int i2 = (k2 - h1.pg[k1]) * j3 + (l2 - h1.qg[k1]) * k3 + (i3 - h1.rg[k1])
					* l3;
		...
		for (int l4 = 0; l4 < j1; l4++) {
			int l1 = ai2[l4];
			int j2 = (k2 - h2.pg[l1]) * j3 + (l2 - h2.qg[l1]) * k3 + (i3 - h2.rg[l1])
					* l3;
	...
	public void yi(int arg0, int arg1, int arg2, int arg3, int arg4) {
		if (arg2 == 0 && arg3 == 0 && arg4 == 0)
			arg2 = 32;
		for (int k = 0; k < ln; k++)
			nn[k].be(arg0, arg1, arg2, arg3, arg4);
	...
	public boolean kh(int arg0[], int arg1[], int arg2[], int arg3[]) {
		...
		if (arg1[i1] < arg3[k1]) {
			...
			for (; arg1[i1] < arg3[k1]; i1 = ((i1 - 1) + k) % k)
				;
			int i2 = nh(arg0[(i1 + 1) % k], arg1[(i1 + 1) % k], arg0[i1], arg1[i1],
					arg3[k1]);
			int i7 = nh(arg0[((j1 - 1) + k) % k], arg1[((j1 - 1) + k) % k], arg0[j1],
					arg1[j1], arg3[k1]);
			int j11 = arg2[k1];
			flag = (i2 < j11) | (i7 < j11);
			...
			for (; arg3[k1] < arg1[i1]; k1 = ((k1 - 1) + l) % l)
				;
			int j2 = arg0[i1];
			int k11 = nh(arg2[(k1 + 1) % l], arg3[(k1 + 1) % l], arg2[k1], arg3[k1],
					arg1[i1]);
			int j16 = nh(arg2[((l1 - 1) + l) % l], arg3[((l1 - 1) + l) % l],
					arg2[l1], arg3[l1], arg1[i1]);
			flag = (j2 < k11) | (j2 < j16);
		...
		while (byte0 == 0)
			if (arg1[i1] < arg1[j1]) {
				if (arg1[i1] < arg3[k1]) {
					if (arg1[i1] < arg3[l1]) {
						int k2 = arg0[i1];
						int j7 = nh(arg0[((j1 - 1) + k) % k], arg1[((j1 - 1) + k) % k],
								arg0[j1], arg1[j1], arg1[i1]);
						int l11 = nh(arg2[(k1 + 1) % l], arg3[(k1 + 1) % l], arg2[k1],
								arg3[k1], arg1[i1]);
						int k16 = nh(arg2[((l1 - 1) + l) % l], arg3[((l1 - 1) + l) % l],
								arg2[l1], arg3[l1], arg1[i1]);
						...
						int l2 = nh(arg0[(i1 + 1) % k], arg1[(i1 + 1) % k], arg0[i1],
								arg1[i1], arg3[l1]);
						int k7 = nh(arg0[((j1 - 1) + k) % k], arg1[((j1 - 1) + k) % k],
								arg0[j1], arg1[j1], arg3[l1]);
						int i12 = nh(arg2[(k1 + 1) % l], arg3[(k1 + 1) % l], arg2[k1],
								arg3[k1], arg3[l1]);
						int l16 = arg2[l1];
					...
					int i3 = nh(arg0[(i1 + 1) % k], arg1[(i1 + 1) % k], arg0[i1],
							arg1[i1], arg3[k1]);
					int l7 = nh(arg0[((j1 - 1) + k) % k], arg1[((j1 - 1) + k) % k],
							arg0[j1], arg1[j1], arg3[k1]);
					int j12 = arg2[k1];
					int i17 = nh(arg2[((l1 - 1) + l) % l], arg3[((l1 - 1) + l) % l],
							arg2[l1], arg3[l1], arg3[k1]);
					...
					int j3 = nh(arg0[(i1 + 1) % k], arg1[(i1 + 1) % k], arg0[i1],
							arg1[i1], arg3[l1]);
					int i8 = nh(arg0[((j1 - 1) + k) % k], arg1[((j1 - 1) + k) % k],
							arg0[j1], arg1[j1], arg3[l1]);
					int k12 = nh(arg2[(k1 + 1) % l], arg3[(k1 + 1) % l], arg2[k1],
							arg3[k1], arg3[l1]);
					int j17 = arg2[l1];
				...
				if (arg1[j1] < arg3[l1]) {
					int k3 = nh(arg0[(i1 + 1) % k], arg1[(i1 + 1) % k], arg0[i1],
							arg1[i1], arg1[j1]);
					int j8 = arg0[j1];
					int l12 = nh(arg2[(k1 + 1) % l], arg3[(k1 + 1) % l], arg2[k1],
							arg3[k1], arg1[j1]);
					int k17 = nh(arg2[((l1 - 1) + l) % l], arg3[((l1 - 1) + l) % l],
					...
					int l3 = nh(arg0[(i1 + 1) % k], arg1[(i1 + 1) % k], arg0[i1],
							arg1[i1], arg3[l1]);
					int k8 = nh(arg0[((j1 - 1) + k) % k], arg1[((j1 - 1) + k) % k],
							arg0[j1], arg1[j1], arg3[l1]);
					int i13 = nh(arg2[(k1 + 1) % l], arg3[(k1 + 1) % l], arg2[k1],
							arg3[k1], arg3[l1]);
					int l17 = arg2[l1];
				...
				int i4 = nh(arg0[(i1 + 1) % k], arg1[(i1 + 1) % k], arg0[i1], arg1[i1],
						arg3[k1]);
				int l8 = nh(arg0[((j1 - 1) + k) % k], arg1[((j1 - 1) + k) % k],
						arg0[j1], arg1[j1], arg3[k1]);
				int j13 = arg2[k1];
				int i18 = nh(arg2[((l1 - 1) + l) % l], arg3[((l1 - 1) + l) % l],
						arg2[l1], arg3[l1], arg3[k1]);
				...
				int j4 = nh(arg0[(i1 + 1) % k], arg1[(i1 + 1) % k], arg0[i1], arg1[i1],
						arg3[l1]);
				int i9 = nh(arg0[((j1 - 1) + k) % k], arg1[((j1 - 1) + k) % k],
						arg0[j1], arg1[j1], arg3[l1]);
				int k13 = nh(arg2[(k1 + 1) % l], arg3[(k1 + 1) % l], arg2[k1],
						arg3[k1], arg3[l1]);
				int j18 = arg2[l1];
		...
		while (byte0 == 1)
			if (arg1[i1] < arg3[k1]) {
				if (arg1[i1] < arg3[l1]) {
					int k4 = arg0[i1];
					int l13 = nh(arg2[(k1 + 1) % l], arg3[(k1 + 1) % l], arg2[k1],
							arg3[k1], arg1[i1]);
					int k18 = nh(arg2[((l1 - 1) + l) % l], arg3[((l1 - 1) + l) % l],
							arg2[l1], arg3[l1], arg1[i1]);
					return rh(l13, k18, k4, !flag);
				}
				int l4 = nh(arg0[(i1 + 1) % k], arg1[(i1 + 1) % k], arg0[i1], arg1[i1],
						arg3[l1]);
				int j9 = nh(arg0[((j1 - 1) + k) % k], arg1[((j1 - 1) + k) % k],
						arg0[j1], arg1[j1], arg3[l1]);
				int i14 = nh(arg2[(k1 + 1) % l], arg3[(k1 + 1) % l], arg2[k1],
						arg3[k1], arg3[l1]);
				int l18 = arg2[l1];
				...
				int i5 = nh(arg0[(i1 + 1) % k], arg1[(i1 + 1) % k], arg0[i1], arg1[i1],
						arg3[k1]);
				int k9 = nh(arg0[((j1 - 1) + k) % k], arg1[((j1 - 1) + k) % k],
						arg0[j1], arg1[j1], arg3[k1]);
				int j14 = arg2[k1];
				int i19 = nh(arg2[((l1 - 1) + l) % l], arg3[((l1 - 1) + l) % l],
						arg2[l1], arg3[l1], arg3[k1]);
				...
				int j5 = nh(arg0[(i1 + 1) % k], arg1[(i1 + 1) % k], arg0[i1], arg1[i1],
						arg3[l1]);
				int l9 = nh(arg0[((j1 - 1) + k) % k], arg1[((j1 - 1) + k) % k],
						arg0[j1], arg1[j1], arg3[l1]);
				int k14 = nh(arg2[(k1 + 1) % l], arg3[(k1 + 1) % l], arg2[k1],
						arg3[k1], arg3[l1]);
				int j19 = arg2[l1];
		...
		while (byte0 == 2)
			if (arg3[k1] < arg1[i1]) {
				if (arg3[k1] < arg1[j1]) {
					int k5 = nh(arg0[(i1 + 1) % k], arg1[(i1 + 1) % k], arg0[i1],
							arg1[i1], arg3[k1]);
					int i10 = nh(arg0[((j1 - 1) + k) % k], arg1[((j1 - 1) + k) % k],
							arg0[j1], arg1[j1], arg3[k1]);
					int l14 = arg2[k1];
					return rh(k5, i10, l14, flag);
				}
				int l5 = nh(arg0[(i1 + 1) % k], arg1[(i1 + 1) % k], arg0[i1], arg1[i1],
						arg1[j1]);
				int j10 = arg0[j1];
				int i15 = nh(arg2[(k1 + 1) % l], arg3[(k1 + 1) % l], arg2[k1],
						arg3[k1], arg1[j1]);
				int k19 = nh(arg2[((l1 - 1) + l) % l], arg3[((l1 - 1) + l) % l],
						arg2[l1], arg3[l1], arg1[j1]);
				...
				int i6 = arg0[i1];
				int k10 = nh(arg0[((j1 - 1) + k) % k], arg1[((j1 - 1) + k) % k],
						arg0[j1], arg1[j1], arg1[i1]);
				int j15 = nh(arg2[(k1 + 1) % l], arg3[(k1 + 1) % l], arg2[k1],
						arg3[k1], arg1[i1]);
				int l19 = nh(arg2[((l1 - 1) + l) % l], arg3[((l1 - 1) + l) % l],
						arg2[l1], arg3[l1], arg1[i1]);
				...
				int j6 = nh(arg0[(i1 + 1) % k], arg1[(i1 + 1) % k], arg0[i1], arg1[i1],
						arg1[j1]);
				int l10 = arg0[j1];
				int k15 = nh(arg2[(k1 + 1) % l], arg3[(k1 + 1) % l], arg2[k1],
						arg3[k1], arg1[j1]);
				int i20 = nh(arg2[((l1 - 1) + l) % l], arg3[((l1 - 1) + l) % l],
						arg2[l1], arg3[l1], arg1[j1]);
		...
		if (arg1[i1] < arg3[k1]) {
			int k6 = arg0[i1];
			int l15 = nh(arg2[(k1 + 1) % l], arg3[(k1 + 1) % l], arg2[k1], arg3[k1],
					arg1[i1]);
			int j20 = nh(arg2[((l1 - 1) + l) % l], arg3[((l1 - 1) + l) % l],
					arg2[l1], arg3[l1], arg1[i1]);
			return rh(l15, j20, k6, !flag);
		}
		int l6 = nh(arg0[(i1 + 1) % k], arg1[(i1 + 1) % k], arg0[i1], arg1[i1],
				arg3[k1]);
		int i11 = nh(arg0[((j1 - 1) + k) % k], arg1[((j1 - 1) + k) % k], arg0[j1],
				arg1[j1], arg3[k1]);
		int i16 = arg2[k1];
