...
public class Quat extends Vec {
    ...
    //
    //===========================================================================
    public static final Vector4f QUAT_ZERO = Quatf(0, 0, 0, 0);
    public static final Vector4f QUAT_ONE = Quatf(1, 1, 1, 1);
    public static final Vector4f QUAT_MINUS_ONE = Quatf(-1, -1, -1, -1);
    public static final Vector4f QUAT_IDENTITY = Quatf(0, 0, 0, 1);

    public static Vector4f Quatf() {
        return new Vector4f();
    }

    public static Vector4f Quatf(final int x, final int y, final int z, final int w) {
        return (new Vector4f()).set(x, y, z, w);
    }

    public static Vector4f Quatf(final float x, final float y, final float z, final float w)
    {
        return (new Vector4f()).set(x, y, z, w);
    }

    public static Vector4f Quatf(final Object o) {
        return (new Vector4f()).set(o);
    }

    public static Vector4f quatConjugate(final Vector4f Out, final Vector4f Q) {
        return negate(Out, Q);
    }

    public static Vector4f quatExp(Vector4f Out, final Vector4f Q) {
        if (Out == null) {
            Out = new Vector4f();
        }
    ...
    public static Vector4f quatLn(Vector4f Out, final Vector4f Q) {
        if (Out == null) {
            Out = new Vector4f();
        }
    ...
    public static Vector4f quatInverse(Vector4f Out, final Vector4f Q) {
        if (Out == null) {
            Out = new Vector4f();
        }
    ...
    public static Vector4f quatMul(Vector4f Out, final Vector4f Q1, final Vector4f Q2) {
        if (Out == null) {
            Out = new Vector4f();
        }
    ...
    public static Vector4f quatRotation(Vector4f Out, final Vector3f Axis, final double radian)
    {
        if (Out == null) {
            Out = new Vector4f();
        }
    ...
    public static Vector4f quatRotation(final Vector4f Out, final Matrixf M) {
        float trace, root;
        int i, j, k;
    ...
    public static Vector4f quatRotation(Vector4f Out, final double yaw, final double pitch, final double roll)
    {
        if (Out == null) {
            Out = new Vector4f();
        }
    ...
    public static Vector4f quatRotation(final Vector4f Out, final Vector3f from, final Vector3f to)
    {
        final Vector3f crossFT = Vec.cross(null, from, to);
    ...
    public static Vector4f quatSlerp(final Vector4f Out, final Vector4f Q1, final Vector4f Q2, final float aT, final int mode)
    {
        float cosTheta, invT;
        float T = aT;
        float q1x, q1y, q1z, q1w;
    ...
    public static Vector4f quatSlerp(final Vector4f Out, final Vector4f Q1, final Vector4f Q2, final float aT)
    {
        return quatSlerp(Out, Q1, Q2, aT, SLERP_SHORT);
    }

    public static Vector4f quatSquad(Vector4f Out, final Vector4f Q1, final Vector4f Q2, final Vector4f Q3, final Vector4f Q4, final float t)
    {
        if (Out == null) {
            Out = new Vector4f();
        }
        final Vector4f u = quatSlerp(null, Q1, Q4, t);
        final Vector4f v = quatSlerp(null, Q2, Q3, t);
     ...
     *         in w.
     */
    public static Vector4f quatToAxisAngle(Vector4f Out, final Vector4f Q) {
        if (Out == null) {
            Out = new Vector4f();
        }
     ...
     */
    public static Vector4f quatRandom(Vector4f Out) {
        if (Out == null) {
            Out = new Vector4f();
        }
