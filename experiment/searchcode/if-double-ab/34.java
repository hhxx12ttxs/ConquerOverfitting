package fp.s100502514.borrowed.a4;
/**
 * CE1002-100502514 FlashTeens Chiang
 * Borrowed from Assignment 4-2.
 */
...
public class InnerTriangle2D {
	...
	/** MODIFIED: a constructor with java.awt.Point for compatibility. */
	public InnerTriangle2D(Point p1, Point p2, Point p3){
		this(
			new MyPoint(p1.x, p1.y),
			new MyPoint(p2.x, p2.y),
			new MyPoint(p3.x, p3.y)
		);
	}
	...
	/** MODIFIED: a same method as above but with java.awt.Point for compatibility. */
	public boolean contains(Point p){
		return contains(new MyPoint(p.x, p.y));
	}
