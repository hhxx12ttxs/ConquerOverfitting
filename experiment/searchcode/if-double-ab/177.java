...
public class GuiMainMenu extends GuiScreen
{
	...
	public void initGui()
	{
		...
		controlList.add(new GuiButton(3, width / 2 - 100, i + 48, 99, 20, stringtranslate.translateKey("menu.mods")));
		controlList.add(new GuiButton(6, width / 2 , i + 48, 99, 20, stringtranslate.translateKey("tkh.menu.skinedit")));
	 ...
	 * MODIF GuiMainMenu: actionPerformed(GuiButton par1GuiButton)
	 */
