package ru.izucken.triangulation;

import ru.izucken.triangulation.splaytree.BTreeNode;
import ru.izucken.triangulation.splaytree.SplayTree;
...
public class Polygon {
	 ...
	 */
	 ...
	 /**
	  * This is used to change key of all items in 
	  */
	  ...
	  */
	 public Polygon(int numContures, int[] numVerticesInContures, double[][] vertices){
