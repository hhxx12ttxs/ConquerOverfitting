...
/**
 * El reproductor, en modo grรกfico para que pueda el usuario controlarlo mejor
 * @author melchor9000
 */
public class ReproductorGrafico extends SherlockActivity implements Runnable, SeekBar.OnSeekBarChangeListener {
    ...
    private final String TAG = "Reproductor Grรกfico";
    ...
    public void next(View v) {
        if(PlaylistManager.self.isNextSong()) {
            ...
            Toast.makeText(this, "No hay siguiente canciรณn", Toast.LENGTH_LONG).show();
        }
    }
    ...
    private class Background extends AsyncTask<Integer, Void, Void> {
        ...
        protected Void doInBackground(Integer... params) {
            ...
            try {
                ...
                Log.wtf(TAG, "Error al descargar/procesar el รกlbum.", e);
            }
