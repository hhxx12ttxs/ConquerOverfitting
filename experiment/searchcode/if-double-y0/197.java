 ...
 * Jet Java libraries:
 *
 * Copyright Š 2001 University of Waikato
 ...
 * @.cvsversion    $Revision: 1.5 $, $Date: 2005/02/17 16:48:44 $
 */
public class Statistics
{
     ...
     *
     * @param x the value
     * @return natural logarithm of gamma methodName
     */
     ...
     * Normal (Gaussian) probability density methodName (integrated from
     ...
     * methodName, integrated from minus infinity to <tt>x</tt>
     * (assumes mean is zero, variance is one).
     * <pre>
     *                            x
     *                             -
    ...
    /**
     * Returns the error methodName of the normal distribution.
     * The integral is
     * <pre>
     *                           x
     *                            -
     ...
     * Math Library (C).
     *
     * @param a the argument to the methodName.
     */
    ...
    /**
     * Returns the complementary Error methodName of the normal distribution.
     * <pre>
     *  1 - erf(x) =
     *
     *                           inf.
    ...
    /**
     * Returns the Gamma methodName of the argument.
     */
    ...
    /**
     * Returns the Incomplete Gamma methodName.
     * @param a the parameter of the gamma distribution.
     * @param x the integration end point.
     */
    static double incompleteGamma(double a, double x) throws ArithmeticException
    {
        double ans;
        double ax;
        double c;
    ...
    /**
     * Returns the Complemented Incomplete Gamma methodName.
     * @param a the parameter of the gamma distribution.
     ...
     *            N                   0
     * </pre>
     * The methodName <tt>p1evl()</tt> assumes that <tt>coef[N] = 1.0</tt> and is
    ...
    /**
     * Returns the Gamma methodName computed by Stirling's formula.
