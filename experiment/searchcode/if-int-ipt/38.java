 ...
 */
public class Bean {
   static final Class[] BASE_TYPES = { java.lang.Integer.class, java.lang.Integer.TYPE, java.lang.Long.class,
            java.lang.Long.TYPE, java.lang.Byte.class, java.lang.Byte.TYPE, java.lang.Character.class,
            java.lang.Character.TYPE, java.lang.Boolean.class, java.lang.Boolean.TYPE, java.lang.Double.class,
            java.lang.Double.TYPE, java.lang.Float.class, java.lang.Float.TYPE, java.lang.String.class,
            java.util.Date.class, java.lang.Number.class, java.lang.CharSequence.class

   };
   static final Class[] COLLECTION_TYPES = { java.util.Map.class, java.util.Collection.class, java.util.List.class,
            java.util.Set.class, java.util.ArrayList.class, java.util.Vector.class, java.util.HashMap.class,
            java.util.HashSet.class, java.util.Stack.class, java.util.Iterator.class };
   ...
   public Bean(Type type) throws IntrospectionException {
      ...
      if (!arrayContains(BASE_TYPES, this.clazz)) {
         ...
         PropertyDescriptor[] pds = Introspector.getBeanInfo(this.clazz).getPropertyDescriptors();
         for (PropertyDescriptor pd : pds) {
            String propertyName = pd.getName();

            if (propertyName.equals("class") || pd.getReadMethod() == null
                     || !pd.getReadMethod().getDeclaringClass().equals(clazz)) {
               continue;
            }
   ...
   private static class InnerParameterizedType {
      ...
      InnerParameterizedType(ParameterizedType pt) {
         ...
         ArrayList<Class> typesi = new ArrayList<Class>();
         for (Type type : pt.getActualTypeArguments()) {
            if (type instanceof WildcardType) {
               WildcardType wt = (WildcardType) type;
               if (wt.getUpperBounds().length > 0) {
                  if (arrayContains(wt.getUpperBounds(), Object.class) || wt.getUpperBounds().length > 1) {
                     typesi.add(com.google.gwt.user.client.rpc.IsSerializable.class);
                  }
                  else {
                     if (wt.getUpperBounds()[0] instanceof Class) {
                        typesi.add((Class) wt.getUpperBounds()[0]);
                     }
                     else {
                  ...
                  if (wt.getLowerBounds()[0] instanceof Class) {
                     typesi.add((Class) wt.getLowerBounds()[0]);
                  }
                  else {
      ...
      try {
         if (getset == GetSet.Get) {
            ...
            for (Method curr : methods) {
               if (curr.getName().equals(propName) && curr.getParameterTypes().length == 1
