...
public interface RmiExporter extends RemoteExporter {
	...
	/**
	 * Thi?t l?p ch? ?? <code>autorun</code> cho
	 * <code>rmi service exporter</code>. N?u ch? ??nh <b>true</b>, t? ??ng ngay
	 * sau khi <code>service bean</code> ???c <code>container</code> kh?i t?o,
	 * <code>rmi service</code> c?ng s? ???c <code>export</code>. Ng??c l?i n?u
	 * ch? ??nh lŕ <b>false</b>, ch? khi nŕo <code>rmi service</code> ???c ch?
	 * ??nh <code>run service (thông qua runService method)</code> thě exporter
	 * m?i ???c kh?i ??ng.
	 * 
	 * @param autorun
	 *            giá tr? boolean c?n thi?t l?p.
	 */
