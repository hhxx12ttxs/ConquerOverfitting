...
/**
 * Qu?n lý các ph??ng th?c ?i?u khi?n các <i>module</i> lŕ các
 * <i>extension-point</i> trong khi th?c thi x? lý annotation, bao g?m vi?c di?n
 * d?ch <code>annotation</code> thŕnh {@link AnnotationMetadata}, qu?n lý
