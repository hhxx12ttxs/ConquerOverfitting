 ...
 */
    ...
    public void init() {
        ...
        addEntity(new ShopItem(32 * (width / 2 + 1.5), 4.5 * 32, ShopItem.SHOP_POINT, Team.Team2));
        ...
        addEntity(new ShopItem(32 * (width / 2 + 1.5), (height - 4.5) * 32, ShopItem.SHOP_POINT, Team.Team1));
