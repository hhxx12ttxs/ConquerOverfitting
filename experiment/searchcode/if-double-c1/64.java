...
//				.getDefaultCoordinateFactory(coordDim);
		...
		// Wie in deinem Vorschlag von unserem Telefonat am 04/10 hole ich die CoordFactory 端ber ein DP
	...
	public double[] getCoordinate(int index) {
		...
		// Auskommentiert und ge辰ndert durch Sanjay am 21.08.2006
		// der komplette code hat nicht soviel sinn gemacht, wurde nicht getestet
		// Position nicht ber端cksichtigt wurde
		// OLD CODE:
