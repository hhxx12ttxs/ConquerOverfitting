...
public final class Utility
{
    ...
    */
   public static void addCommand(final ArrayList<String> commandList, final int code)
   {
    ...
    */
   public static void addCommand(final ArrayList<String> commandList, final int code, final int intvalue)
   {
    ...
    */
   public static void addCommand(final ArrayList<String> commandList, final int code, final boolean boolvalue)
   {
      String str ;
      if (boolvalue == true)
    ...
    */
   public static void addCommand(final ArrayList<String> commandList, final int code, final String strvalue)
   {
      if (strvalue == null )
    ...
    * @param strvalue String parameter
    */
   public static void addCommand(final ArrayList<String> commandList, final int code, final int intvalue, final String strvalue)
   {
      if (strvalue == null )
    ...
    */
   public static void addCommand(final ArrayList<String> commandList, final int code, final int intvalue1, final int intvalue2, final String strvalue)
   {
      if (strvalue == null )
    ...
    */
   public static void addCommand(final ArrayList<String> commandList, final int code, final int intvalue1, final int intvalue2, final int intvalue3 , final String strvalue)
   {
      if (strvalue == null )
