...
public class RenderEngine
{
    ...
    public int getTexture(String par1Str)
    {
        ...
        {
            TexturePackBase var3 = this.texturePack.getSelectedTexturePack();
            ...
            try
            {
                ...
                {
                    InputStream var7 = var3.getResourceAsStream(par1Str);
                    ...
                    else
                    {
                        ...
                        this.setupTexture(this.readTextureImage(var7), var4);
                    }
                }
    ...
    public void updateDynamicTextures()
    {
        ...
        int var3 = -1;
        Iterator var4 = this.textureList.iterator();

        while (var4.hasNext())
        {
            TextureFX var5 = (TextureFX)var4.next();
