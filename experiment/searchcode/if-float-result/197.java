...
public abstract class AbsListView extends AdapterView<ListAdapter> implements TextWatcher,
    ...
    public void setCacheColorHint(int color) {
        if (color != mCacheColorHint) {
              int transBackgroundApp = Settings.System.getInt(mContext.getContentResolver(), Settings.System.TRANSPARENT_BACKGROUND_APP, 0);
              if (transBackgroundApp == 0) {
              ...
              } else if (transBackgroundApp == 1 || transBackgroundApp == 2) {
                  mCacheColorHint = 0;
                  color = 0;
                  int count = getChildCount();
                  for (int i = 0; i < count; i++) {
