...
//    }
    ...
    // List of RuleSets.
    private final List<RuleSet> iRuleSets;
...
//        }
    ...
    private static final class RuleSet {
        ...
        public Transition firstTransition(final long firstMillis) {
            ...
            List<Rule> copy = new ArrayList<Rule>(iRules);
...
//        }
         ...
         */
        static PrecalculatedZone create(String id, boolean outputID, List<Transition> transitions, DSTZone tailZone) {
            int size = transitions.size();
            if (size == 0) {
                throw new IllegalArgumentException();
            }
