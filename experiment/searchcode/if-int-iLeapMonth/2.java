package com.server.tools.calendar;
public class TestNongLi {
	  public static void main(String[] args) {
	    // ??????????????
	    System.out.println(ChineseCalendar.sCalendarLundarToSolar(2013, 12, 29));
	  }
	}
	...
	class LunarDate extends MyDate {
	  ...
	  public String toString() {
	    ...
	    if (iDay > 29)
	      ...
	      sCalendar += "??" + sChineseNum[iDay % 20];
	    else if (iDay == 20)
	      sCalendar += "??";
	    else if (iDay > 10)
	      sCalendar += "?" + sChineseNum[iDay % 10];
	    else
