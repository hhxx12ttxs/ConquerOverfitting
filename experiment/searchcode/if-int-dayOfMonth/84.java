...
public class RequestActivity extends FragmentActivity implements DialogManager.DialogCreator, DialogManager.DialogPreparer
{
	...
	protected void onCreate( Bundle savedInstanceState )
	{
		...
		Typeface font = Typeface.createFromAsset( getAssets(), "fonts/pt_sans.ttf" );
		//Typeface fontBold = Typeface.createFromAsset( getAssets(), "fonts/pt_sans_bold.ttf" );
		Typeface fontItalic = Typeface.createFromAsset( getAssets(), "fonts/pt_sans_italic.ttf" );
		...
		TextView ceo = ( TextView )findViewById( android.R.id.text1 );
		TextView hr = ( TextView )findViewById( android.R.id.text2 );
		
		ceo.setTypeface( fontItalic );
		hr.setTypeface( fontItalic );
		
		setMainRecipients( ceo, hr );
		...
		mDateFromText.setTypeface( font );
		mDateToText.setTypeface( font );
