package services.p2legacy;

import com.atlassian.jira.issue.CustomFieldManager;
import com.atlassian.jira.issue.Issue;
import com.atlassian.jira.plugins.calendar.model.GregorianCalendarFactory;
import com.atlassian.jira.plugins.calendar.utils.ParameterUtils;
...
public class MonthEvents
{
     ...
     */
    public MonthEvents(List issueList, List versionList, Calendar monthStart, String dateFieldName, CustomFieldManager customFieldManager)
    {
        ...
        for (Iterator it = issueList.iterator(); it.hasNext();)
        {
            ...
            Date date = DateProviderUtils.getDate(issue, dateFieldName, customFieldManager);
            Calendar issueDueCal = GregorianCalendarFactory.constructCalendar(new DateTime(date));
        ...
        for (Iterator it = versionList.iterator(); it.hasNext();)
        {
            ...
            Calendar versionRelCal = GregorianCalendarFactory.constructCalendar(new DateTime(version.getReleaseDate()));
    ...
    {
        return GregorianCalendarFactory.constructCalendar(new DateTime(date)).get(Calendar.DAY_OF_MONTH);
    }
    ...
    {
        return new Integer(GregorianCalendarFactory.constructCalendar(new DateTime(date)).get(Calendar.MONTH));
    }
