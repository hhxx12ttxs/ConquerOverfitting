 ...
 * and has a nested class PaintWithFiles.Applet that can be used as
...
public class PaintWithFiles extends JPanel {
   ...
   /**
    * The public static class PaintWithFiles$Applet represents this program
    * as an applet.  The applet's init() method simply sets the content 
    * pane of the applet to be a PaintWithFiles.  To use the applet on
    * a web page, use code="PaintWithFiles$Applet.class" as the name of
