			...
			public boolean onTouch(View v, MotionEvent event) {
				...
				switch (action) {
					...
					case MotionEvent.ACTION_MOVE:	// eseguita ad ogni spostamento sul drawable
					    ...
					    break;
					case MotionEvent.ACTION_UP:	// eseguita quando termina la gesture e il dito non  pi sullo schermo
						try {
						    ...
						    if(i > 3){ // almeno tre punti per disegnare un poligono
							    ...
							    // es.: in caso di chiamata verso un web-service  possibile inviare le
