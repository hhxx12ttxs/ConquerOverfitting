...
public class ShapeWriter {
    ...
    private OpenStreetMapViewProjection pointTransformer = null;
     ...
     */
    public ShapeWriter( OpenStreetMapViewProjection pointTransformer, PointShapeFactory pointFactory ) {
     ...
     * @param pointTransformer a transformation from model to view space to use 
     */
    public ShapeWriter( OpenStreetMapViewProjection pointTransformer ) {
        this(pointTransformer, null);
    }

    public ShapeWriter( OpenStreetMapViewProjection pointTransformer, String shapeName, float size ) {
    ...
    private PointF transformPoint( Coordinate model, PointF view ) {
        ...
        pointTransformer.toPixels(GeoPoint.from2DoubleString(model.y+"", model.x+""), point);
        transPoint = new PointF(point);
        return transPoint;
    }
}
