package us.corytodd.utils;

/**
 * Sourced from three example projects:
 * 1) http://www.javapractices.com/topic/TopicAction.do?Id=13
 * 2) svn://svn.code.sf.net/p/timeandmoney/code/ timeandmoney-code
 * 3) http://users.csc.calpoly.edu/~jdalbey/SWE/SampleCode/Money.java
 */
...
* to scale (while {@link #isEqual(Money)} is not) . That is,  
* <PRE>
...
public final class Money implements Comparable<Money>, Serializable {
  ...
  */
  public static final class MismatchedCurrencyException extends RuntimeException { 
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5986081949848414991L;
  ...
  */
  ...
  public Money(String string) {
	  	this(new BigDecimal(string), DEFAULT_CURRENCY, DEFAULT_ROUNDING);
   }
  ...
  * Currencies must match.  
  */
  public Money subtract(Money aThat){
    checkCurrenciesMatch(aThat);
  ...
  */
  public boolean isEqual(Money aThat) {
    checkCurrenciesMatch(aThat);
  ...
  */
  public boolean isGreaterThan(Money aThat) { 
    checkCurrenciesMatch(aThat);
    return compareAmount(aThat) > 0;  
  }
  ...
  */
  public boolean isGreaterThanOrEqual(Money aThat) { 
    checkCurrenciesMatch(aThat);
    return compareAmount(aThat) >= 0;  
  }
  ...
  * 'that' amount. Currencies must match. 
  */
  public boolean isLessThan(Money aThat) { 
    checkCurrenciesMatch(aThat);
    return compareAmount(aThat) < 0;  
  }
  ...
  * 'that' amount. Currencies must match.  
  */
  public boolean isLessThanOrEqual(Money aThat) { 
    checkCurrenciesMatch(aThat);
    return compareAmount(aThat) <= 0;  
  }
  ...
  * <tt>Money</tt>.
  */
  public Money multiply(int aFactor){  
  ...
  * 'this' <tt>Money</tt>. 
  */
  public Money multiply(double aFactor){
  ...
  * 'this' <tt>Money</tt>. 
  */
  public Money divide(int aDivisor){
  ...
  * 'this' <tt>Money</tt>. 
  */
  public Money divide(double aDivisor){  
  ...
  * The {@link #isEqual(Money)} method, on the other hand, is <em>not</em> 
  * sensitive to scale.
  */
