...
public class PreferencesForm extends Shell
{
	...
	public PreferencesForm() {
		...
		lblprjname = new Label(grpPreferences, SWT.BORDER | SWT.CENTER);
		...
		lblamount = new Label(grpPreferences, SWT.BORDER | SWT.CENTER);
	   ...
	   // txtamount.setText("0.00");
		...
		btnNext.setText("Ne&xt");
		btnNext.setFont(new Font(display, "Times New Roman", 10, SWT.NONE));
		layout = new FormData();
		layout.top = new FormAttachment(chkbtnManualAccCode, 20);
	...
	private void setEvents() 
	{
		btnNext.addFocusListener(new FocusAdapter() {
			...
			public void focusGained(FocusEvent arg0) {
				btnNext.setBackground(FocusBackground);
				btnNext.setForeground(BtnFocusForeground);
			...
			public void focusLost(FocusEvent arg0) {
				...
				btnNext.setForeground(Foreground);
				
				// TODO Auto-generated method stub
			//	super.focusLost(arg0);
			}
		});
		btnAddNewProj.addFocusListener(new FocusAdapter() {
			@Override
			public void focusGained(FocusEvent arg0) {
				btnAddNewProj.setBackground(FocusBackground);
				btnAddNewProj.setForeground(BtnFocusForeground);
				// TODO Auto-generated method stub
			//	super.focusGained(arg0);
			}
			@Override
			public void focusLost(FocusEvent arg0) {
				btnAddNewProj.setBackground(Background);
				btnAddNewProj.setForeground(Foreground);
				// TODO Auto-generated method stub
				super.focusLost(arg0);
			}
		});
		chkbtnProjAcc.addFocusListener(new FocusAdapter() {
			@Override
			public void focusGained(FocusEvent arg0) {
				chkbtnProjAcc.setBackground(FocusBackground);
				chkbtnProjAcc.setForeground(BtnFocusForeground);
				// TODO Auto-generated method stub
			//	super.focusGained(arg0);
			}
			@Override
			public void focusLost(FocusEvent arg0) {
				chkbtnProjAcc.setBackground(Background);
				chkbtnProjAcc.setForeground(Foreground);
				// TODO Auto-generated method stub
				//super.focusLost(arg0);
			}
		});
		...
		this.btnAddNewProj.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent arg0) {
				...
				newtxtprjname.setBackground(FocusBackground);
				newtxtprjname.setForeground(FocusForeground);
				
				newtxtamount = new Text(grpPreferences, SWT.BORDER | SWT.RIGHT);
				gd=new GridData();
				gd.widthHint=170;
				newtxtamount.setLayoutData(gd);
				newtxtamount.setBackground(Background);
				newtxtamount.setForeground(Foreground);
			...
			if(chkbtnProjAcc.getSelection()==true)
			 {
				...
				{
					if(amounts.get(i).getText().equals(""))
						{
							projectAmount.put(projectNames.get(i).getText() ,nf.format(Double.parseDouble("0.00")));
						} else{
						try {
		...
		for(int rowcounter=startFrom; rowcounter<projectNames.size();rowcounter++)
		{
			...
			projectNames.get(rowcounter).addFocusListener(new FocusAdapter() {
				...
				public void focusLost(FocusEvent arg0) {
					...
					curprjname.setBackground(Background);
					curprjname.setForeground(Foreground);
					final int rowindex=(Integer) curprjname.getData("curindex");
				...
				public void focusGained(FocusEvent arg0) {
					Text curprjname = (Text) arg0.widget;
					curprjname.setBackground(FocusBackground);
					curprjname.setForeground(FocusForeground);
			...
			amounts.get(rowcounter).addFocusListener(new FocusAdapter() {
				...
				public void focusLost(FocusEvent arg0) {
					...
					try {
						...
						//amounts.get(rowindex).setText(nf.format(Double.valueOf(s)));
						e.printStackTrace();
					}
			...
			if(arg0.keyCode == 46)
			{
				...
				Removebtn.get(rowcounter).addFocusListener(new FocusAdapter() {
					...
					public void focusGained(FocusEvent arg0) {
						...
						btncurrentremove.setForeground(FocusForeground);
						// TODO Auto-generated method stub
					//	super.focusGained(arg0);
					}
					@Override
