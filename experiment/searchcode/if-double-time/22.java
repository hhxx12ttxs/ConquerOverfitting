...
import org.not.java.DateFormat;
...
final class NativeDate extends IdScriptableObject
{
    ...
    private NativeDate()
    {
        if (thisTimeZone == null) {
            ...
            // should be OK.
            thisTimeZone = org.not.java.TimeZone.getDefault();
    ...
    private static String date_format(double t, int methodId)
    {
        ...
        if (methodId != Id_toDateString) {
            ...
            if (timeZoneFormatter == null)
                timeZoneFormatter = new org.not.java.SimpleDateFormat("zzz");
    ...
    {
    	org.not.java.DateFormat formatter;
        switch (methodId) {
          case Id_toLocaleString:
...
// #/string_id_map#
    ...
    /* cached values */
    private static org.not.java.TimeZone thisTimeZone;
    private static double LocalTZA;
    private static org.not.java.DateFormat timeZoneFormatter;
    private static org.not.java.DateFormat localeDateTimeFormatter;
    private static org.not.java.DateFormat localeDateFormatter;
    private static org.not.java.DateFormat localeTimeFormatter;
