 ...
 */
public class BitmapLoaderTask extends AsyncTask<byte[], Void, Bitmap> {
    ...
    public BitmapLoaderTask(ImageView imageView, IImageModifier modifier, IImageReceiver imageReceiver,
