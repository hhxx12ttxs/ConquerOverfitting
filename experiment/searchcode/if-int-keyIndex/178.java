...
import com.googlecode.eyesfree.inputmethod.latin.LatinKeyboardBaseView.OnKeyboardActionListener;
import com.googlecode.eyesfree.inputmethod.latin.LatinKeyboardBaseView.UIHandler;
...
public class PointerTracker {
    ...
    public void onDownEvent(int x, int y, long eventTime) {
        ...
        if (isValidKeyIndex(keyIndex)) {
            ...
            if (mKeys[keyIndex].repeatable && !mIsAccessibilityEnabled) {
                repeatKey(keyIndex);
