...
package com.exalto.UI.grid.org.jdesktop.swingx.treetable;
...
import com.exalto.UI.grid.org.jdesktop.swingx.JXTreeTable;
 ...
 * @author Ramesh Gupta
 */
public class AttrTextEditor extends DefaultCellEditor {

    public AttrTextEditor(JTree tree) {
  ...
  //     System.out.println(" in TTCE tree ");
    ...
    public AttrTextEditor(JTree tree, JXTreeTable treeTable) {
        super(new TreeTableTextField());
        if (tree == null) {
            throw new IllegalArgumentException("null tree");
        }
