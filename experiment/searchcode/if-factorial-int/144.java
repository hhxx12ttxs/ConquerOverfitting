...
{
	public static ArrayList<GlobalVariant> mergeGlobalVariantSet(ArrayList<GlobalVariant> b) throws DocumentOperationException
	{
	    
		ArrayList<GlobalVariant> a = new ArrayList<GlobalVariant>();
	...
	public static void setFrequencies(ArrayList<GlobalVariant> reconstructedQuasispecies)
	{
	...
	public static ArrayList<GlobalVariant> correct(ArrayList<GlobalVariant> gv, double start, double stop, String genome, double hErr, double nonhErr, int runs, int n_proc) throws DocumentOperationException
	{
		LocalVariantSet lvs = new LocalVariantSet();
		Hashtable<String,LocalVariant> h=new Hashtable<String,LocalVariant>();
		ArrayList<LocalVariant> a=new ArrayList<LocalVariant>();
		...
		ArrayList<GlobalVariant> gvsNew = new ArrayList<GlobalVariant>();
	...
	public static double posteriorClusteringLikelihood(ArrayList<Integer> clusterIndices, ArrayList<LocalVariant> lv, double length, String genome, double hErr, double nonhErr)
	{
		if (clusterIndices.size()==0)
			return Double.MAX_VALUE;
		ArrayList<LocalVariant> clusterSet = new ArrayList<LocalVariant>();
		...
		for (int i=0; i<lv.size(); i++)
		{
			...
			if (dist!=0)
			{
				...
				double prob = Math.max(Double.MIN_VALUE,Functions.poissonError(dist, length, errorRate));
	...
	public static ArrayList<Integer> proposeClusterSet(ArrayList<Integer> c, int size) throws DocumentOperationException
	{
	...
	public static double overallErrorProbability(double start,double stop, String genome, double hErr, double nonhErr) throws DocumentOperationException
	{
		double prob=0;
		double tot=0;
