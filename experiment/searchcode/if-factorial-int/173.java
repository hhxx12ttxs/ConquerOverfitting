 ...
 * form of histogram or multiset) by using {@link org.infinispan.commons.util.concurrent.jdk8backported.LongAdder} values
 ...
 * org.infinispan.commons.util.concurrent.jdk8backported.ForkJoinPool#commonPool()}). Tasks that may be used in other
...
public class EquivalentConcurrentHashMapV8<K,V>
    ...
    * java.util.Collection#add} and {@link java.util.Collection#addAll}). This is of
    ...
    */
   @SuppressWarnings("unchecked") public Entry<K,V> reduceEntriesSequentially
   (BiFun<Entry<K,V>, Entry<K,V>, ? extends Entry<K,V>> reducer) {
      if (reducer == null) throw new NullPointerException();
      Traverser<K,V,Object> it = new Traverser<K,V,Object>(this);
      Entry<K,V> r = null; V v;
      while ((v = it.advance()) != null) {
         Entry<K,V> u = entryFor((K)it.nextKey, v);
         r = (r == null) ? u : reducer.apply(r, u);
      }
      return r;
   }
    ...
    * @param action the action
    */
   public void forEachEntryInParallel(Action<Entry<K,V>> action) {
    ...
    * @return the result of accumulating all entries
    */
   public Entry<K,V> reduceEntriesInParallel
   (BiFun<Entry<K,V>, Entry<K,V>, ? extends Entry<K,V>> reducer) {
   ...
   @SuppressWarnings("serial") static final class ReduceEntriesTask<K,V>
         extends Traverser<K,V,Entry<K,V>> {
