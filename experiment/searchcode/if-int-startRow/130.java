 ...
 */
package org.waksiu.myjsf.domain;
...
//            page = fetchPage(rowIndex, pageSize);
        ...
        int datasetSize = page.getTotalResult();
        int startRow = page.getStartRow();
        int nRows = page.getListResult().size();
        ...
        return page.getListResult().get(rowIndex - startRow);
    }
    ...
    public boolean isRowAvailable() {
        ...
        if (rowIndex < 0) {
            return false;
        } else if (rowIndex >= page.getTotalResult()) {
            return false;
        } else {
            return true;
        }
     ...
     */
    public abstract BaseResult<T> fetchPage(int startRow, int pageSize);
}
