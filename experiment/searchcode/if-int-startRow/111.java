...
public class ExcelInputMetaInjection implements StepMetaInjectionInterface
{
	...
	private enum Entry
	{
		...
		FIELDS(ValueMetaInterface.TYPE_NONE,
			"All the fields on the spreadsheets"),
		...
		TRIM_TYPE(FIELD,
			ValueMetaInterface.TYPE_STRING,
			"Field trim type (none, left, right, both)"),
		FORMAT(FIELD,
			ValueMetaInterface.TYPE_STRING,
		...
		SHEETS(ValueMetaInterface.TYPE_NONE,
			"All the sheets in the spreadsheets"),
		SHEET(ValueMetaInterface.TYPE_NONE,
			"One sheet in the spreadsheet"),

		SHEET_NAME(SHEET,
			ValueMetaInterface.TYPE_STRING,
			"Sheet name"),
		SHEET_START_ROW(SHEET,
			ValueMetaInterface.TYPE_STRING,
			"Sheet start row"),
		SHEET_START_COL(SHEET,
			ValueMetaInterface.TYPE_STRING,
			"Sheet start col"), ;
