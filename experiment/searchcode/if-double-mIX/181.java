...
//					 CALC THE OVERLAP OF Y
	...
	*******************************************************************************/		
	public static RgbImage changeColorByHSL (final RgbImage sourceImg, int H, int S, int L, int alpha) 
	{
		...
		{
			//#mdebug error
de.enough.polish.util.Debug.debug("error", "de.enough.polish.util.ImageUtil", 1541, "Error adjusting RgbImage colorspace: ", t.getMessage());
de.enough.polish.util.Debug.debug("error", "de.enough.polish.util.ImageUtil", 1542, t);
			//#enddebug
	...
	*******************************************************************************/		
	public static RgbImage changeColorBalance (final RgbImage sourceImg, int R, int G, int B, int alpha) 
	{
		...
		{
			//#mdebug error
de.enough.polish.util.Debug.debug("error", "de.enough.polish.util.ImageUtil", 1818, "Error balancing RgbImage: ", t.getMessage());
de.enough.polish.util.Debug.debug("error", "de.enough.polish.util.ImageUtil", 1819, t);
			//#enddebug
		}
