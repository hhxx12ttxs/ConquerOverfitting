...
public class CSVFile implements Serializable 
{
    ...
    public CSVFile(String csvString) throws IOException 
    {
        load(csvString);
    }
    ...
    public void load(String csvString) throws IOException 
    {
        BufferedReader reader = null;
        try {
            reader = new BufferedReader(new StringReader(csvString));
