...
public class Intent implements Parcelable, Cloneable {
     ...
     * {@link #ACTION_BATTERY_FULL}, {@link #ACTION_BATTERY_OKAY}, {@link #ACTION_POWER_CONNECTED},
    ...
    /**
     * Broadcast Action:  Indicates full battery condition on the device.
     * This broadcast corresponds to the "Full battery warning" system dialog.
     *
     * <p class="note">This is a protected intent that can only be sent
     * by the system.
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_BATTERY_FULL = "android.intent.action.BATTERY_FULL";
    /**
    ...
    /** Warmboot feature which enables Device to enter into and resume from "hibernate2ram" state
     * Activity Action:  Start this activity to request system hibernate
     *
     * <p class="note">This is a protected intent that can only be sent
     * by the system.
     *
     * {@hide}
     */
    public static final String ACTION_REQUEST_HIBERNATE = "android.intent.action.ACTION_REQUEST_HIBERNATE";
    /**
