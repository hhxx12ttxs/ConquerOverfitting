 ...
 *     character ('ą') (see {@link AmountFormat}). For example, 
 *     <code>"(2.0 ą 0.001) km/s"</code> represents a velocity of 
 *     2 km/s with an absolute error of ą 1 m/s. Exact amount use an
...
////////////////////////////////////////////////////////////////////////////////
     ...
     *
     * @param value the estimated value (ą LSB) stated in the specified unit.
     * @param unit the unit in which the value is stated.
     * @return the corresponding measure object.
     */
     ...
     *
     * @param value the estimated amount (ą error) stated in the specified unit.
     ...
     * @return <code>this ˇ factor</code>.
     */
