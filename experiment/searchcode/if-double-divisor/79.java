...
public class NumberUtil
{
	 ...
	 * @return 1 if 1st is greater than 2nd, -1 if 1st is less than 2nd, 0 if
	 *         1st equals wit 2nd. Null is valid in here.
	 */
	...
	public static int compareNumber( Number na, Number nb )
	{
		...
		return Double.valueOf( na.doubleValue( ) )
				.compareTo( Double.valueOf( nb.doubleValue( ) ) );
	}
