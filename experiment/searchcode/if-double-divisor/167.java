...
public class SymphonyId extends Id implements java.io.Serializable {
	...
	static public double buildIdFrom(byte[] data)
	{
		...
		double id2 = wrapperDigest.doubleValue();
		//System.out.println("*********** id app "+getDecimals(id2));
		
		return getDecimals(id2);
	}
...
// Id
	...
	public boolean between(Id ccw, Id cw) {
		//System.out.println("destination between "+ccw+" and "+cw);
		int comp = ccw.compareTo(cw);
		//System.out.println("comaparation "+comp);
		if (comp == 0)
			return true;
					//ccw<cw
		else if (comp < 0)
