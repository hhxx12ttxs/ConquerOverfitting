                ...
                if(isGUI)
                {
                    ...
                    if(flag)
                    {
                        if(isResize)
                        {
                            ...
                            Dimension dimension5 = dS;
                            int i2 = dimension2.width + (l - oldX);
                            int j2 = dimension2.height + (j1 - oldY);
                            setSize(i2 >= dimension5.width ? i2 <= dimension4.width ? i2 : dimension4.width : dimension5.width, j2 >= dimension5.height ? j2 <= dimension4.height ? j2 : dimension4.height : dimension5.height);
                            oldX = l;
                            oldY = j1;
                        } else
                        {
                            Point point2 = getLocation();
                            Dimension dimension6 = getParent().getSize();
                            l = (point2.x + l) - oldX;
                            l = l > 0 ? l + dimension1.width < dimension6.width ? l : dimension6.width - dimension1.width : 0;
                            j1 = (point2.y + j1) - oldY;
                            j1 = j1 > 0 ? j1 + dimension1.height < dimension6.height ? j1 : dimension6.height - dimension1.height : 0;
                            setLocation(l, j1);
                        }
                        if(isPaint)
                        {
