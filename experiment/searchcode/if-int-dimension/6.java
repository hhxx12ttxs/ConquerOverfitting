...
public class RedstoneEtherServer extends RedstoneEther
{
    ...
    public void resetPlayer(EntityPlayer player)
    {
        ...
        String openstring = SaveManager.generalProp.getProperty(player.username+".jammedFreqs");
        if(openstring == null)
            jamDefaultRange(player.username);
        else
            loadJammedFrequencies(openstring, player.username);
    ...
    {
        playerJammedMap.remove(player.username);
    }
