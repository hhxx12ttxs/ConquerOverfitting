...
public class RedstoneEtherServerAddons extends RedstoneEtherAddons
{
    ...
    {
        return playerInfos.get(player.username);
    }
    ...
    {
        playerInfos.put(player.username, new AddonPlayerInfo());
    }
    
    public void onLogout(EntityPlayer player)
    {
        playerInfos.remove(player.username);
    }
    ...
    public void onDimensionChange(EntityPlayer player)
    {
        ...
        for(Iterator<EntityWirelessTracker> iterator = playerTrackers.iterator(); iterator.hasNext();)
        {
            ...
            if(tracker.attachedPlayerName.equals(player.username))
            {
    ...
    {
        trackerTicks++;
        HashSet<EntityPlayer> playerEntities = new HashSet<EntityPlayer>(ServerUtils.getAllPlayers());
