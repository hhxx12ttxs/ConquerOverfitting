...
public class ImageInfo implements Serializable {
	...
	public List<Info> getInfo() {
		...
		if ( orientation != 0 ) {
			result.add( new Info( "Orientation", orientation + "Ą" ) );
		}
	...
	private String processLightSource( int value ) {
		switch ( value ) {
			...
			case 11:
				return "Shade";
			case 12:
				return "Daylight fluorescent (D 5700 Đ 7100K)";
			case 13:
				return "Day white fluorescent (N 4600 Đ 5400K)";
			case 14:
				return "Cool white fluorescent (W 3900 Đ 4500K)";
			case 15:
				return "White fluorescent (WW 3200 Đ 3700K)";
			case 17:
