...
public class ActionMenuView extends IcsLinearLayout implements MenuBuilder.ItemInvoker, MenuView {
    ...
    /* (non-Javadoc)
     * @see com.actionbarsherlock.internal.widget.IcsLinearLayout#onLayout(boolean, int, int, int, int)
     */
    @Override
     ...
     *
     * @param reserveOverflow the new overflow reserved
     */
    ...
    /* (non-Javadoc)
     * @see com.actionbarsherlock.internal.widget.IcsLinearLayout#generateDefaultLayoutParams()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.actionbarsherlock.internal.widget.IcsLinearLayout#generateLayoutParams(android.util.AttributeSet)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.actionbarsherlock.internal.widget.IcsLinearLayout#generateLayoutParams(android.view.ViewGroup.LayoutParams)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.actionbarsherlock.internal.widget.IcsLinearLayout#checkLayoutParams(android.view.ViewGroup.LayoutParams)
     */
    @Override
    ...
    public static class LayoutParams extends IcsLinearLayout.LayoutParams {
         ...
         * @param width the width
         * @param height the height
         * @param isOverflowButton the is overflow button
         */
