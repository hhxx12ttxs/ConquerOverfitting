...
public class UnlockRing extends ViewGroup {
    ...
    public static final int HALO_RADIUS = 30;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthSpecMode == MeasureSpec.UNSPECIFIED || heightSpecMode == MeasureSpec.UNSPECIFIED) {
            Log.e("UnlockRing", "UnlockRing cannot have UNSPECIFIED MeasureSpec" + "(wspec="
    ...
    public boolean inRing(float xPos, float yPos) {
        ...
        Resources r = getResources();
        final int ra = r.getDisplayMetrics().densityDpi;

        if (DBG) {
           Log.d(TAG, "X: " + x + " , Y: " + y);
           Log.d(TAG, "Max radius: " + ra);
