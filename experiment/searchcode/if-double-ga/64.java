    ...
    private static class AppFrame extends ApplicationTemplate.AppFrame
    {
        ...
        private void setupAnnotations()
        {
            ...
            ga.getAttributes().setAdjustWidthToText(
                Annotation.SIZE_FIXED);  // use strict dimension - dont follow text width
        ...
        public void makeRelativeAnnotations(AnnotationLayer layer)
        {
            ...
            defaultAttributes.setAdjustWidthToText(Annotation.SIZE_FIT_TEXT); // use strict dimension width - 200
        ...
        private void updateControlPanel()
        {
            if (this.currentAnnotation != null)
            {
                ...
                if (imageRepeat.equals(Annotation.IMAGE_REPEAT_NONE))
                    this.cbImageRepeat.setSelectedIndex(0);
                else if (imageRepeat.equals(Annotation.IMAGE_REPEAT_X))
                    this.cbImageRepeat.setSelectedIndex(1);
                else if (imageRepeat.equals(Annotation.IMAGE_REPEAT_Y))
                    this.cbImageRepeat.setSelectedIndex(2);
                else if (imageRepeat.equals(Annotation.IMAGE_REPEAT_XY))
        ...
        private void updateAnnotation()
        {
            if (this.currentAnnotation != null && !this.suspendUpdate)
            {
                ...
                {
                    case 0:
                        currentAnnotation.getAttributes().setImageRepeat(Annotation.IMAGE_REPEAT_NONE);
                        break;
                    case 1:
                        currentAnnotation.getAttributes().setImageRepeat(Annotation.IMAGE_REPEAT_X);
                        break;
                    case 2:
                        currentAnnotation.getAttributes().setImageRepeat(Annotation.IMAGE_REPEAT_Y);
                        break;
                    case 3:
                        currentAnnotation.getAttributes().setImageRepeat(Annotation.IMAGE_REPEAT_XY);
                        break;
                }
