...
public abstract class EntityPlayer extends EntityLiving {
    ...
    public final void callSuper(double mx, double my, double mz) { super.moveEntity(mx,my,mz); }
    ...
    {
        // -----------------------------------------------------------------------------------------------------------------------
        return !noClip && !sleeping && super.isEntityInsideOpaqueBlock();
        // -----------------------------------------------------------------------------------------------------------------------
    }
