...
import com.dsh105.echopet.nms.v1_7_R3.entity.EntityNoClipPetImpl;
...
@EntityPetData(petType = PetType.ENDERDRAGON)
public class EntityEnderDragonPetImpl extends EntityNoClipPetImpl implements IComplex, IMonster, EntityEnderDragonPet {
    ...
    public EntityEnderDragonPetImpl(World world) {
        super(world);
    }

    public EntityEnderDragonPetImpl(World world, Pet pet) {
        super(world, pet);
            ...
            if (human.getBukkitEntity() == this.getPlayerOwner().getPlayer()) {
                ...
                if (this.FIELD_JUMP != null) {
                    try {
                        ...
                        EchoPet.LOG.console("Failed to allow EnderDragon flight for " + getPlayerOwner().getName() + "\'s pet.");
                        e.printStackTrace();
