...
public class EntityDragon extends EntityLiving implements IBossDisplayData, IEntityMultiPart
{
    ...
    private void updateDragonEnderCrystal()
    {
        if (this.healingEnderCrystal != null)
        {
            ...
            else if (this.ticksExisted % 10 == 0 && this.health < this.maxHealth)     // CraftBukkit - this.getMaxHealth() -> this.maxHealth
            {
                // CraftBukkit start
    ...
    public boolean func_82195_e(DamageSource par1DamageSource, int par2)   // CraftBukkit - protected -> public
    {
