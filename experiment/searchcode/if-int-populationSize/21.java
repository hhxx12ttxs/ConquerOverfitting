...
public class GAsearch {
	...
	private static String[] cities = {"edin", "aber", "ayr", "fort", "glas", "inv", "stan", "stir"};
	private static int MAX_POPULATION = 400;
	...
	private static int numberOfCities = 9; //to include round trip to edinburgh
	...
	private static void readTheDistanceMatrix() {
		...
		try {
			...
			System.exit0; city2 < numberOfCities; city2++) {
				inputNumberInt = Integer.parseInt(splitarray[city2]);
				distance[city1][city2] = inputNumberInt;(0);
		}
	}
