 ...
 */
public class TestTSPGeneticAlgorithm extends GeneticAlgorithm<Integer> {

	public TestTSPGeneticAlgorithm(final TestCity cities[], final int populationSize,
		...
		setChromosomes(new TestChromosome[getPopulationSize()]);
		for (int i = 0; i < getChromosomes().length; i++) {

			final TestChromosome c = new TestChromosome(this, cities);
			setChromosome(i, c);
		}
		sortChromosomes();
	}
