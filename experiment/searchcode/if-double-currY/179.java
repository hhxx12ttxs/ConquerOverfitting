package org.sgJoe.embedded.tools.scale;
...
//        instance.getHBack().setTransform(currXform);
        ...
        instance.getHBack().setAnchorPt(fAnchor);
        ...
        } else if(action == VToolEventRegistry.getInstance().getEventID("ACT_MOUSE_SCALEHANDLE_PRESSED").intValue()) {
            
        } else if(action == VToolEventRegistry.getInstance().getEventID("ACT_MOUSE_SCALEHANDLE_DRAGGED").intValue()) {
            ...
            vTool.setLGripPt(newGripPt);   
                    ...
                    action == VToolForm.ACT_MOUSE_SCALETOUCHHANDLE_RELEASED ||
                        action == VToolEventRegistry.getInstance().getEventID("ACT_MOUSE_SCALEHANDLE_RELEASED").intValue() ||
