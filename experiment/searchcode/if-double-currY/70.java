 ...
 * @version 2.20<br>
 *          <ul>
 *          <li>$LastChangedRevision: 140 $</li>
 *          <li>$LastChangedDate: 2009-05-19 13:33:07 +1000 (Tue, 19 May 2009) $</li>
...
public final class Gen<A> {
  ...
  public static <A> Gen<A> sized(final F<Integer, Gen<A>> f) {
    return parameterised(Function.flip(Function.<Rand, F<Integer, Gen<A>>>constant(f)));
  }
  ...
  public static <A> Gen<A> frequency(final List<P2<Integer, Gen<A>>> gs) {
    ...
    final F<P2<Integer, Gen<A>>, Integer> f = P2.__1();

    return choose(1, Monoid.intAdditionMonoid.sumLeft(gs.map(f))).bind(new F<Integer, Gen<A>>() {
  ...
  public static <A> Gen<A> elements(final A... as) {
    return Array.array(as).isEmpty() ? Gen.<A>fail() : choose(0, as.length - 1).map(new F<Integer, A>() {
