...
// [jooq-tools] END [seek]
    ...
    @Override
    public final SelectOrderByStep<R> window(WindowDefinition... definitions) {
        getQuery().addWindow(definitions);
        return this;
    }

    @Override
    public final SelectOrderByStep<R> window(Collection<? extends WindowDefinition> definitions) {
        getQuery().addWindow(definitions);
        return this;
    }
