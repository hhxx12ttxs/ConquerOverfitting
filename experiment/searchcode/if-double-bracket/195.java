...
public class ExecutionInitializer {
	...
	private org.drip.math.autodiff.ObjectiveFunction _of = null;
		...
		throws java.lang.Exception
	{
		...
		org.drip.math.autodiff.Differential diff1D = _of.calcDerivative (dblConvergenceZoneVariate, 1);
		...
		org.drip.math.autodiff.Differential diff2D = _of.calcDerivative (dblConvergenceZoneVariate, 2);
	...
	public ExecutionInitializer (
		final org.drip.math.autodiff.ObjectiveFunction of,
