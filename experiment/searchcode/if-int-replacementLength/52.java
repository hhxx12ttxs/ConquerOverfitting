...
import at.bestsolution.efxclipse.text.jface.DocumentCommand;
...
import at.bestsolution.efxclipse.text.jface.ITextViewerExtension2;
import at.bestsolution.efxclipse.text.jface.ITextViewerExtension4;
import at.bestsolution.efxclipse.text.jface.ITextViewerExtension5;
...
import at.bestsolution.efxclipse.text.jface.contentassist.ICompletionProposalExtension5;
import at.bestsolution.efxclipse.text.jface.contentassist.ICompletionProposalExtension6;
...
//		TextSelection selection= viewer.getSelectedRange();
//		fToggleEating= (stateMask & SWT.CTRL) != 0;
//		int newLength= selection.offset + selection.length - getReplacementOffset();
...
//			setReplacementLength(newLength);
	...
	public TextSelection getSelection(IDocument document) {
		if (!fIsValidated)
			return null;
		return new TextSelection(getReplacementOffset() + getCursorPosition(), 0);
	}
...
//		}
	...
	private void updateStyle(ITextViewer viewer) {
		StyledTextArea text= viewer.getTextWidget();
