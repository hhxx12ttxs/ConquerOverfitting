...
// * Creates a plot NPC.
// */
//public class CommandPlotHireVendor extends CrimsonCommand {
//    @Override
//    public void execute(CommandSender sender, Command cmnd, String string, String[] args) {
//        //Check if the person is a player
//        if (!(sender instanceof Player)) {
//            sender.sendMessage("You can't hire Vendors from the console.");
//            return;
//        }
//        
...
//        if (!PlotUtils.getRole(citizen, plot).hasPrivilege(Privilege.MOD_NPC_VENDOR)) {
//            citizen.sendError("You are not allowed to hire Vendors.");
//            return;
//        }
//        
...
//        
//        //Create the NPC
//        npcFlag.addNPC(name, citizen.getLocation(), Type.VENDOR);
//        citizen.sendPlotMessage("The Vendor " + name + " has been hired for the plot.");
//    }
//}
