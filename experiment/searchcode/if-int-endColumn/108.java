...
public abstract class SingleChunkLineRenderer implements LineRenderer {
     ...
     * @param startColumn
     *         the first column to render
     * @param endLine
     *         the last line to render (inclusive)
     * @param endColumn
     *         the last column to render (inclusive)
     * @param className
     *         the CSS class to apply
     */
    public static SingleChunkLineRenderer create(final int startLine, final int startColumn, final int endLine,
     ...
     *
     * @param startAnchor
     *         the rendering start point.
     * @param endAnchor
     *         the last part to render (note that whatever line or
     *         character the anchor is at will also be rendered.
     * @param className
     *         the CSS class name to apply
     */
    public static SingleChunkLineRenderer create(final Anchor startAnchor, final Anchor endAnchor, String className) {
