...
public final class ClassOrInterfaceType extends Type {
	...
	@Override
	public boolean isPrimi() {
		if(name.equals("Boolean") || "Char".equals(name) || "Byte".equals(name) || "Short".equals(name) ||
				"Integer".equals(name) || "Long".equals(name) || "Float".equals(name) || "Double".equals(name) || "String".equals(name))return true;
						return false;
	}
