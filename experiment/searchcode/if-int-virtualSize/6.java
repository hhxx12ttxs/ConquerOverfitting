...
public class PESection implements Cloneable, Serializable {
	...
	public static final int CHARACTERISTICS_COMDAT = 0x00001000; // The section contains COMDAT data. For more information, see section 5.5.6, ?COMDAT Sections (Object Only).Ó This is valid only for object files.
