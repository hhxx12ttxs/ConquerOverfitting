 ...
 * DISCLAIMER
 *
 * I wrote all these programs strictly as illustrative examples for my book.
 * You're free to use the source code any way you like, but bear in mind that
 * this is not fully tested, commercial-quality code. Neither Prentice-Hall nor
 * I can be responsible for anything bad that may happen if you use these
 * programs.
 *
 * This class was copied from the book (with minor modifications) by
 * David Finlayson.
 *
 * Copyright  2006, 2007 Ronald Mak
 *
 * History
 * 
 * 25 October 2008 - Typed the class in, changed the float to double. /DPF
 ******************************************************************************/
 ...
 * The matrix class.
 * 
 * @author Ronalg Mak (2003) Java Number Cruncher: The Java Programmer's Guide
 * @author to numerical computing, Prentice Hall: Upper Saddle, NJ. p 230.
 */
public class Matrix {
     ...
     * @param colCount the number of cols.
     */
     ...
     */
    public int colCount() { return nCols; }
    ...
    /**
     * Set this matrx from a 2-d array of values
     * If the rows do not have the same length, then the matrix column
     * count is the length of the shortest row.
     * @param values the 2-d array of values
     */
    ...
    public void setRow(RowVector rv, int r) throws MatrixException
    {
        ...
        if ((nCols != rv.nCols)) {
            throw new MatrixException(MatrixException.INVALID_DEMENSIONS);
        }
     ...
     */
     ...
     /**
      * Substract another matrix from this matrix
     ...
     public Matrix multiply(Matrix m) throws MatrixException
     {
         ...
         double pv[][] = new double[nRows][nCols];  // product value
     ...
     */
     ...
     /**
      * Print the matrix values. This was modified a bit to remove a dependancy
      * on Mak's AlignRight class.
      */
     public void print()
     {
         for (int r = 0; r < nRows; ++r) {
             ...
             for (int c = 0; c < nCols; ++c) {
                 System.out.printf("%f", values[r][c]);
             }
