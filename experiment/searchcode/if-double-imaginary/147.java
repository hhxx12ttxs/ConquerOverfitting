 ...
 * to produce a Tricorn fractal when they are called by a FractalExplorer
 * instance
 */
public class Tricorn extends FractalGenerator {
     ...
     *
     * Uses the generation function z(n) = (conj(z(n-1)))^2 + c, where
     * c = x + iy and n is an integer number of iterations
     */
