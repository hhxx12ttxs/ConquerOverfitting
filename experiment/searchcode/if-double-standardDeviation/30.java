...
package applications.bayesAnalyzeImagePixelsUnique;
 ...
 * @author  apple
 */
public class AnalyzeImagePixelsUnique extends javax.swing.JPanel
        implements ImageModel,
                    EnterAsciiPackage,
                        java.beans.PropertyChangeListener {

    /** Creates new form AnalyzeImagePixels */
    public AnalyzeImagePixelsUnique() {
    ...
    private class FormListener implements java.awt.event.ActionListener, java.beans.PropertyChangeListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == jSystemModel) {
                AnalyzeImagePixelsUnique.this.jSystemModelActionPerformed(evt);
            }
            else if (evt.getSource() == jUserModel) {
                AnalyzeImagePixelsUnique.this.jUserModelActionPerformed(evt);
            }
            else if (evt.getSource() == buildModelButton) {
                AnalyzeImagePixelsUnique.this.buildModelButtonActionPerformed(evt);
            }
        ...
        public void propertyChange(java.beans.PropertyChangeEvent evt) {
            if (evt.getSource() == startFormatetedTextField) {
                AnalyzeImagePixelsUnique.this.startFormatetedTextFieldPropertyChange(evt);
            }
            else if (evt.getSource() == endFormattedTextField) {
                AnalyzeImagePixelsUnique.this.endFormattedTextFieldPropertyChange(evt);
            }
            else if (evt.getSource() == stdDevField) {
                AnalyzeImagePixelsUnique.this.stdDevFieldPropertyChange(evt);
            }
        }
...
private void useGaussianCheckBoxActionPerformed (java.awt.event.ActionEvent evt) {//GEN-FIRST:event_useGaussianCheckBoxActionPerformed
    ...
    public boolean           isReadyToRun(){
      // make sure data has been loaded
       ...
       //make sure exactly two files are selected
       int numimages    = imageFiles.size();  
       if( numimages != 2){
           String msg           =  String.format( 
                                    "Currently %d images are selected.\n"
                                    + "Two images must be selected to run this package.\n"
                                    + "Exiting..." ,numimages);
           DisplayText.popupMessage(msg);
           return false;
       }
       
       // make sure ftable file is present
        boolean isFtableFileFound                    =   false;
        for (File file : imageFiles) {
            isFtableFileFound  = isFTableImage(file); 
            if (isFtableFileFound ){
                break;
            }
        }
        if ( isFtableFileFound == false){
           String msg           =   String.format( 
                                    "No ftable file is found.\n"
                                    + "Exiting...");
           DisplayText.popupMessage(msg);
           return false;
        }
        ...
        for (File file : imageFiles) {
           if(!file.exists()){
                 String msg = String.format(    "Image file doesn't exist.\n" +
                                                "%s\n" +
                                                "Exiting... ",
                                                file.getPath());
                DisplayText.popupMessage(msg);
    ...
    public String            getProgramName(){
       if (isUseMaximumLikelihood() == false){
           return "BayesImagePixelsUnique";
       }
       else {
            return "BayesImagePixelsUniqueMax";
       }
        
    }
    public String            getExtendedProgramName() { return "Analyze Image Pixels Unique" ;}
    ...
    public String            getInstructions(){return PACKAGE_INTSRUCTIONS.BAYES_IMAGE_PIXEL_UNIQUE.getInstruction();}
    ...
    public boolean          isFTableImage(File image){
        String name             =   image.getName().toLowerCase();
        String findStr          =   FTABLE.toLowerCase();
        return name.contains(findStr );
       
    }
     public void sortImageFiles(List<File> in){
       Collections.sort(in, new CustomFileComparator());
    }
    ...
    public static void createAndShowGUI() {
        ...
        frame.add(new AnalyzeImagePixelsUnique());
    ...
    public final static String FTABLE                  =   "ftable";
     ...
     public void        setIncludeOutlires ( boolean outlires ) {
      ...
      class CustomFileComparator implements Comparator<File>{

        public int compare(File t, File t1) {
           if( isFTableImage(t) == false){
               return -1;
           }
           else{
               return 1;
