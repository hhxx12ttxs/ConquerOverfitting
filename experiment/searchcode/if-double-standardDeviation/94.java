...
public class Utility {
	 ...
	 */
	public static boolean anyQ(List a) {
		return (a.size() > 0);
	}

	/**
	 * Queries if all agents in an agentset are true for a boolean closure.
	 * 
	 * @param a
	 *            an agentset
	 * @param reporter
	 *            a boolean closure
	 * @return true or false based on whether all agents in an agentset are true
	 *         for reporter
	 */
	public static boolean allQU(List<? extends ReLogoAgent> a, Closure reporter) {
		return allQU(null, a, reporter);
	}

	public static boolean allQU(Object caller, List<? extends ReLogoAgent> a,
			Closure reporter) {
		if (caller != null) {
			for (ReLogoAgent o : a) {
				o.setMyself(caller);
	 ...
	 */
	public static boolean emptyQ(List list) {
		return (list.isEmpty());
	}
	...
	/**
	 * Returns the turtle with the smallest value when operated on by a set of
	 * commands.
	 * 
	 * @param a
	 *            an agentset
	 * @param closure
	 *            a set of commands
	 * @return turtle with the smallest value when operated on by closure
	 * @exclude
	 */
	public static ReLogoAgent minOneOfU(List<? extends ReLogoAgent> a,
			Closure reporter) {
		return minOneOfU(null, a, reporter);
	}

	public static ReLogoAgent minOneOfU(Object caller,
			List<? extends ReLogoAgent> a, Closure reporter) {
	 ...
	 * @exclude
	 */
	public static AgentSet minNOfU(int number, List<? extends ReLogoAgent> a,
			Closure reporter) {
		return minNOfU(null, number, a, reporter);
	}

	public static AgentSet minNOfU(Object caller, int number,
			List<? extends ReLogoAgent> a, final Closure reporter) {
		List<ReLogoAgent> b = new ArrayList(a);
		int l = b.size();
		Collections.shuffle(b);
		if (caller != null) {
	...
	/**
	 * Returns the turtle with the largest value when operated on by a set of
	 * commands.
	 * 
	 * @param a
	 *            an agentset
	 * @param closure
	 *            a set of commands
	 * @return turtle with the largest value when operated on by closure
	 * @exclude
	 */
	public static ReLogoAgent maxOneOfU(List<? extends ReLogoAgent> a,
			Closure reporter) {
	 ...
	 * @exclude
	 */
	public static AgentSet maxNOfU(int number, List<? extends ReLogoAgent> a,
			Closure reporter) {
	...
	public static AgentSet removeLinkFromList(List a, Link l) {
		Predicate pr = NotPredicate.getInstance(EqualPredicate.getInstance(l));
		FilteredIterator result = new FilteredIterator(a.iterator(), pr);
		AgentSet b = new AgentSet();
		while (result.hasNext()) {
	...
	public static AgentSet removePatchFromList(List a, Patch p) {
		Predicate pr = NotPredicate.getInstance(EqualPredicate.getInstance(p));
		FilteredIterator result = new FilteredIterator(a.iterator(), pr);
		AgentSet b = new AgentSet();
		while (result.hasNext()) {
	...
	public static AgentSet removeTurtleFromList(List a, Turtle t) {
		Predicate pr = NotPredicate.getInstance(EqualPredicate.getInstance(t));
		FilteredIterator result = new FilteredIterator(a.iterator(), pr);
		AgentSet b = new AgentSet();
		while (result.hasNext()) {
	...
	/**
	 * Queries if a value is in a list.
	 * 
	 * @param value
	 *            an object
	 * @param list
	 *            a list
	 * @return true or false based on whether object value is in list list
	 */
	public static boolean memberQ(Object value, List list) {
	...
	/**
	 * Returns a random subset of a list of size number.
	 * 
	 * @param number
	 *            an integer
	 * @param a
	 *            a list
	 * @return random subset of list a of size number
	 */
	public static List nOf(int number, List a) {
		int size = a.size();
		if (size <= number) {
			return a;
		}
	 ...
	 */
	public static <X> X oneOf(List<X> a) {
		if (a.size() == 0) {
			return null;
		}
		int index = RandomHelper.nextIntFromTo(0, a.size() - 1);
		return a.get(index);
	}
	 ...
	 */
	public static ArrayList remove(Object item, List list) {
		Predicate pr = NotPredicate.getInstance(EqualPredicate
				.getInstance(item));
		FilteredIterator it = new FilteredIterator(list.iterator(), pr);
		ArrayList result = new ArrayList();
		while (it.hasNext()) {
			result.add(it.next());
		}
	...
	public static Object max(List list) {
		return Collections.max(list, new Comparator() {
			public int compare(Object o1, Object o2) {
	...
	public static Object min(List list) {
		return Collections.min(list, new Comparator() {
			public int compare(Object o1, Object o2) {
				if (!(o1 instanceof Number && o2 instanceof Number)) {
					return 0;
				}
	 ...
	 */
	public static double mean(List a) {
		if (a.size() == 0) {
			return 0;
		}
	 ...
	 * @param a
	 *            a list of numbers
	 * @return median of list a
	 */
	public static double median(List a) {
	 ...
	 */
	public static double standardDeviation(List a) {
	 ...
	 */
	public static double variance(List a) {
		double mean = mean(a);
		ArrayList<Double> temp = new ArrayList();
		for (Object o : a) {
			if (o instanceof Number) {
	 ...
	 * @return sum of a
	 */
	public static double sum(List a) {
		if (a.size() == 0) {
			return 0;
		}
		double sum = 0.0;
	...
	/**
	 * Returns the time since ?resetTimerÓ was last called.
	 * 
	 * @return time since ?resetTimerÓ was last called
	 */
	 ...
	 */
	public static int count(List a) {
		return a.size();
	}
	...
	public static boolean shadeOfQ(Number nColor1, Number nColor2) {
		...
		if (color2 >= minValue && color2 < minValue
