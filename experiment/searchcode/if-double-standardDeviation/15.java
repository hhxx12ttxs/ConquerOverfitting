 ...
 * <ul>
 *   <li>{@link org.jboss.drools.impl.TruncatedNormalDistributionTypeImpl#getMax <em>Max</em>}</li>
 *   <li>{@link org.jboss.drools.impl.TruncatedNormalDistributionTypeImpl#getMean <em>Mean</em>}</li>
 *   <li>{@link org.jboss.drools.impl.TruncatedNormalDistributionTypeImpl#getMin <em>Min</em>}</li>
 *   <li>{@link org.jboss.drools.impl.TruncatedNormalDistributionTypeImpl#getStandardDeviation <em>Standard Deviation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TruncatedNormalDistributionTypeImpl extends DistributionParameterImpl implements TruncatedNormalDistributionType {
	...
	protected EClass eStaticClass() {
		return DroolsPackage.Literals.TRUNCATED_NORMAL_DISTRIBUTION_TYPE;
	}
	...
	public void setMax(double newMax) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.TRUNCATED_NORMAL_DISTRIBUTION_TYPE__MAX, oldMax, max, !oldMaxESet));
	}
	...
	public void unsetMax() {
		...
		maxESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DroolsPackage.TRUNCATED_NORMAL_DISTRIBUTION_TYPE__MAX, oldMax, MAX_EDEFAULT, oldMaxESet));
	}
	...
	public void setMean(double newMean) {
		...
		meanESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.TRUNCATED_NORMAL_DISTRIBUTION_TYPE__MEAN, oldMean, mean, !oldMeanESet));
	}
	...
	public void unsetMean() {
		...
		meanESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DroolsPackage.TRUNCATED_NORMAL_DISTRIBUTION_TYPE__MEAN, oldMean, MEAN_EDEFAULT, oldMeanESet));
	}
	...
	public void setMin(double newMin) {
		...
		minESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.TRUNCATED_NORMAL_DISTRIBUTION_TYPE__MIN, oldMin, min, !oldMinESet));
	}
	...
	public void unsetMin() {
		...
		minESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DroolsPackage.TRUNCATED_NORMAL_DISTRIBUTION_TYPE__MIN, oldMin, MIN_EDEFAULT, oldMinESet));
	}
	...
	public void setStandardDeviation(double newStandardDeviation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.TRUNCATED_NORMAL_DISTRIBUTION_TYPE__STANDARD_DEVIATION, oldStandardDeviation, standardDeviation, !oldStandardDeviationESet));
	}
	...
	public void unsetStandardDeviation() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DroolsPackage.TRUNCATED_NORMAL_DISTRIBUTION_TYPE__STANDARD_DEVIATION, oldStandardDeviation, STANDARD_DEVIATION_EDEFAULT, oldStandardDeviationESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DroolsPackage.TRUNCATED_NORMAL_DISTRIBUTION_TYPE__MAX:
				return getMax();
			case DroolsPackage.TRUNCATED_NORMAL_DISTRIBUTION_TYPE__MEAN:
				return getMean();
			case DroolsPackage.TRUNCATED_NORMAL_DISTRIBUTION_TYPE__MIN:
				return getMin();
			case DroolsPackage.TRUNCATED_NORMAL_DISTRIBUTION_TYPE__STANDARD_DEVIATION:
