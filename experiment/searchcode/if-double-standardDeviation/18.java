 ...
 * <ul>
 *   <li>{@link org.jboss.drools.impl.LogNormalDistributionTypeImpl#getMean <em>Mean</em>}</li>
 *   <li>{@link org.jboss.drools.impl.LogNormalDistributionTypeImpl#getStandardDeviation <em>Standard Deviation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LogNormalDistributionTypeImpl extends DistributionParameterImpl implements LogNormalDistributionType {
	...
	protected EClass eStaticClass() {
		return DroolsPackage.Literals.LOG_NORMAL_DISTRIBUTION_TYPE;
	}
	...
	public void setMean(double newMean) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.LOG_NORMAL_DISTRIBUTION_TYPE__MEAN, oldMean, mean, !oldMeanESet));
	}
	...
	public void unsetMean() {
		...
		meanESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DroolsPackage.LOG_NORMAL_DISTRIBUTION_TYPE__MEAN, oldMean, MEAN_EDEFAULT, oldMeanESet));
	}
	...
	public void setStandardDeviation(double newStandardDeviation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.LOG_NORMAL_DISTRIBUTION_TYPE__STANDARD_DEVIATION, oldStandardDeviation, standardDeviation, !oldStandardDeviationESet));
	}
	...
	public void unsetStandardDeviation() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DroolsPackage.LOG_NORMAL_DISTRIBUTION_TYPE__STANDARD_DEVIATION, oldStandardDeviation, STANDARD_DEVIATION_EDEFAULT, oldStandardDeviationESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DroolsPackage.LOG_NORMAL_DISTRIBUTION_TYPE__MEAN:
				return getMean();
			case DroolsPackage.LOG_NORMAL_DISTRIBUTION_TYPE__STANDARD_DEVIATION:
