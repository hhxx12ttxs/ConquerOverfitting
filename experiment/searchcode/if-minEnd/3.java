...
public class CalendarModelImpl implements CalendarSelectionModel
{
    ...
    public CalendarModelConfiguration createConfiguration(ClassificationFilter[] allocatableFilter, ClassificationFilter[] eventFilter) throws RaplaException {
        ...
        return m_facade.newRaplaCalendarModel( m_facade.newRaplaMap(selected), allocatableFilter,eventFilter, title, getStartDate(), getEndDate(), getSelectedDate(), viewName, m_facade.newRaplaMap(optionMap));
    }
    ...
    private Collection getRestrictedReservations( Date start, Date end) throws RaplaException {
        ...
        Reservation[] reservations =m_facade.getReservations((User) null, start, end,reservationFilter2 );
