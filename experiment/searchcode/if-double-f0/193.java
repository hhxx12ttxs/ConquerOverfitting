...
public class SpringForceBending implements Force
{
     ...
     */
    SpringForceBending(Particle p0, Particle p1, Particle p2, double stiffness, ParticleSystem PS)
    {
	...
	public String outputToText () {
		return String.format("SpringForceBending %d %d %d %f", p0.id, p1.id, p2.id, stiffness);
	}
}
