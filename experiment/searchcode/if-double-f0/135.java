...
import sirentropy.weaponry.resources.WResourceManager;
...
final class CannonFlameFX extends EntityFX {
	...
	public void renderParticle(Tessellator par1Tessellator, float f, float f1, float f2, float f3, float f4, float f5) {
		...
		GL11.glBindTexture(3553 /* GL_TEXTURE_2D */, ModLoader.getMinecraftInstance().renderEngine.getTexture(WResourceManager.PARTICLES));
