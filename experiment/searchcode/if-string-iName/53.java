...
public class RoboRally<Board, Robot, Wall, Battery, RepairKit, SurpriseBox> extends JFrame {
	...
	private static final long BOARD_WIDTH = 300;
	private static final long BOARD_HEIGHT = 300;
	...
	public static void main(String[] args) {
		...
		/* <begin> */
		RoboRally<roborally.position.Board, roborally.entity.Robot, roborally.entity.Wall, roborally.entity.item.Battery, roborally.entity.item.RepairKit, roborally.entity.item.SurpriseBox> roboRally 
			= new RoboRally<roborally.position.Board, roborally.entity.Robot, roborally.entity.Wall, roborally.entity.item.Battery, roborally.entity.item.RepairKit, roborally.entity.item.SurpriseBox>(new roborally.Facade());
		/* <end> */
