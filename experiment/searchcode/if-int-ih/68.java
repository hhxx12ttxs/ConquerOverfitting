...
public class ImageScale {
    ...
    public  void compressSave(File inFile,OutputStream outFile,int maxWidth,int maxHeight,String type) throws Exception{
        BufferedImage image1 = ImageIO.read(inFile);
        if(image1.getWidth() <= maxWidth && image1.getHeight() <= maxHeight){
        	ImageIO.write(image1, type, outFile);
        	return ;
        }        	
        BufferedImage image2 = this.imageZoomOut(image1, maxWidth, maxHeight, true);
        ImageIO.write(image2, type, outFile);
    }

    public static void main(String[] args) throws IOException {
        ImageScale is = new ImageScale();
        String path = "E://";
        BufferedImage image1 = ImageIO.read(new File(path + "004.jpg"));
        int w = 60, h = 60;
        BufferedImage image2 = is.imageZoomOut(image1, w, h, true);
        FileOutputStream out = new FileOutputStream(path + "004_2.jpg");
