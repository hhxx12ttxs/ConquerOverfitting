...
public class MapsActivityv2 extends FragmentActivity {
	...
	public class GetDataTask extends AsyncTask<Void, Void, Boolean> {
		...
		protected Boolean doInBackground(Void... params) {
			...
			// new JSONObject(
			// "{\"pic\": \"https://developers.google.com/maps/documentation/android/images/marker-infowindows.png\",\"title\": \"ilk baslik\",  \"body\": \"ilk iรงerik\", \"user\": \"salim\",  \"_id\": \"50ecbf19131a73e01e000002\", \"__v\": 0,  \"createdAt\": \"2013-01-09T00:51:37.669Z\",  \"loc\": [ 41.2565, 29.23554 ]}"));
			// records.add(rec);
			// } catch (Exception e) {
			// e.printStackTrace();
			// }
