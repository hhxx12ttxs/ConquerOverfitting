...
{
	public float x0Zoom, y0Zoom, widthZoom, heightZoom, parentX0Zoom, parentY0Zoom;
	...
	public void image(PImage img, float a, float b, float c, float d) {
		Main.main.image(img,  s(a),  s(b), s(c), s(d));
	}
	...
	public PGraphics createGraphics(float a, float b) {
		return  Main.main.createGraphics((int) s(a), (int) s(b),null);
	}
	...
	public PImage loadImage(String imagePath)
	{
		...
		return Main.main.loadImage(imagePath);
	}
