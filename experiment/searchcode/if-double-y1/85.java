...
public class Line2d extends Shape {
    ...
    public void render(Matrix transformation, Camera camera, Renderer renderer) {
        // Einbeziehen der Transformationsgruppen. Um Animationen zu ber체cksichtigen, die auf die einzelnen Felder zugegriffen haben, werden die start und end Vektoren aktualisiert, bevor sie mit der Transformationsmatrix multipliziert werden.
        start = new Vector3d(x1, y1, -1).transform(transformation);
        end = new Vector3d(x2, y2, -1).transform(transformation);


        // Start- und Endpunkt der Linie in Pixeln, mit denen die Linienalgorithmen durchgef체hrt werden.
         ...
         * TODO Eine Verbesserung hier w채re der Bresenhamalgorithmus.
         */
