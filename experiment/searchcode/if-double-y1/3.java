...
public class ExtrasTerrain extends TerrainMethods {
    ...
    @Override
    public void generateFromArrayList(ArrayList<Location> ArrayList, Material m, Byte data) {
    ...
    @Override
    public void replaceBlocks(Material toReplace, Byte toReplaceData, Material replaceWith, Byte replaceWithData,
            Location point1, Location point2) {
        double x1 = point1.getX(), x2 = point2.getX(), y1 = point1.getY(), y2 = point2.getY(), z1 = point1.getZ(), z2 = point2
                .getZ(), tmp = 0;
                ...
                for (double zz = z1 - (z1 - z2); zz <= z1; zz++) {
                    ...
                    if (toReplaceData != null) {
                        if (w.getBlockAt(construct).getType() == toReplace
                                && w.getBlockAt(construct).getData() == toReplaceData) {
    ...
    @Override
    public void replaceBlocks(int toReplace, Byte toReplaceData, int replaceWith, Byte replaceWithData,
            Location point1, Location point2) {
        double x1 = point1.getX(), x2 = point2.getX(), y1 = point1.getY(), y2 = point2.getY(), z1 = point1.getZ(), z2 = point2
                .getZ(), tmp = 0;
