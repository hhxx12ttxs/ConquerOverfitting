...
public class CustomDateTimePickerForReport implements OnClickListener{
...
//	private int selectedHour, selectedMinute;
	...
	public CustomDateTimePickerForReport(Activity a,
	        ICustomDateTimeListener customDateTimeListener) {
	    activity = a;
	    iCustomDateTimeListener = customDateTimeListener;

	    dialog = new Dialog(a.getParent());
...
//	    datePicker.init( 10, 10, 10, new OnDateChangedListener(){
//
//        @Override
//        public void onDateChanged(DatePicker view, int year, int monthOfYear, int dayOfMonth)
//        {
//            if (year < 2010)
//                view.updateDate(2010, 11, 10);
////
...
//	        timePicker.setCurrentMinute(selectedMinute);
	...
	public interface ICustomDateTimeListener {
	    public void onSet(Dialog dialog, Calendar calendarSelected,
	            ...
	            String weekDayFullName, String weekDayShortName,int hours);
...
//	private Date getTimeSpans(Date date){
...
//	}
	...
	@SuppressLint("NewApi")
	public void settingMinDate(long second){
		datePicker.setMinDate(second - 1000);
	}
	@SuppressLint("NewApi")
	public void settingMaxDate(long second){
		datePicker.setMaxDate(second - 1000);
	}
