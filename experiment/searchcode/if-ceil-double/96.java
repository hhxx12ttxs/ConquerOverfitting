    ...
    */
    ...
    private static Object evaluate(Node n)
    {
        if (n.hasOperator() && n.hasChild())
        {
            ...
            {
                n.setValue(evaluateExpression1(n.getOperator(),
                        evaluate(n.getLeft())));
            }
            else if (n.getOperator().getType() == 2)
            {
                n.setValue(evaluateExpression2(n.getOperator(),
    ...
    private static Object evaluateExpression1(Operator o, Object o1)
    {
        ...
        if (o1isMatrix)
        {
            ...
            if ("t".equals(op))
            {
                res = (Object) (f1.transpose());
            }
            else if ("inv".equals(op))
            {
                res = (Object) (f1.inverse());
            }
            else if ("diag".equals(op))
            {
                res = (Object) (f1.diag());
            }
            else if ("det".equals(op))
            {
                res = (Object) (new Double((double) (f1.det())));
            }
            else if ("trace".equals(op))
            {
                res = (Object) (new Double((double) (f1.trace())));
            }
            else if ("rank".equals(op))
            {
                res = (Object) (new Double((double) (f1.rank())));
            }
            else if ("sum".equals(op))
            {
                res = (Object) (f1.sum());
            }
            else if ("prod".equals(op))
            {
                res = (Object) (f1.prod());
            }
            ...
            else if ("mean".equals(op))
            {
                res = (Object) (((RandomMatrix) (f1)).mean());
            }
            else if ("cov".equals(op))
            {
                res = (Object) (((RandomMatrix) (f1)).cov());
            }
            else if ("var".equals(op))
            {
                res = (Object) (((RandomMatrix) (f1)).var());
            }
            else if ("cor".equals(op))
            {
                res = (Object) (((RandomMatrix) (f1)).cor());
            }
        }
        else
        {
            ...
            if ("cos".equals(op))
            {
                res = (Object) (new Double(Math.cos(f1)));
            }
            else if ("sin".equals(op))
            {
                res = (Object) (new Double(Math.sin(f1)));
            }
            else if ("tan".equals(op))
            {
                res = (Object) (new Double(Math.tan(f1)));
            }
            else if ("acos".equals(op))
            {
                res = (Object) (new Double(Math.acos(f1)));
            }
            else if ("asin".equals(op))
            {
                res = (Object) (new Double(Math.asin(f1)));
            }
            else if ("atan".equals(op))
            {
                res = (Object) (new Double(Math.atan(f1)));
            }
            else if ("sqrt".equals(op))
            {
                res = (Object) (new Double(Math.sqrt(f1)));
            }
            else if ("log".equals(op))
            {
                res = (Object) (new Double(Math.log(f1)));
            }
            else if ("exp".equals(op))
            {
                res = (Object) (new Double(Math.exp(f1)));
            }
            else if ("floor".equals(op))
            {
                res = (Object) (new Double(Math.floor(f1)));
            }
            else if ("ceil".equals(op))
            {
                res = (Object) (new Double(Math.ceil(f1)));
            }
            else if ("abs".equals(op))
            {
                res = (Object) (new Double(Math.abs(f1)));
            }
        }
    ...
    private static Object evaluateExpression2(Operator o, Object o1, Object o2)
    {
        ...
        if (o1isMatrix)
        {
            ...
            if (o2isMatrix)
            {
                ...
                if ("+".equals(op))
                {
                    res = (Object) (f1.plus(f2));
                }
                else if ("-".equals(op))
                {
                    res = (Object) (f1.minus(f2));
                }
                else if ("*".equals(op))
                {
                    res = (Object) (f1.times(f2));
                }
                else if ("/".equals(op))
                {
                    res = (Object) (f1.divide(f2));
                }
            }
            else
            {
                ...
                {
                    res = (Object) (f1.sort(Math.round((float) f2)));
                }
                else if ("find".equals(op))
                {
                    res = (Object) (f1.find(f2));
                }
            }
        }
        else
        {
            ...
            else
            {
                ...
                {
                    res = (Object) (new Double(Math.pow(f1, f2)));
                }
                else if ("%".equals(op))
                {
                    res = (Object) (new Double(f1 % f2));
                ...
                {
                    res = (Object) (new Double(Math.min(f1, f2)));
                }
                else if ("max".equals(op))
                {
                    res = (Object) (new Double(Math.max(f1, f2)));
                }
                else if ("&".equals(op))
                {
                    res = (Object) (new Double(
                                ((f1 > 0) && (f2 > 0)) ? (1) : (0)));
                }
                else if ("|".equals(op))
                {
                ...
                {
                    res = (Object) (new Double((f1 < f2) ? (1) : (0)));
                }
                else if (">".equals(op))
                {
                    res = (Object) (new Double((f1 > f2) ? (1) : (0)));
        ...
        private void init(Node parent, String s, int level) throws Exception
        {
            ...
            if (nOperator != null)
            {
                ...
                if ((startOperator == 0) && (nOperator.getType() == 1))
                {
                    ...
                    if (checkBrackets(
                                s.substring(nOperator.getOperator().length())) ==
                            0)
                    {
                        nLeft = new Node(this,
                                s.substring(nOperator.getOperator().length()),
