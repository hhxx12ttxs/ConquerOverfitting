...
public class AWTEventMulticaster implements 
    ...
    {
        if(ev.a != null && ev.a instanceof AWTEventMulticaster)
        {
            count += count((AWTEventMulticaster)ev.a, count);
        }
        else
        if(ev.a != null)
            count ++;
        if(ev.b != null && ev.b instanceof AWTEventMulticaster)
        {
            count += count((AWTEventMulticaster)ev.b, count );
        }
        else
        if(ev.b != null)
            count++;
