...
public class NumberRangeMeta extends BaseStepMeta implements StepMetaInterface
{
	...
	public NumberRangeMeta(Node stepnode, List<DatabaseMeta> databases, Map<String, Counter> counters) throws KettleXMLException
	{
		loadXML(stepnode, databases, counters);
	}

	public NumberRangeMeta(Repository rep, ObjectId id_step, List<DatabaseMeta> databases, Map<String, Counter> counters) throws KettleException
	{
