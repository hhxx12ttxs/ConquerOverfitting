 ...
 * </div>
 */
public abstract class SerenityAdapterView<T extends Adapter> extends ViewGroup {
	...
	public SerenityAdapterView(Context context) {
		super(context);
	}

	public SerenityAdapterView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public SerenityAdapterView(Context context, AttributeSet attrs, int defStyle) {
	...
	public interface OnItemSelectedListener {
		 ...
		 */
		void onNothingSelected(SerenityAdapterView<?> parent);
	}
	...
	class AdapterDataSetObserver extends DataSetObserver {
		...
		public void onChanged() {
			...
			if (SerenityAdapterView.this.getAdapter().hasStableIds()
					&& mInstanceState != null && mOldItemCount == 0
					&& mItemCount > 0) {
				SerenityAdapterView.this.onRestoreInstanceState(mInstanceState);
				mInstanceState = null;
			} else {
				rememberSyncState();
			}
		...
		public void onInvalidated() {
			...
			if (SerenityAdapterView.this.getAdapter().hasStableIds()) {
				...
				mInstanceState = SerenityAdapterView.this.onSaveInstanceState();
			}
