 ...
 *           $Id: GL11.java 3412 2010-09-26 23:43:24Z spasi $
 */
public final class GL11 {
	...
	public static void glColorPointer(int size, int stride, DoubleBuffer pointer) {
		...
		if ( LWJGLUtil.CHECKS ) GLChecks.getReferences(caps).GL11_glColorPointer_pointer = pointer;
	...
	public static void glEdgeFlagPointer(int stride, ByteBuffer pointer) {
		...
		GLChecks.ensureArrayVBOdisabled(caps);
		BufferChecks.checkDirect(pointer);
		if ( LWJGLUtil.CHECKS ) GLChecks.getReferences(caps).GL11_glEdgeFlagPointer_pointer = pointer;
	...
	public static void glNormalPointer(int stride, ByteBuffer pointer) {
		...
		GLChecks.ensureArrayVBOdisabled(caps);
		BufferChecks.checkDirect(pointer);
		if ( LWJGLUtil.CHECKS ) GLChecks.getReferences(caps).GL11_glNormalPointer_pointer = pointer;
	...
	public static void glVertexPointer(int size, int stride, DoubleBuffer pointer) {
		...
		GLChecks.ensureArrayVBOdisabled(caps);
		BufferChecks.checkDirect(pointer);
		if ( LWJGLUtil.CHECKS ) GLChecks.getReferences(caps).GL11_glVertexPointer_pointer = pointer;
	...
	public static void glTexCoordPointer(int size, int stride, DoubleBuffer pointer) {
		...
		GLChecks.ensureArrayVBOdisabled(caps);
		BufferChecks.checkDirect(pointer);
		if ( LWJGLUtil.CHECKS ) GLChecks.getReferences(caps).glTexCoordPointer_buffer[GLChecks.getReferences(caps).glClientActiveTexture] = pointer;
