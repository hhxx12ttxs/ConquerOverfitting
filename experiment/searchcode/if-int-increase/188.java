 ...
 * 
 */
public class ModuloCounter extends StepwiseAdjustable implements
	Comparable<ModuloCounter> {
    ...
    // used by CounterIncreaseSet.apply()
    public void increaseValue(int increase) {
	setValue(value + increase);	
    }
    
    // todo: only fire if modulo value has changed
