...
public class JsonLoadTestCase extends TestCase {

    private static final Logger logger = LoggerFactory.getLogger(JsonLoadTestCase.class);
    ...
    public JsonLoadTestCase(String name) throws Exception {
        super(name);
    ...
    public void testStreaming() throws Exception {
        ...
        untyped = mapper.readValue(is, HashMap.class);
    ...
    public void testMerging() throws Exception {
        ...
        untyped = mapper.readValue(response.getEntity().getContent(), HashMap.class);
        List<Map> results = (List<Map>) untyped.get("merged");
        Assert.assertEquals(3, results.size());
