...
public abstract class Type extends Node {
	...
	public static boolean SameIgnoreArray(Type t1, Type t2) {
		if (t1 instanceof PrimitiveType) {
			if (t2 instanceof PrimitiveType) {
				...
				switch (p1.primitive) {
				case Int:
					return p2.primitive == Primitive.Int
							|| p2.primitive == Primitive.IntArr;
				case IntArr:
					return p2.primitive == Primitive.Int
							|| p2.primitive == Primitive.IntArr;

				case Long:
					return p2.primitive == Primitive.Long
							|| p2.primitive == Primitive.LongArr
							|| p2.primitive == Primitive.Int
							|| p2.primitive == Primitive.IntArr;
				case LongArr:
					return p2.primitive == Primitive.Long
							|| p2.primitive == Primitive.LongArr
	...
	public static boolean Assignable(Type t1, Type t2) {
		if (t1 instanceof PrimitiveType || t2 instanceof PrimitiveType) {
			if (t1.IsType(Primitive.Long) && t2.IsType(Primitive.Int))
				return true;
			return Same(t1, t2);
		}
	...
	public static boolean IsPrimative(Type type) {
		if (type.IsType(Primitive.Boolean) || type.IsType(Primitive.Int)
				|| type.IsType(Primitive.Long) || type.IsType(Primitive.IntArr)
				|| type.IsType(Primitive.LongArr))
			return true;
		return false;
	}

	public boolean IsDoubleWordInnerType() {
		return this.IsType(Primitive.LongArr);
	}
