 ...
 * 
 */
public class JobMeta extends ChangedFlag implements Cloneable, Comparable<JobMeta>, XMLInterface, UndoInterface, HasDatabasesInterface, VariableSpace, EngineMetaInterface, ResourceExportInterface, HasSlaveServersInterface, NamedParams,
				...
				if (exist == null) {
					...
					if (!exist.isShared()) // skip shared connections
					{
						...
						if (askOverwrite && prompter != null) {
							overwrite = prompter.overwritePrompt(BaseMessages.getString(PKG, "JobMeta.Dialog.ConnectionExistsOverWrite.Message", dbcon.getName()),
								BaseMessages.getString(PKG, "JobMeta.Dialog.ConnectionExistsOverWrite.DontShowAnyMoreMessage"), Props.STRING_ASK_ABOUT_REPLACING_DATABASES);
						}
