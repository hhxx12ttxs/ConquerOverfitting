...
/**
 * MuPlusLambdaBreeder is a subclass of MuCommaLambdaBreeder which, together
 * with ESSelection, implements the (mu + lambda) breeding strategy and gathers
 ...
 * values in the second generation and keep them at that size thereafter. See
 * MuCommaLambdaBreeder for information about how to set mu and lambda.
 * 
 * @author Sean Luke
 * @version 1.0
 */
