...
public class ExperimentalAI extends SimpleAI // NO_UCD
{
    ...
    {
        LOGGER.finest("This is ExperimentalAI (really " +
                this.getClass().getName() +
                " ) and I'm asked for my battle move at turn "+
                client.getBattleCS().getBattleTurnNumber() +
                " and I am the " +
                (client.getMyEngagedLegion().equals(client.getDefender()) ?
                    "Defender" : "Attacker"));
    ...
    protected List<TacticalObjective> listObjectives = null;

    protected void showObjectives(String prefix) {
        ...
        for (TacticalObjective to : listObjectives)
        {
            buf.append("\t" + prefix + " objective: " + to.getDescription() + "\n");
        }
