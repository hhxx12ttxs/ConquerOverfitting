...
*******************************************************************************/
	...
	public static Chromo makeChromo() {
	
		switch(Parameters.encodingType)
		{
			case 0: return new BinaryChromo();
			case 1: return new GrayCodeChromo();
			case 2: return new FloatChromo();
			case 3: return new DynamicChromo();
					
			default:
				System.out.println("Invalud Encoding Type Specified, defaulting to Chromo");
				return new Chromo();
...
*******************************************************************************/
	...
	public double getGeneValue(int geneID) {
		return (double) getIntGeneValue(geneID);
	}
...
//		if(parent1 instanceof FloatChromo)
//		{
//			FloatChromo.mateParents(pnum1, pnum2, parent1, parent2, child1, child2);
//			return;
//		}
...
//		if(parent instanceof FloatChromo)
//		{
//			FloatChromo.mateParents(pnum, parent, child);
//			return;
//		}
//		
		//  Create child chromosome from parental material
...
//		if(targetA instanceof FloatChromo)
//		{
//			FloatChromo.copyB2A(targetA, sourceB);
//			return;
//		}
