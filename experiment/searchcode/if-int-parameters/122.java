...
/**
 * GPInitializer is a SimpleInitializer which sets up all the Cliques, ( the
 * initial [tree/node]constraints, types, and function sets) for the GP system.
 * 
 * <p>
 ...
 * <ol>
 * <li>GPType</li>
 * <li>GPNodeConstraints</li>
 * <li>GPFunctionSets</li>
 * <li>GPTreeConstraints</li>
 * </ol>
 * 
 * <p>
 ...
 * <table>
 * <tr>
 * <td valign=top><tt>gp.type</tt></td>
 * <td>GPTypes</td>
 * </tr>
 * <tr>
 * <td valign=top><tt>gp.nc</tt></td>
 * <td>GPNodeConstraints</td>
 * </tr>
 * <tr>
 * <td valign=top><tt>gp.tc</tt></td>
 * <td>GPTreeConstraints</td>
 * </tr>
 * <tr>
 * <td valign=top><tt>gp.fs</tt></td>
 * <td>GPFunctionSets</td>
 * </tr>
 * 
 * </table>
 * 
...
public class GPInitializer extends SimpleInitializer {
    ...
    /**
     * TODO Comment these members. TODO Make clients of these members more
     * efficient by reducing unnecessary casting.
     */
    ...
    public void setup(final EvolutionState state, final Parameter base) {
        ...
        // will break.
        setupNodeConstraints(state, GPDefaults.base().push(P_NODECONSTRAINTS));
        setupFunctionSets(state, GPDefaults.base().push(P_FUNCTIONSETS));
        setupTreeConstraints(state, GPDefaults.base().push(P_TREECONSTRAINTS));
    }

    /**
     * Sets up all the types, loading them from the parameter file. This must be
     * called before anything is called which refers to a type by name.
     */
     ...
     * arrays for set types. If you add new types (heaven forbid), you should
     * call this method again to get all the types set up properly. However, you
     * will have to set up the function sets again as well, as their arrays are
     * based on these type numbers.
     */
    ...
    public void setupNodeConstraints(final EvolutionState state, final Parameter base) {
        ...
        for (int y = 0; y < x; y++) {
            ...
            if (state.parameters.exists(base.push("" + y), null))
                c = (GPNodeConstraints) (state.parameters.getInstanceForParameterEq(base.push("" + y), null,
                        GPNodeConstraints.class));
            else {
                state.output
                        .message("No GP Node Constraints specified, assuming the default class: ec.gp.GPNodeConstraints for "
                                + base.push("" + y));
    ...
    public void setupFunctionSets(final EvolutionState state, final Parameter base) {
        ...
        for (int y = 0; y < x; y++) {
            ...
            if (state.parameters.exists(base.push("" + y), null))
                c = (GPFunctionSet) (state.parameters.getInstanceForParameterEq(base.push("" + y), null,
                        GPFunctionSet.class));
            else {
                state.output.message("No GPFunctionSet specified, assuming the default class: ec.gp.GPFunctionSet for "
                        + base.push("" + y));
                c = new GPFunctionSet();
            }
            c.setup(state, base.push("" + y));
    ...
    public void setupTreeConstraints(final EvolutionState state, final Parameter base) {
        ...
        for (int y = 0; y < x; y++) {
            ...
            // Figure the constraint class
            if (state.parameters.exists(base.push("" + y), null))
                c = (GPTreeConstraints) (state.parameters.getInstanceForParameterEq(base.push("" + y), null,
                        GPTreeConstraints.class));
            else {
                state.output
                        .message("No GP Tree Constraints specified, assuming the default class: ec.gp.GPTreeConstraints for "
                                + base.push("" + y));
