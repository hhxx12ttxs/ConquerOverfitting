 ...
 * 
 * <p>
 * Mutated trees are restricted to being <tt>maxdepth</tt> depth at most. If in
 * <tt>tries</tt> attemptes, the pipeline cannot come up with a mutated tree
 * within the depth limit, then it simply copies the original individual
 ...
 * while RandomBranch will replace it with a tree of the same size or
 * "slightly smaller" as described in the algorithm.
 * 
 * <p>
