...
public class GetSnapshot extends JDialog implements FocusListener, KeyListener
{
    JPanel panel1 = new JPanel();
    JLabel jLabel1 = new JLabel();
    JTextField jTextSubName = new JTextField();
    JButton jButtonGetSNapshot = new JButton();
    ...
    public GetSnapshot(Frame frame, String title, boolean modal)
    {
    ...
    public GetSnapshot(Frame frame, String title, boolean modal, boolean able0)
    {
        super(frame, title, modal);
        able = able0;
        try
    ...
    /*
      public GetSnapshot(_ReplicationServer repServer0) {
        this(null, "SnapShot", true);
        repServer = repServer0;
      }

      public GetSnapshot(_ReplicationServer repServer0, String subName0) {
        this(null, "SnapShot", true);
        repServer = repServer0;
        subName = subName0;
        init();
     ...
     */
    public GetSnapshot(_ReplicationServer repServer0, boolean able0,String snapShotType0)
    {
        this(StartRepServer.getMainFrame(), "SnapShot", true, able0);
        repServer = repServer0;
        able = able0;
    ...
    public GetSnapshot(_ReplicationServer repServer0, String subName0,
                       boolean able0,String snapShotType0)
    {
        this(null, "SnapShot", true, able0);
        repServer = repServer0;
        subName = subName0;
        able = able0;
        snapShotType=snapShotType0;
    ...
    private void init()
    {
        try
        {
            ...
            {
                jButtonGetSNapshot.setEnabled(true);
            }
        }
...
//      ex.printStackTrace();
    ...
    private void jbInit() throws Exception
    {
        ...
        jButtonGetSNapshot.setBounds(new Rectangle(106, 229, 131, 25));
        jButtonGetSNapshot.setEnabled(false);
        jButtonGetSNapshot.setFont(new java.awt.Font("Dialog", 1, 12));
        jButtonGetSNapshot.setHorizontalAlignment(SwingConstants.CENTER);
        jButtonGetSNapshot.setText("Get Snapshot");
        jButtonGetSNapshot.addActionListener(new
                                             GetSnapshot_jButtonGetSNapshot_actionAdapter(this));
        ...
        jButtonCancle.addActionListener(new GetSnapshot_jButtonCancle_actionAdapter(this));
        jLabel2.setEnabled(true);
        jLabel2.setFont(new java.awt.Font("Serif", 3, 25));
        jLabel2.setText("Snapshot");
        jLabel2.setBounds(new Rectangle(135, 2, 118, 36));
        ...
        help.setText(
            "Will transfer a complete copy of the contents of a Publishers publication " +
            "to a Subscribers subscription.");
        ...
        panel1.add(jButtonGetSNapshot, null);
    ...
    void jButtonGetSNapshot_actionPerformed(ActionEvent e)
    {
        try
        {
            ...
            if (snapShotType.equalsIgnoreCase(snapShotAfterSubscribing)){
              sub.getSnapShot();
            }
            if (snapShotType.equalsIgnoreCase(snapShotAfterUpdating)){
              sub.getSnapShotAfterUpdatingSubscriber();
            }
    ...
    public void keyReleased(KeyEvent keyEvent)
    {
        ...
        else
        {
            ...
            {
                jButtonGetSNapshot_actionPerformed(null);
            }
        }
...
class GetSnapshot_jButtonCancle_actionAdapter implements java.awt.event.ActionListener
{
    GetSnapshot adaptee;

    GetSnapshot_jButtonCancle_actionAdapter(GetSnapshot adaptee)
    {
...
class GetSnapshot_jButtonGetSNapshot_actionAdapter implements java.awt.event.ActionListener
{
    GetSnapshot adaptee;

    GetSnapshot_jButtonGetSNapshot_actionAdapter(GetSnapshot adaptee)
    {
        this.adaptee = adaptee;
    }
    ...
    public void actionPerformed(ActionEvent e)
    {
        adaptee.jButtonGetSNapshot_actionPerformed(e);
    }
}
