...
public class Buffer {
	...
	public void fb(int arg0, byte arg1[]) throws IOException {
		writeTo(arg0, 0, arg1);
	}

	public int pb(byte arg0[]) {
		try {
			ne++;
			if (oe > 0 && ne > oe) {
				wd = true;
	...
	public void nb(int arg0, int arg1) {
		buffer[pe + arg1] = (byte) (arg0 >> 8);
		buffer[pe + arg1 + 1] = (byte) arg0;
	}
