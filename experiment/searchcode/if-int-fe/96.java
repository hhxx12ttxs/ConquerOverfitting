...
//		System.loadLibrary( "rxtxSerial" );
	...
	*/
	...
	/** File descriptor - a native stub, directly accessed by native code */
	private int fd = 0;

	/**
	 * Get the serial port's native-level code file descriptor.
	 *
	 * @return the serial port's file descriptor
 	 */
	protected final int getFileDescriptor() {
		return fd;
	}
	...
	*/
	long eis = 0;
	/** pid for lock files - a native stub */
	int pid = 0;
	...
	*/
	...
	/** Line speed in bits-per-second - a native stub */
	...
	*/
	...
	/** Data bits port parameter - a native stub */
	...
	*/
	...
	/** Stop bits port parameter - a native stub */
	...
	*/
	...
	/** Parity port parameter - a native stub */
	...
	*/
	...
	protected final void addIOLock() {
		synchronized (IOLockedMutex) {
			IOLocked++;
		}
	}
	protected final void removeIOLock() {
		synchronized (IOLockedMutex) {
			IOLocked--;
		}
	}
