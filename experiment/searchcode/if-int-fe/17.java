...
public class Synchronize extends JDialog implements FocusListener, KeyListener
{
    JPanel panel1 = new JPanel();
    JLabel jLabel1 = new JLabel();
    JTextField jTextSubName = new JTextField();
    JButton jButtonSynchronize = new JButton();
    ...
    public Synchronize(Frame frame, String title, boolean modal, boolean able0)
    {
...
//  public Synchronize(_ReplicationServer repServer0) {
//     this(null, "Synchronize", true);
//     repServer = repServer0;
//  }
//
//  public Synchronize(_ReplicationServer repServer0,String subName0) {
//     this(null, "Synchronize", true);
//     repServer = repServer0;
//     subName = subName0;
//     init();
//  }
    ...
    public Synchronize(_ReplicationServer repServer0, boolean able0)
    {
        this(StartRepServer.getMainFrame(), "Synchronize", true, able0);
        repServer = repServer0;
        able = able0;
    }
    ...
    public Synchronize(_ReplicationServer repServer0, String subName0,
                       boolean able0)
    {
        this(null, "Synchronize", true, able0);
        repServer = repServer0;
        subName = subName0;
        able = able0;
        init();
    ...
    private void init()
    {
        try
        {
            ...
            {
                jButtonSynchronize.setEnabled(true);
            }
        }
...
//      ex.printStackTrace();
    ...
    private void jbInit() throws Exception
    {
        ...
        jButtonSynchronize.setBounds(new Rectangle(111, 211, 116, 25));
        jButtonSynchronize.setEnabled(false);
        jButtonSynchronize.setFont(new java.awt.Font("Dialog", 1, 12));
        jButtonSynchronize.setText("Synchronize");
        jButtonSynchronize.addActionListener(new
                                             Synchronize_jButtonSynchronize_actionAdapter(this));
        ...
        jButtonCancle.addActionListener(new Synchronize_jButtonCancle_actionAdapter(this));
        ...
        jLabel2.setText("Synchronize");
        jLabel2.setBounds(new Rectangle(113, 12, 167, 27));
        ...
        help.setText(
            " The changes made to the data by both Publisher and  Subscriber  " +
            "will be merged");
        ...
        panel1.add(jButtonSynchronize, null);
    ...
    void jButtonSynchronize_actionPerformed(ActionEvent e)
    {
        try
        {
            ...
            if (sub == null)
            {
                throw new RepException("REP059", new Object[]
                                       {subName});
            }
            sub.setRemoteServerPortNo(remoteRepPortNo);
            sub.setRemoteServerUrl(remoteServerName);
            sub.synchronize();
            JOptionPane.showMessageDialog(this, "Synchronized Successfully",
    ...
    public void keyReleased(KeyEvent keyEvent)
    {
        ...
        else
        {
            ...
            {
                jButtonSynchronize_actionPerformed(null);
            }
        }
...
class Synchronize_jButtonCancle_actionAdapter implements java.awt.event.ActionListener
{
    Synchronize adaptee;

    Synchronize_jButtonCancle_actionAdapter(Synchronize adaptee)
    {
...
class Synchronize_jButtonSynchronize_actionAdapter implements java.awt.event.ActionListener
{
    Synchronize adaptee;

    Synchronize_jButtonSynchronize_actionAdapter(Synchronize adaptee)
    {
        this.adaptee = adaptee;
    }
    ...
    public void actionPerformed(ActionEvent e)
    {
        adaptee.jButtonSynchronize_actionPerformed(e);
    }
}
