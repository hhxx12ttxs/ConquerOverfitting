...
public class Push extends JDialog implements FocusListener, KeyListener
{
    ...
    public Push(_ReplicationServer repServer0, String subName0,
                       boolean able0)
    {
...
//      ex.printStackTrace();
    ...
    private void jbInit() throws Exception
    {
        ...
        help.setText(
            " The changes made to the data by Publisher" +
            "will be uploaded to Subscriber");
    ...
    void jButtonPush_actionPerformed(ActionEvent e)
    {
        try
        {
            ...
            if (sub == null)
            {
                throw new RepException("REP0107", new Object[]
                                       {subName});
            }
            sub.setRemoteServerPortNo(remoteRepPortNo);
            sub.setRemoteServerUrl(remoteServerName);
            sub.push();
            JOptionPane.showMessageDialog(this, "Pushed Successfully",
