...
public abstract class Fields {
    ...
    public static long parseLong(String s, long defaultValue) {
        try {
            ...
            logger.log(Level.SEVERE, "Failed to parse value as long: "+s+" : "+e, e);
            return defaultValue;
        }
    }
    ...
    public static int parseInt(String s, int defaultValue) {
        try {
            ...
            logger.log(Level.SEVERE, "Failed to parse value as int: "+s+" : "+e, e);
            return defaultValue;
        }
    }
    ...
    public static long parseShort(String s, short defaultValue) {
        try {
            ...
            logger.log(Level.SEVERE, "Failed to parse value as short: "+s+" : "+e, e);
            return defaultValue;
        }
    }
