...
public class xycut {
    ...
    public static Vector<rectangle> segment(BufferedImage binarizedImage) {
        ...
        imageHelpers.writeImage( binarizedImage,"/usr/debugImages/inner"+ System.currentTimeMillis()+".jpg");
