...
import org.goda.calendar.TimeZoneList;
...
public class DefaultNameProvider implements NameProvider {
    ...
    private Map<Locale, Map<String, Map<String, String[]>>> iByLocaleCache = new HashMap<Locale, Map<String, Map<String, String[]>>>(7);
    ...
    private synchronized String[] getNameSet(Locale locale, String id, String nameKey) {
        ...
        Map<String, Map<String, String[]>> byIdCache = iByLocaleCache.get(locale);
        if (byIdCache == null) {
            iByLocaleCache.put(locale, byIdCache = new HashMap<String, Map<String, String[]>>(7));
        }

        Map<String, String[]> byNameKeyCache = byIdCache.get(id);
        if (byNameKeyCache == null) {
            byIdCache.put(id, byNameKeyCache = new HashMap<String, String[]>(7));
            //TODO Fix this!
