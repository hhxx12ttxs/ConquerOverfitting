...
public abstract class GuiContainer extends GuiScreen
{
    ...
    protected void handleMouseClick(Slot par1Slot, int par2, int par3, boolean par4)
    {
        ...
        if(par2==0 && par1Slot!=null && par1Slot.getClass()!=Slot.class) infinite = ZMod.craftingHandle();
        par4 &= infinite == 1;
        while(   mc.playerController.windowClick(inventorySlots.windowId, par2, par3, par4, mc.thePlayer)   != null && --infinite > 0);
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
