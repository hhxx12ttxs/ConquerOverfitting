...
public class bzip
{
    ...
    private static void zj(bzstate b1)
    {
        byte byte4 = b1.db;
        int i = b1.eb;
        int j = b1.ob;
...
label0:
    ...
    private static void yj(bzstate b1)
    {
        boolean flag = false;
        boolean flag1 = false;
        boolean flag2 = false;
        ...
        while(flag19) 
        {
            ...
            for(int l3 = 0; l3 < j4; l3++)
            {
                ...
                dk(b1.bc[l3], b1.cc[l3], b1.dc[l3], b1.ac[l3], byte8, i, i4);
                b1.ec[l3] = byte8;
            }
            ...
            int l7;
            byte byte9;
            for(l7 = ck(i7, b1); l7 > ai[i7]; l7 = l7 << 1 | byte9)
            {
                i7++;
                byte9 = bk(b1);
            }
            ...
            for(int k5 = ai2[l7 - ai1[i7]]; k5 != l4;)
                if(k5 == 0 || k5 == 1)
                {
                    ...
                    do
                    {
                        ...
                        int i8;
                        byte byte10;
                        for(i8 = ck(j7, b1); i8 > ai[j7]; i8 = i8 << 1 | byte10)
                        {
                            j7++;
                            byte10 = bk(b1);
                        }
                ...
                } else
                {
                    ...
                    int j8;
                    byte byte11;
                    for(j8 = ck(k7, b1); j8 > ai[k7]; j8 = j8 << 1 | byte11)
                    {
                        k7++;
                        byte11 = bk(b1);
                    }
    ...
    private static byte wj(bzstate b1)
    {
        return (byte)ck(8, b1);
    }

    private static byte bk(bzstate b1)
    {
        return (byte)ck(1, b1);
    }

    private static int ck(int i, bzstate b1)
    {
        int j;
        do
        {
    ...
    private static void ak(bzstate b1)
    {
        b1.sb = 0;
        for(int i = 0; i < 256; i++)
            if(b1.tb[i])
