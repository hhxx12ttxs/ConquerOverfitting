...
public class GulchTeleporter extends Teleporter
{
    ...
    public GulchTeleporter(WorldServer par1WorldServer)
    {
    ...
    public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
    {
        ...
        else
        {
            for (k1 = l - short1; k1 <= l + short1; ++k1)
            {
                ...
                for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1)
                {
                    ...
                    {
                        if (this.worldServerInstance.getBlock(k1, i2, l1) == GaltBlocks.portalBlock)
                        {
                            while (this.worldServerInstance.getBlock(k1, i2 - 1, l1) == GaltBlocks.portalBlock)
                            {
                                --i2;
                            }
        ...
        if (d3 >= 0.0D)
        {
            ...
            if (this.worldServerInstance.getBlock(i - 1, j, k) == GaltBlocks.portalBlock)
            {
                j2 = 2;
            }
            ...
            if (this.worldServerInstance.getBlock(i, j, k - 1) == GaltBlocks.portalBlock)
            {
                j2 = 3;
            }
