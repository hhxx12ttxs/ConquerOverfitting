...
public class Graphics2D implements ImageProducer, ImageObserver {
	public Graphics2D(int arg0, int arg1, int arg2, Component arg3) {
		wk = false;
		al = false;
		tk = arg1;
		vk = arg0;
	...
	public void ff() {
		...
		for (int k = 0; k < l; k++) {
			int j = ek[k] & 0xffffff;
			ek[k] = (j >>> 1 & 0x7f7f7f) + (j >>> 2 & 0x3f3f3f)
	...
	public void og(int arg0, byte arg1[], byte arg2[], int arg3) {
		int j = Util.readInt8(arg1, 0);
		int k = Util.readInt8(arg2, j);
		j += 2;
		int l = Util.readInt8(arg2, j);
		j += 2;
		int i1 = arg2[j++] & 0xff;
		int ai[] = new int[i1];
		ai[0] = 0xff00ff;
		for (int j1 = 0; j1 < i1 - 1; j1++) {
			ai[j1 + 1] = ((arg2[j] & 0xff) << 16) + ((arg2[j + 1] & 0xff) << 8)
					+ (arg2[j + 2] & 0xff);
			j += 3;
		}
		...
		for (int l1 = arg0; l1 < arg0 + arg3; l1++) {
			nk[l1] = arg2[j++] & 0xff;
			ok[l1] = arg2[j++] & 0xff;
			lk[l1] = Util.readInt8(arg2, j);
			j += 2;
			mk[l1] = Util.readInt8(arg2, j);
			j += 2;
			int i2 = arg2[j++] & 0xff;
			int j2 = lk[l1] * mk[l1];
			jk[l1] = new byte[j2];
	...
	public void ig(byte arg0[], int arg1, int arg2, boolean arg3, int arg4,
	...
	private void hf(int arg0[], int arg1, int arg2, int arg3, boolean arg4,
			int arg5[], int arg6) {
		int j = 0;
		int k = 0;
		int l = arg1;
		...
		for (int l1 = 0; l1 < j; l1++) {
			...
			if (l2 == -1) {
				...
				for (int i4 = 0; i4 < 256; i4++) {
					...
					int l4 = j4 >> 8 & 0xff;
					int i5 = j4 & 0xff;
					int j5 = (j3 - k4) * (j3 - k4) + (k3 - l4) * (k3 - l4) + (l3 - i5)
							* (l3 - i5);
					if (j5 < i3) {
						i3 = j5;
						l2 = i4;
	...
	private static void gf(int arg0[], int arg1[], int arg2, int arg3, int arg4,
	...
	// previously non static -- stormy
	private static void cg(int arg0[], byte arg1[], int arg2[], int arg3,
	...
	// previously non static -- stormy
	private static void pf(int arg0[], int arg1[], int arg2, int arg3, int arg4,
	...
	// previously non static -- stormy
	private static void gg(int arg0[], int arg1[], int arg2, int arg3, int arg4,
	...
	// previously non static -- stormy
	private static void ch(int arg0[], byte arg1[], int arg2[], int arg3,
	...
	// previously non static -- stormy
	private static void xf(int arg0[], int arg1[], int arg2, int arg3, int arg4,
			int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11,
			int arg12, int arg13) {
		int j = 256 - arg13;
		try {
	...
	// previously non static -- stormy
	private static void eh(int arg0[], int arg1[], int arg2, int arg3, int arg4,
			int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11,
			int arg12, int arg13) {
		int j = arg13 >> 16 & 0xff;
		int k = arg13 >> 8 & 0xff;
	...
	private void ag(int arg0[], int arg1[], int arg2, int arg3, int arg4,
			int arg5, int arg6, int arg7, int arg8, int arg9) {
	...
	private void eg(int arg0[], int arg1[], int arg2, int arg3, int arg4,
			int arg5, int arg6, int arg7, int arg8, int arg9) {
	...
	public void dg(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5,
			int arg6) {
		nf(arg0, arg1, arg2, arg3, arg4);
	}

	public void wf(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5,
		...
		try {
			...
			if (arg6 == 0xffffff) {
				if (ik[arg4] != null)
					if (!arg8) {
						dh(ek, ik[arg4], 0, l, i1, k2, arg2, arg3, k1, l1, j, arg5, j1, i2,
								j3);
						return;
					} else {
						dh(ek, ik[arg4], 0, (lk[arg4] << 16) - l - 1, i1, k2, arg2, arg3,
								-k1, l1, j, arg5, j1, i2, j3);
						return;
					}
				if (!arg8) {
					_mthif(ek, jk[arg4], kk[arg4], 0, l, i1, k2, arg2, arg3, k1, l1, j,
							arg5, j1, i2, j3);
					return;
				} else {
					_mthif(ek, jk[arg4], kk[arg4], 0, (lk[arg4] << 16) - l - 1, i1, k2,
							arg2, arg3, -k1, l1, j, arg5, j1, i2, j3);
					return;
				}
			}
			if (ik[arg4] != null)
				if (!arg8) {
					bg(ek, ik[arg4], 0, l, i1, k2, arg2, arg3, k1, l1, j, arg5, arg6, j1,
							i2, j3);
					return;
				} else {
					bg(ek, ik[arg4], 0, (lk[arg4] << 16) - l - 1, i1, k2, arg2, arg3,
							-k1, l1, j, arg5, arg6, j1, i2, j3);
					return;
				}
			if (!arg8) {
				bh(ek, jk[arg4], kk[arg4], 0, l, i1, k2, arg2, arg3, k1, l1, j, arg5,
						arg6, j1, i2, j3);
				return;
			} else {
				bh(ek, jk[arg4], kk[arg4], 0, (lk[arg4] << 16) - l - 1, i1, k2, arg2,
	...
	private void dh(int arg0[], int arg1[], int arg2, int arg3, int arg4,
			int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11,
				...
				if (arg14 != 0) {
					for (int k3 = k2; k3 < k2 + l2; k3++) {
						...
						if (arg2 != 0) {
							...
							int l = arg2 & 0xff;
							if (j == k && k == l)
								arg0[k3 + arg5] = ((j * i1 >> 8) << 16) + ((k * j1 >> 8) << 8)
										+ (l * k1 >> 8);
							else
								arg0[k3 + arg5] = arg2;
						}
				...
				if (arg15 != 0) {
					for (int j4 = j3; j4 < j3 + k3; j4++) {
						...
						if (arg2 != 0) {
							...
							int l = arg2 & 0xff;
							if (j == k && k == l)
								arg0[j4 + arg5] = ((j * i1 >> 8) << 16) + ((k * j1 >> 8) << 8)
										+ (l * k1 >> 8);
							else if (j == 255 && k == l)
								arg0[j4 + arg5] = ((j * l1 >> 8) << 16) + ((k * i2 >> 8) << 8)
										+ (l * j2 >> 8);
							else
								arg0[j4 + arg5] = arg2;
						}
	...
	private void _mthif(int arg0[], byte arg1[], int arg2[], int arg3, int arg4,
			int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11,
			int arg12, int arg13, int arg14, int arg15) {
				...
				if (arg15 != 0) {
					for (int k3 = k2; k3 < k2 + l2; k3++) {
						...
						if (arg3 != 0) {
							...
							int l = arg3 & 0xff;
							if (j == k && k == l)
								arg0[k3 + arg6] = ((j * i1 >> 8) << 16) + ((k * j1 >> 8) << 8)
										+ (l * k1 >> 8);
							else
								arg0[k3 + arg6] = arg3;
						}
	...
	private void bh(int arg0[], byte arg1[], int arg2[], int arg3, int arg4,
			int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11,
				...
				if (arg16 != 0) {
					for (int j4 = j3; j4 < j3 + k3; j4++) {
						...
						if (arg3 != 0) {
							...
							int l = arg3 & 0xff;
							if (j == k && k == l)
								arg0[j4 + arg6] = ((j * i1 >> 8) << 16) + ((k * j1 >> 8) << 8)
										+ (l * k1 >> 8);
							else if (j == 255 && k == l)
								arg0[j4 + arg6] = ((j * l1 >> 8) << 16) + ((k * i2 >> 8) << 8)
										+ (l * j2 >> 8);
							else
								arg0[j4 + arg6] = arg3;
						}
	...
	public void ug(String arg0, int arg1, int arg2, int arg3, int arg4) {
		...
		try {
			...
			for (int i1 = 0; i1 < arg0.length(); i1++) {
				...
				if (j > arg5) {
					if (l <= k)
						l = i1;
					ug(arg0.substring(k, l), arg1, arg2, arg3, arg4);
					j = 0;
					k = i1 = l + 1;
					arg2 += ng(arg3);
				}
			...
			if (j > 0) {
				ug(arg0.substring(k), arg1, arg2, arg3, arg4);
				return;
			}
	...
	public void drawString(String arg0, int arg1, int arg2, int arg3,
			int textColor) {
		try {
			byte abyte0[] = xk[arg3];
	...
	// previously non static -- stormy
	private static void cf(int arg0[], byte arg1[], int arg2, int arg3, int arg4,
	...
	public int df(String arg0, int arg1) {
		...
		for (int k = 0; k < arg0.length(); k++)
			if (arg0.charAt(k) == '@' && k + 4 < arg0.length()
					&& arg0.charAt(k + 4) == '@')
				k += 4;
			else if (arg0.charAt(k) == '~' && k + 4 < arg0.length()
					&& arg0.charAt(k + 4) == '~')
				k += 4;
			else
