...
public class World implements IBlockAccess
{
     ...
     * MODIF World: getClosestPlayer(double par1, double par3, double par5, double par7)
     */
    public EntityPlayer getClosestPlayer(double par1, double par3, double par5, double par7)
    {
        ...
        for (int i = 0; i < playerEntities.size(); i++)
        {
            ...
            if ((par7 < 0.0D || d1 < par7 * par7) && (d == -1D || d1 < d) && !entityplayer1.isSkillActive(TKHSkill.invisibility))
            {
                d = d1;
    ...
    /**
     * MODIF World: func_48456_a(double par1, double par3, double par5)
     */
    public EntityPlayer func_48456_a(double par1, double par3, double par5)
    {
        ...
        for (int i = 0; i < playerEntities.size(); i++)
        {
            ...
            if ((par5 < 0.0D || d1 < par5 * par5) && (d == -1D || d1 < d) && !entityplayer1.isSkillActive(TKHSkill.invisibility))
            {
                d = d1;
                entityplayer = entityplayer1;
            }
     ...
     * MODIF World: getClosestVulnerablePlayer(double par1, double par3, double par5, double par7)
     */
    public EntityPlayer getClosestVulnerablePlayer(double par1, double par3, double par5, double par7)
    {
        ...
        for (int i = 0; i < playerEntities.size(); i++)
        {
            ...
            if (entityplayer1.capabilities.disableDamage || entityplayer1.isSkillActive(TKHSkill.invisibility))
            {
                continue;
            }
