...
public class World {
  public World(Scene arg0, Graphics2D arg1) {
    xhb = false;
    yhb = true;
    bib = 750;
    eib = new int[256];
    ...
    zhb = arg1;
    for (int k = 0; k < 64; k++)
      eib[k] = Scene.fi(255 - k * 4, 255 - (int) ((double) k * 1.75D),
          255 - k * 4);
    ...
    for (int i1 = 0; i1 < 64; i1++)
      eib[i1 + 128] = Scene.fi(192 - (int) ((double) i1 * 1.5D),
          144 - (int) ((double) i1 * 1.5D), 0);

    for (int j1 = 0; j1 < 64; j1++)
      eib[j1 + 192] = Scene.fi(96 - (int) ((double) j1 * 1.5D),
          48 + (int) ((double) j1 * 1.5D), 0);

  }

  public int ho(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5,
    ...
    while (j1 != i1) {
      ...
      if (arg8) {
        if (k1 > 0 && k1 - 1 >= arg2 && k1 - 1 <= arg4 && l1 >= arg3
            && l1 <= arg5 && (ajb[k1 - 1][l1] & 8) == 0) {
          flag = true;
          break;
        }
        if (k1 < vib - 1 && k1 + 1 >= arg2 && k1 + 1 <= arg4 && l1 >= arg3
            && l1 <= arg5 && (ajb[k1 + 1][l1] & 2) == 0) {
          flag = true;
          break;
        }
        if (l1 > 0 && k1 >= arg2 && k1 <= arg4 && l1 - 1 >= arg3
            && l1 - 1 <= arg5 && (ajb[k1][l1 - 1] & 4) == 0) {
          flag = true;
          break;
        }
        if (l1 < wib - 1 && k1 >= arg2 && k1 <= arg4 && l1 + 1 >= arg3
            && l1 + 1 <= arg5 && (ajb[k1][l1 + 1] & 1) == 0) {
          flag = true;
          break;
        }
      }
      ...
      if (k1 > 0 && l1 > 0 && (ajb[k1][l1 - 1] & 0x74) == 0
          && (ajb[k1 - 1][l1] & 0x78) == 0 && (ajb[k1 - 1][l1 - 1] & 0x7c) == 0
          && zib[k1 - 1][l1 - 1] == 0) {
        arg6[i1] = k1 - 1;
        arg7[i1] = l1 - 1;
        i1 = (i1 + 1) % i2;
      ...
      if (k1 < vib - 1 && l1 > 0 && (ajb[k1][l1 - 1] & 0x74) == 0
          && (ajb[k1 + 1][l1] & 0x72) == 0 && (ajb[k1 + 1][l1 - 1] & 0x76) == 0
          && zib[k1 + 1][l1 - 1] == 0) {
        arg6[i1] = k1 + 1;
        arg7[i1] = l1 - 1;
        i1 = (i1 + 1) % i2;
      ...
      if (k1 > 0 && l1 < wib - 1 && (ajb[k1][l1 + 1] & 0x71) == 0
          && (ajb[k1 - 1][l1] & 0x78) == 0 && (ajb[k1 - 1][l1 + 1] & 0x79) == 0
          && zib[k1 - 1][l1 + 1] == 0) {
        arg6[i1] = k1 - 1;
        arg7[i1] = l1 + 1;
        i1 = (i1 + 1) % i2;
      ...
      if (k1 < vib - 1 && l1 < wib - 1 && (ajb[k1][l1 + 1] & 0x71) == 0
          && (ajb[k1 + 1][l1] & 0x72) == 0 && (ajb[k1 + 1][l1 + 1] & 0x73) == 0
          && zib[k1 + 1][l1 + 1] == 0) {
        arg6[i1] = k1 + 1;
        arg7[i1] = l1 + 1;
        i1 = (i1 + 1) % i2;
  ...
  public void no(int arg0, int arg1, int arg2, int arg3) {
    ...
    for (int k = arg0; k <= arg0 + arg2; k++) {
      for (int l = arg1; l <= arg1 + arg3; l++)
        if ((lp(k, l) & 0x63) != 0 || (lp(k - 1, l) & 0x59) != 0
            || (lp(k, l - 1) & 0x56) != 0 || (lp(k - 1, l - 1) & 0x6c) != 0)
          to(k, l, 35);
        else
          to(k, l, 0);
  ...
  public void ip(int arg0, int arg1, int arg2, int arg3, int arg4) {
    ...
    for (int k = 0; k < h1.og; k++)
      if (h1.ji[k] == arg2 * 128 && h1.li[k] == arg3 * 128) {
        h1.xd(k, arg4);
        return;
      }
  ...
  public int oo(int arg0, int arg1) {
    int k = arg0 >> 7;
    int l = arg1 >> 7;
    int i1 = arg0 & 0x7f;
    int j1 = arg1 & 0x7f;
  ...
  public int wo(int arg0, int arg1, int arg2) {
    ...
    return sib[byte0][arg0 * 48 + arg1] & 0xff;
  }
  ...
  public void so(int arg0, int arg1, int arg2) {
    ...
    sib[byte0][arg0 * 48 + arg1] = (byte) arg2;
  }
  ...
  public boolean ep(int arg0, int arg1) {
    return bp(arg0, arg1) > 0 || bp(arg0 - 1, arg1) > 0
        || bp(arg0 - 1, arg1 - 1) > 0 || bp(arg0, arg1 - 1) > 0;
  }
  ...
  public int po(int arg0, int arg1) {
    ...
    return qib[byte0][arg0 * 48 + arg1] & 0xff;
  }
  ...
  public int yo(int arg0, int arg1) {
    ...
    return pib[byte0][arg0 * 48 + arg1] & 0xff;
  }

  public void eo(int arg0, int arg1, int arg2, int arg3) {
    ...
    try {
      if (landscape != null) {
        ...
        if (abyte0 != null && abyte0.length > 0) {
          ...
          for (int i4 = 0; i4 < 48; i4++) {
            for (int k5 = 0; k5 < 48; k5++) {
              i2 = nib[arg3][k5 * 48 + i4] + i2 & 0x7f;
              nib[arg3][k5 * 48 + i4] = (byte) (i2 * 2);
            }
          ...
          for (int j7 = 0; j7 < 48; j7++) {
            for (int l8 = 0; l8 < 48; l8++) {
              i2 = oib[arg3][l8 * 48 + j7] + i2 & 0x7f;
              oib[arg3][l8 * 48 + j7] = (byte) (i2 * 2);
            }
        ...
        for (int i10 = 0; i10 < 2304;) {
          ...
          if (k10 < 128) {
            sib[arg3][i10++] = (byte) k10;
            j9 = k10;
          } else {
            for (int j11 = 0; j11 < k10 - 128; j11++)
              sib[arg3][i10++] = (byte) j9;
        ...
        for (int l6 = 0; l6 < 2304; l6++)
          pib[arg3][l6] = abyte1[k2++];

        for (int j8 = 0; j8 < 2304; j8++)
          qib[arg3][j8] = abyte1[k2++];

        for (int k9 = 0; k9 < 2304; k9++) {
          uib[arg3][k9] = (abyte1[k2] & 0xff) * 256 + (abyte1[k2 + 1] & 0xff);
          k2 += 2;
        }

        for (int j10 = 0; j10 < 2304; j10++)
          rib[arg3][j10] = abyte1[k2++];

        for (int i11 = 0; i11 < 2304; i11++)
          sib[arg3][i11] = abyte1[k2++];

        for (int i12 = 0; i12 < 2304; i12++)
          tib[arg3][i12] = abyte1[k2++];
  ...
  public void ko(int arg0, int arg1, int arg2, boolean arg3) {
    ...
    ro();
    if (gjb == null)
      gjb = new Model(vib * wib * 2 + 256, vib * wib * 2 + 256, true, true,
          false, false, true);
    if (arg3) {
      zhb.lf();
      ...
      for (int i2 = 0; i2 < 96; i2++) {
        for (int l2 = 0; l2 < 96; l2++) {
          ...
          if (wo(i2, l2, arg2) > 0 && Config.xlb[wo(i2, l2, arg2) - 1] == 4)
            l3 = 0;
          if (wo(i2 - 1, l2, arg2) > 0
              && Config.xlb[wo(i2 - 1, l2, arg2) - 1] == 4)
            l3 = 0;
          if (wo(i2, l2 - 1, arg2) > 0
              && Config.xlb[wo(i2, l2 - 1, arg2) - 1] == 4)
            l3 = 0;
          if (wo(i2 - 1, l2 - 1, arg2) > 0
              && Config.xlb[wo(i2 - 1, l2 - 1, arg2) - 1] == 4)
            l3 = 0;
      ...
      for (int i3 = 0; i3 < 95; i3++) {
        for (int i4 = 0; i4 < 95; i4++) {
          ...
          if (wo(i3, i4, arg2) > 0) {
            ...
            if (k5 == 5) {
              if (lo(i3, i4) > 0 && lo(i3, i4) < 24000)
                if (mo(i3 - 1, i4, arg2, j12) != 0xbc614e
                    && mo(i3, i4 - 1, arg2, j12) != 0xbc614e) {
                  j7 = mo(i3 - 1, i4, arg2, j12);
                  k14 = 0;
                } else if (mo(i3 + 1, i4, arg2, j12) != 0xbc614e
                    && mo(i3, i4 + 1, arg2, j12) != 0xbc614e) {
          ...
          jo(i3, i4, k14, j7, l9);
          int l16 = ((uo(i3 + 1, i4 + 1) - uo(i3 + 1, i4)) + uo(i3, i4 + 1))
              - uo(i3, i4);
          if (j7 != l9 || l16 != 0) {
            int ai[] = new int[3];
            int ai7[] = new int[3];
      ...
      for (int j4 = 1; j4 < 95; j4++) {
        for (int l5 = 1; l5 < 95; l5++)
          if (wo(j4, l5, arg2) > 0 && Config.xlb[wo(j4, l5, arg2) - 1] == 4) {
            ...
            int l14 = h1
                .oe((j4 + 1) * 128, -uo(j4 + 1, l5 + 1), (l5 + 1) * 128);
            ...
            jo(j4, l5, 0, k7, k7);
          } else if (wo(j4, l5, arg2) == 0
              || Config.xlb[wo(j4, l5, arg2) - 1] != 3) {
            if (wo(j4, l5 + 1, arg2) > 0
                && Config.xlb[wo(j4, l5 + 1, arg2) - 1] == 4) {
              int l7 = Config.wlb[wo(j4, l5 + 1, arg2) - 1];
              int j10 = h1.oe(j4 * 128, -uo(j4, l5), l5 * 128);
              int l12 = h1.oe((j4 + 1) * 128, -uo(j4 + 1, l5), l5 * 128);
              int i15 = h1.oe((j4 + 1) * 128, -uo(j4 + 1, l5 + 1),
                  (l5 + 1) * 128);
            ...
            if (wo(j4, l5 - 1, arg2) > 0
              ...
              int j15 = h1.oe((j4 + 1) * 128, -uo(j4 + 1, l5 + 1),
                  (l5 + 1) * 128);
            ...
            if (wo(j4 - 1, l5, arg2) > 0
              ...
              int l15 = h1.oe((j4 + 1) * 128, -uo(j4 + 1, l5 + 1),
                  (l5 + 1) * 128);
    ...
    for (int l6 = 1; l6 < 95; l6++) {
      for (int j9 = 1; j9 < 95; j9++) {
        ...
        if (l11 > 0) {
          ...
          k27 = -k27;
          l27 = -l27;
          if (lo(l6, j9) > 12000 && lo(l6, j9) < 24000
              && bp(l6 - 1, j9 - 1) == 0) {
            int ai8[] = new int[3];
          ...
          } else if (lo(l6, j9) > 12000 && lo(l6, j9) < 24000
              && bp(l6 + 1, j9 + 1) == 0) {
            int ai9[] = new int[3];
          ...
          } else if (lo(l6, j9) > 0 && lo(l6, j9) < 12000
              && bp(l6 + 1, j9 - 1) == 0) {
            int ai10[] = new int[3];
