...
public class RenderGlobalPublic implements IWorldAccess {
    ...
    public RenderGlobalPublic() {} 
    
    public RenderGlobalPublic(Minecraft minecraft, RenderEngine renderengine)
    {
    ...
    public void checkOcclusionQueryResult(int i, int j)
    {
        for(int k = i; k < j; k++)
        {
    ...
    public int renderSortedRenderers(int i, int j, int k, double d)
    {
        glRenderLists.clear();
        int l = 0;
