 ...
 * @version $Id: TerrainProfileLayer.java 12429 2009-08-07 23:43:23Z patrickmurris $
 */
public class TerrainProfileLayer extends AbstractLayer implements PositionListener, SelectListener
{
    ...
    // Expiry handling
    private TimedExpirySupport expirySupport = new TimedExpirySupport(1000, 2000);
     ...
     */
    public boolean getUpdate(DrawContext dc)
    {
        return this.expirySupport.isExpired(dc);
    }
    ...
    {
        this.expirySupport.setExpired(state);
    }
...
//            this.wwd.getModel().getGlobe().getElevationModel().addPropertyChangeListener(this);
     ...
     * <p>
     * If {@link #FOLLOW_VIEW}, {@link #FOLLOW_EYE}, {@link #FOLLOW_CURSOR} or {@link #FOLLOW_OBJECT}, collects
     * terrain profile data along a great circle line centered at the current position (view, eye, cursor or object)
     * and perpendicular to the view heading - or object heading if {@link #FOLLOW_OBJECT}. 
     * <p>
     ...
     * {@link #setPathPositions(ArrayList<? extends LatLon>)}</p>
     *
