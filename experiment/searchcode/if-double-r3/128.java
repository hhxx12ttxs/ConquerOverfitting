...
public class JavaScriptSpecialTest extends TestCase
{
	public RowMetaInterface createRowMetaInterface1()
	{
		...
		ValueMetaInterface valuesMeta[] = { new ValueMeta("string", ValueMetaInterface.TYPE_STRING), };
	...
	public RowMetaInterface createRowMetaInterfaceResult1()
	{
		...
		ValueMetaInterface valuesMeta[] = { new ValueMeta("string", ValueMetaInterface.TYPE_STRING), new ValueMeta("bool", ValueMetaInterface.TYPE_BOOLEAN) };
	...
	public RowMetaInterface createRowMetaInterface3()
	{
		...
		ValueMetaInterface valuesMeta[] = { new ValueMeta("int_in", ValueMetaInterface.TYPE_INTEGER), new ValueMeta("number_in", ValueMetaInterface.TYPE_NUMBER), new ValueMeta("string_in", ValueMetaInterface.TYPE_STRING), };
	...
	public RowMetaInterface createRowMetaInterface4()
	{
		...
		ValueMetaInterface valuesMeta[] = { new ValueMeta("int_in", ValueMetaInterface.TYPE_INTEGER), new ValueMeta("number_in", ValueMetaInterface.TYPE_NUMBER), new ValueMeta("string_in", ValueMetaInterface.TYPE_STRING),
			new ValueMeta("long1", ValueMetaInterface.TYPE_INTEGER), new ValueMeta("number1", ValueMetaInterface.TYPE_NUMBER), new ValueMeta("string1", ValueMetaInterface.TYPE_STRING), new ValueMeta("long2", ValueMetaInterface.TYPE_INTEGER),
			new ValueMeta("number2", ValueMetaInterface.TYPE_NUMBER), new ValueMeta("string2", ValueMetaInterface.TYPE_STRING), };
