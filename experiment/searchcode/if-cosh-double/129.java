...
public final class MathUtils {
	...
	/**
	 * Returns the inverse hyperbolic cosine of a <code>double</code> value. Note 
	 ...
	 * <li>If the argument is zero, then the result is a zero with the same sign as the argument.
	 * </ul>
	 * @param d a <code>double</code> specifying the value whose inverse hyperbolic tangent is sought
	 * @return a <code>double</code> specifying the inverse hyperbolic tangent of <code>d</code>
	 */ 
