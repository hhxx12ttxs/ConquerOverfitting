...
public class MikranSearch extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        welcomeMessageLabel.setText("Aplikacja Mikran służy do sprawdzania cen i dostępnoci towarów" +
			                        " w sklepie mikran.pl na podstawie numeru katalogowego produktu. " +
			                        "Jeli chciałby otrzymać nasz katalog wysyłkowy wylij maila na sklep@mikran.pl");
    ...
    protected Dialog onCreateDialog(int id)
    {
    	switch(id)
    	{
    		case DIALOG_PROGRESS:
    			...
    			progressDialog.setMessage("Łšczenie. Proszę czekać...");
    ...
    public void onClickSearchButton(View view)
    {
    	...
    	if(!isProductID)
    	{
    		notFoundResultLabel.setText("Wyszukiwanie nie zwróciło żadnych wyników.");
    ...
    {
    	if(Response.CODE_200 == MikranResults.appState) // dostępny
    	{
    		notFoundResultLayout.setVisibility(View.INVISIBLE);
    		welcomeMessageLayout.setVisibility(View.INVISIBLE);
    		numStoreValueLabel.setText("dostępny z magazynu");
    	...
    	else if(Response.CODE_404 == MikranResults.appState)
    	{
            ...
            welcomeMessageLayout.setVisibility(View.INVISIBLE);
            notFoundResultLayout.setVisibility(View.VISIBLE);
            notFoundResultLabel.setText("Wyszukiwanie nie zwróciło żadnych wyników dla kodu " + results.productID + ".");
    	}
    	else if(Response.CODE_500 == MikranResults.appState)
    	{
            ...
            welcomeMessageLayout.setVisibility(View.INVISIBLE);
            notFoundResultLayout.setVisibility(View.VISIBLE);
            notFoundResultLabel.setText("ID produktu powinno być liczbš.");
    	}
    	else if(Response.DATA_ERROR == MikranResults.appState)
    	{
            ...
            welcomeMessageLayout.setVisibility(View.INVISIBLE);
            notFoundResultLayout.setVisibility(View.VISIBLE);
            notFoundResultLabel.setText("Błšd danych.");
    	}
    	else if(Response.NO_INTERNET_CONNECTION == MikranResults.appState)
    	{
            ...
            welcomeMessageLayout.setVisibility(View.INVISIBLE);
            notFoundResultLayout.setVisibility(View.VISIBLE);
            notFoundResultLabel.setText("Brak połšczenia internetowego.");
    	}
    	...
    	else if(Response.EXCEPTION_MalformedURLException == MikranResults.appState)
    	{
            ...
            welcomeMessageLayout.setVisibility(View.INVISIBLE);
            notFoundResultLayout.setVisibility(View.VISIBLE);
            notFoundResultLabel.setText("Błšd w adresie serwera.");
    	}
    	else if(Response.EXCEPTION_UnsupportedEncodingException == MikranResults.appState)
    	{
            ...
            welcomeMessageLayout.setVisibility(View.INVISIBLE);
            notFoundResultLayout.setVisibility(View.VISIBLE);
            notFoundResultLabel.setText("Błędne kodowanie danych.");
    	}
