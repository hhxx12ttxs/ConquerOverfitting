...
//        return DYNAMIC_ENTITY_PREFIX + viewName.substring(DYNAMIC_ENTITY_VIEW_PREFIX.length()).toLowerCase();
	...
	public void addDynamicEntities(Map<UID, Map<UID, FieldMeta<?>>> result, Map<UID, EntityMeta<?>> mapMetaDataByEntity) {
...
//	public Map<String, FieldMeta> getDynamicFieldsForView(String viewName, long entityId) {
...
//				FieldMeta meta = newDynamicFieldVO(column, columnId, entityName, entityId);
...
//	private FieldMeta newDynamicFieldVO(DbColumn dbColumn, long columnId, String entity, long entityId) {
