 ...
 * of {@link gov.nasa.worldwind.geom.Extent} instances and {@link gov.nasa.worldwind.examples.util.ExtentVisibilitySupport.ScreenExtent}
 ...
 *
 * @author dcollins
 * @version $Id: ExtentVisibilitySupport.java 12947 2009-12-21 11:45:48Z dcollins $
 * @see gov.nasa.worldwind.geom.Extent
 * @see gov.nasa.worldwind.geom.ExtentHolder
 * @see gov.nasa.worldwind.examples.util.ExtentVisibilitySupport.ScreenExtent
 */
public class ExtentVisibilitySupport
{
     ...
     * reference point in model coordinates. ExtentVisibilitySupport assumes that the relationship betwen the model
     * reference point and the screen bounds are predicatble: projecting the reference point into screen coordinates
        ...
        double nearClipDistance, double farClipDistance)
    {
        ...
        Matrix localCoords = globe.computeModelCoordinateOriginTransform(centerPos);
        Matrix newLocalCoords = globe.computeModelCoordinateOriginTransform(newCenterPos);
