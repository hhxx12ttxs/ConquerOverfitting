...
public class DoubleDoubleScalaOperationsToolbar  extends JPanel {
        JButton bconstr, bcolon, bFastOps;
    ...
    public DoubleDoubleScalaOperationsToolbar() {
        ...
        bFastOps = new JButton("Direct Matrix Ops");
        bFastOps.setToolTipText("Matrix-like operations directly on Array[Array[Double]] ");
        bFastOps.addActionListener(new ActionListener() {
             public void actionPerformed(ActionEvent e) {

                 EditorPaneHTMLHelp  eigHelpPane = new EditorPaneHTMLHelp("FastArrayOps.htm");
        ...
        matrixPanel1.add(bFastOps);

        bdirect = new JButton("MDD(s:String)");
        bdirect.setToolTipText("initialize directly the Array[Array[Double]] with some elements, e.g. var A = MDD(\"6.7, -6.5; -3.4 23)\"");
        bdirect.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
           GlobalValues.scalalabMainFrame.scalalabConsole.setText(GlobalValues.scalalabMainFrame.scalalabConsole.getText()+"var A =  MDD(\" ...  ; ... \"");
           GlobalValues.scalalabMainFrame.scalalabConsole.setCaretPosition(GlobalValues.scalalabMainFrame.scalalabConsole.getText().length());
