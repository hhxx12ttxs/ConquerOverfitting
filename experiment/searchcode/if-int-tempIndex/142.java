...
//      VM.sysWriteln(" - startLocal0Offset = ", startLocal0Offset);
    ...
    buildBB.determineTheBasicBlocks(method, cm.useOldBytecodes);

    BuildReferenceMaps buildRefMaps = new BuildReferenceMaps();
    buildRefMaps.buildReferenceMaps(method, stackHeights, localTypes, this, buildBB, cm.useOldBytecodes);
