...
public class BuildCompressedIndex {
  ...
  public static void main(final String[] args) throws IOException {
    final BuildCompressedIndex bi = new BuildCompressedIndex();
  ...
  private void writeCompressedCorpusIndex(final Map<Integer, Set<Integer>> combfMap, final File file)
    ...
    for (final Map.Entry<Integer, Set<Integer>> entry : combfMap.entrySet()) {
      ...
      // Encoding
      final LinkedList<Byte> encodedDocIdList = VariableByteEncoding.vbEncode(VariableByteEncoding.to_gaps(docIdsList));
