...
public class MonopolyGameLogic
{
		...
		do
		{
			...
			if(currentCell.shouldRollTheDice(currentPlayer))
			{
                                ...
                                if (!(currentPlayer instanceof AutomaticPlayer) && !useAutomaticDiceRoll)
				{
                                    ...
                                    StateManager.getStateManager().setCurrentStateToPromptPlayerRollDice(this,
                                            currentPlayer.getName() + " should roll the dice ",
                                            currentPlayer, waiter);
	...
	{
		// motify passing in cell if needed
                if (passedCell.getType().compareTo("Go") == 0)
                {
                    getStateManager().setCurrentStateToPlayerPassedStartSquare(this, "Passing Go",      
                           passedPlayer);
                }
