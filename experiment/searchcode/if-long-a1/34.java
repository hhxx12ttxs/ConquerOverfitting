 ...
 * @author Bela Ban
 * @version $Id: Util.java,v 1.1 2009/07/30 00:58:11 phperret Exp $
 */
public class Util {
...
//    }
    ...
    */
    ...
    public static void main(String args[]) throws Exception {
        ...
        String arg0= getIpStringFromBytes( new byte[]{ (byte)192, (byte)168, 0, 1}) ;
        IpAddress addr= new IpAddress( arg0, 4040);
        System.out.println( addr.getIpAddress().getHostAddress().toString() );
