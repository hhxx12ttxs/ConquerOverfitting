...
public class DateTimeFormat {
	...
	DAY, HOUR_MINUTE, HOUR_MINUTE_SECOND, HOUR24_MINUTE, HOUR24_MINUTE_SECOND, MINUTE_SECOND, MONTH, MONTH_ABBR, MONTH_ABBR_DAY, MONTH_DAY, MONTH_NUM_DAY, MONTH_WEEKDAY_DAY, YEAR, YEAR_MONTH, YEAR_MONTH_ABBR, YEAR_MONTH_ABBR_DAY, YEAR_MONTH_DAY, YEAR_MONTH_NUM, YEAR_MONTH_NUM_DAY, YEAR_QUARTER, YEAR_QUARTER_ABBR,
    }
    ...
    private static DateTimeFormatInfo defaultDateTimeFormatInfo = new DefaultDateTimeFormatInfo();
     ...
     * pattern for this format is predefined for each locale.
     * 
     * @return A DateTimeFormat object {@link PredefinedFormat#DATE_TIME_MEDIUM}
     *         instead
     */
    @Deprecated
     ...
     *            the date object being formatted
     * @param timeZone
     *            a TimeZone object that holds time zone information
     * 
