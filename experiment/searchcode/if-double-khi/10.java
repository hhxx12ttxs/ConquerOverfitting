...
public abstract class Serialize {
	/**
	 * Hŕm nŕy s? th?c thi serialize m?t object ch? ??nh, chuy?n Object thŕnh
	 * ki?u Document c?a XML (JDom).
	 * 
	 * @param source
	 *            object ngu?n ch? ??nh mu?n serialize.
	 * @return Document
	 * @throws Exception
	 *             ném ra ngo?i l? nŕy b?t c? khi nŕo quá trěnh serialize g?p
	 *             l?i.
	 */
	...
	/**
	 * Th?c thi vi?c serialize m?t object.
	 * 
	 * @param source
	 *            object ngu?n ch? ??nh mu?n serialize.
	 * @param target
	 *            ??i t??ng Document důng ?? l?u tr? thông tin các Element c?a
	 *            object d??i d?ng XML
	 * @param table
	 *            B?ng Map ch?a các giá tr? thông tin v? ID c?a các Object ?ă
	 *            ???c serialize.
	 * @return Tr? v? ??i t??ng Document ch?a thông tin ?ă ???c serialize.
	 * @throws Exception
	 *             ném ra ngo?i l? b?t c? khi nŕo quá trěnh serialize g?p l?i.
	 */
	...
	/**
	 * Hŕm th?c thi vi?c serialize các child object lŕ variable c?a m?t object
	 * ???c ch? ??nh serialize.
	 * 
	 * @param fieldType
	 *            ki?u type c?a object c?n serialize
	 * @param child
	 *            object c?n serialize
	 * @param target
	 *            ??i t??ng Document target důng ?? c?t tr? thông tin object sau
	 *            khi ???c serialize.
	 * @param table
	 *            b?ng Map ch?a các giá tr? thông tin v? ID c?a các Object ?ă
	 *            ???c serialize.
	 * @return tr? v? m?t Element t??ng tr?ng cho child object v?a ???c
	 *         serialize.
	 * @throws Exception
	 *             ném ra ngo?i l? b?t c? khi nŕo quá trěnh serialize g?p l?i.
	 */
	private static Element serializeVariable(Class<?> fieldType, Object child,
		...
		/* N?u fieldType không ph?i lŕ Primitive Type */
		else if (!fieldType.isPrimitive()) {
			Element reference = new Element("reference");
			/* N?u child ?ă ???c serialize */
			synchronized (table) {
