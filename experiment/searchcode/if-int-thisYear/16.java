...
//		"????",
	...
	class BasicInfoPane extends JPanel{
		...
		private BasicInfoPane(){
			super();
//			this.setPreferredSize(new Dimension(ANY_VALUE, PANE_HEIGHT));
...
//				constraints.gridheight = 80;
				...
				case 2:
				{
					...
					femaleButton = new JRadioButton("?", false);
	...
	private static final String[] COLUME_STR = {
			"????",
			"??",
		};
	private static final String MOTHOD_STR[] = {
			"????",
			"????",
		};
	class ContractList extends JTable{
		...
		public ContractList(){
//			super(rowData, COLUME_STR);
			super(new ContractModel());
//			this.setMaximumSize(new Dimension(PANE_WIDTH, PANE_HEIGHT));
