...
public class GroupingPage extends WizardPage implements Listener 
{
	public static final String copyright = "(c) Copyright NICK Corporation 2002.";
	
	// widgets on this page
	Combo newPackageChoice;
	List packageList;
	 ...
	 */
	protected GroupingPage(String arg0,org.eclipse.uml2.uml.Package myPackage) {
		super(arg0);
		setTitle("Grouping");
		setDescription("Select Grouping options");
	...
	public void createControl(Composite parent) {
		...
		new Label (composite, SWT.NONE).setText("New Package for Group?:");
	...
	private void saveDataToModel()
	{
		...
		if(newPackageChoice.getText().equals("Yes")) {
			model.groupPackageNew=true;
		} else {
			model.groupPackageNew=false;
			model.groupPackage=(org.eclipse.uml2.uml.Package) myPackage.getNestedPackage(packageList.getSelection()[0]);//packageList.getSelection()[0]);
		}
	}	
