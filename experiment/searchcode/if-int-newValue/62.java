...
public interface MemcacheService extends BaseMemcacheService {
  ...
  final class CasValues {
    ...
    public boolean equals(Object otherObj) {
      ...
      return Objects.equal(oldValue, otherCasValues.oldValue) &&
          Objects.equal(newValue, otherCasValues.newValue) &&
          Objects.equal(expiration, otherCasValues.expiration);
    }

    @Override
    public int hashCode() {
      return Objects.hashCode(oldValue, newValue, expiration);
    }
  }
