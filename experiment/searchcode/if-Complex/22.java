    ...
    /*implements RDFWriter*/
{
    ...
    public N3JenaWriterPP(){
    	 doObjectListsAsLists = getBooleanValue("objectLists", true) ;   	   
    }
...
//        }
    ...
    protected ClosableIterator<Property> preparePropertiesForSubject(Resource r)
    {
        ...
        ExtendedIterator<Property> eIter2 = WrappedIteratorFactory.create(tmp1.values().iterator()) ;
            
        eIter = (eIter == null) ? eIter2 : eIter.andThen(eIter2) ;
                    
        eIter2 = WrappedIteratorFactory.create(tmp2.values().iterator()) ;
