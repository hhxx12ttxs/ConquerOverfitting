...
public class MediaPlaybackService extends Service {
    ...
    public static final String PLAYSTATE_CHANGED = "net.michaelzhou.android.music403.playstatechanged";
    public static final String META_CHANGED = "net.michaelzhou.android.music403.metachanged";
    public static final String QUEUE_CHANGED = "net.michaelzhou.android.music403.queuechanged";

    public static final String SERVICECMD = "net.michaelzhou.android.music403.musicservicecommand";
    ...
    public static final String TOGGLEPAUSE_ACTION = "net.michaelzhou.android.music403.musicservicecommand.togglepause";
    public static final String PAUSE_ACTION = "net.michaelzhou.android.music403.musicservicecommand.pause";
    public static final String PREVIOUS_ACTION = "net.michaelzhou.android.music403.musicservicecommand.previous";
    public static final String NEXT_ACTION = "net.michaelzhou.android.music403.musicservicecommand.next";
    ...
    private long [] mUpcoming = new long[1]; // Circular buffer of songs to play "next" before resuming shuffle.
    private int mUpcomingStart = 0;
    private volatile int mUpcomingLen = 0; // volatile for UI get function.
...
//        mRemoteControlClient.setTransportControlFlags(flags);
     ...
     * "net.michaelzhou.android.music403.metachanged"
     * "net.michaelzhou.android.music403.queuechanged",
     * "net.michaelzhou.android.music403.playbackcomplete"
     * "net.michaelzhou.android.music403.playstatechanged"
...
//            ed.apply();
    ...
    private void openCurrent() {
        synchronized (this) {
            ...
            openById(mPlayList[mPlayPos]);
        }
    }

    private void openById(long longId) {
    ...
    public void play() {
        ...
        if (mPlayer.isInitialized()) {
            ...
            status.contentIntent = PendingIntent.getActivity(this, 0,
                    new Intent("net.michaelzhou.android.music403.PLAYBACK_VIEWER")
    ...
    public void next(boolean force) {
        synchronized (this) {
            ...
            if (mUpcomingLen != 0) {
                // Play the next song.
                stop(false);
                openById(mUpcoming[mUpcomingStart++]);
                mUpcomingStart %= mUpcoming.length;
                --mUpcomingLen;
                play();
                notifyChange(META_CHANGED);
                return;
    ...
    // Add a song to the end of the upcoming list.
    public void addToUpcomingEnd(long id) {
        synchronized (this) {
            // Check if we need to expand the circular buffer.
            if (mUpcoming.length == mUpcomingLen) {
                mUpcoming = CircularBuffer.expand(mUpcoming, mUpcomingStart, mUpcomingLen, mUpcomingLen * 2);
                mUpcomingStart = 0;
            }
            
            // Add.
            mUpcoming[(mUpcomingStart + mUpcomingLen) % mUpcoming.length] = id;
            ++mUpcomingLen;
        }
    }
    
    // Add a song to the start of the upcoming list.
    public void addToUpcomingStart(long id) {
        synchronized (this) {
            // Check if we need to expand the circular buffer.
            if (mUpcoming.length == mUpcomingLen) {
                mUpcoming = CircularBuffer.expand(mUpcoming, mUpcomingStart, mUpcomingLen, mUpcomingLen * 2);
            ...
            // Add.
            mUpcomingStart += mUpcoming.length; // Avoid negative mod problem.
            --mUpcomingStart;
            mUpcomingStart %= mUpcoming.length;
            mUpcoming[mUpcomingStart] = id;
            ++mUpcomingLen;
        }
    }
    
    // Check how many songs are upcoming.
    public int getUpcomingLen() {
        return mUpcomingLen;
    }
    ...
    static class ServiceStub extends IMediaPlaybackService.Stub {
        ...
        public void addToUpcomingEnd(long id) {
            mService.get().addToUpcomingEnd(id);
        }
        public void addToUpcomingStart(long id) {
            mService.get().addToUpcomingStart(id);
        }
        public int getUpcomingLen() {
            return mService.get().getUpcomingLen();
        }
        public long [] getQueue() {
