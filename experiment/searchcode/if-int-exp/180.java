...
public class Tools {
	 ...
	 *         https://github.com/essentials/Essentials/blob/master/Essentials/
	 *         src/net/ess3/craftbukkit/SetExpFix.java
	 */
	...
	public static class Item {
		 ...
		 * <br>
		 * NOTE: Will have a RESET color at the end, use
		 * {@link #print(ItemStack, ChatColor)} to use a diferent end-color
		 * instead.
		 * 
		 * @param item
		 ...
		 * @param endColor
		 *            will be appended at the end of string, should be your text
		 *            color
		 * @return user-friendly item print
		 */
