...
import org.not.java.Character;
import org.not.java.HelpMath;
import org.not.java.Locale;
import org.not.java.MessageFormat;
import org.not.java.Number;
import org.not.java.ResourceBundle;
...
public class ScriptRuntime {
    ...
    public static boolean toBoolean(Object val)
    {
        for (;;) {
            ...
            if (Number.isNumber(val)) {
                double d = Number.doubleValue(val);
                return (d == d && d != 0.0);
            }
    ...
    public static double toNumber(String s) {
        ...
        if (endChar == 'y') {
            ...
            if (startChar == '+' || startChar == '-')
                start++;
            if (start + 7 == end && s.regionMatches(false, start, "Infinity", 0, 8))
                return startChar == '-'
    ...
    public static String toString(Object val) {
        for (;;) {
            ...
            if (Number.isNumber(val)) {
                ...
                // about Numbers?
                return numberToString(Number.doubleValue(val), 10);
            }
            if (val instanceof Scriptable) {
    ...
    static String uneval(Context cx, Scriptable scope, Object value)
    {
        ...
        if (Number.isNumber(value)) {
            double d = Number.doubleValue(value);
            if (d == 0 && 1 / d < 0) {
                return "-0";
            }
            return toString(d);
    ...
    public static int toInt32(double d) {
        ...
        d = HelpMath.IEEEremainder(d, two32);
    ...
    public static long toUint32(double d) {
        ...
        double two32 = 4294967296.0;
        l = (long)HelpMath.IEEEremainder(d, two32);
    ...
    public static char toUint16(Object val) {
        ...
        int int16 = 0x10000;
        i = (int)HelpMath.IEEEremainder(d, int16);
        return (char)i;
    }
    ...
    static String toStringIdOrIndex(Context cx, Object id)
    {
        if (Number.isNumber(id)) {
            double d = Number.doubleValue(id);
            int index = (int)d;
            if (((double)index) == d) {
    ...
    {
        if(Number.isNumber(val1) && Number.isNumber(val2)) {
            return wrapNumber(Number.doubleValue(val1) +
            					Number.doubleValue(val2));
        }
                                               ...
                                               int incrDecrMask)
    {
        ...
        double number;
        if (Number.isNumber(value)) {
            number = Number.doubleValue(value);
        } else {
    ...
    public static boolean eq(Object x, Object y)
    {
        if (x == null || x == Undefined.instance) {
            ...
            return false;
        } else if (Number.isNumber(x)) {
            return eqNumber(Number.doubleValue(x), y);
            ...
            if (y instanceof Scriptable) {
                ...
                return eqNumber(d, x);
            } else if (Number.isNumber(y)) {
                return eqNumber(Number.doubleValue(y), x);
    ...
    private static boolean eqString(String x, Object y)
    {
        for (;;) {
            if (y == null || y == Undefined.instance) {
                ...
                return toNumber(x) == Number.doubleValue(y);
            } else if (y instanceof Boolean) {
    ...
    public static boolean shallowEq(Object x, Object y)
    {
        ...
        if (x == null || x == Undefined.instance) {
            ...
            if (Number.isNumber(y)) {
                return Number.doubleValue(x) == Number.doubleValue(y);
            }
        } else if (x instanceof String) {
    ...
    public static boolean cmp_LT(Object val1, Object val2)
    {
        double d1, d2;
        if (Number.isNumber(val1) && Number.isNumber(val2)) {
            d1 = Number.doubleValue(val1);
            d2 = Number.doubleValue(val2);
        } else {
            if (val1 instanceof Scriptable)
    ...
    public static ScriptableObject getGlobal(Context cx) {
        // We comment this out since we are not using tools in small.js.
        final String GLOBAL_CLASS = "org.mozilla.javascript.tools.shell.Global";
        Class globalClass = Kit.classOrNull(GLOBAL_CLASS);
        if (globalClass != null) {
            try {
                Class[] parm = { ScriptRuntime.ContextClass };
                throw new UnsupportedOperationException("ScribtableRuntime - getGlobal");
