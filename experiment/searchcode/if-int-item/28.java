...
public class Item
{
    ...
    {
        return 1; // requiresMultipleRenderPasses() ? 2 : 1; // MCPC+ - remove client code
    }
    ...
    {
        return new CreativeTabs[]{ }; // getCreativeTab() }; // MCPC+ - remove client code
    }
    ...
    {
    	return null; //getIconFromDamageForRenderPass(stack.getItemDamage(), pass); // MCPC+ - remove client code
    }
