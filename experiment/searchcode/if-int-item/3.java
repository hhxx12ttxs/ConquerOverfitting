...
public class BasicString extends mvString {      
    ...
    private final static char[][] REPLACE_DELIMITERS = {
        null,
        { mvConstants.AM },
        { mvConstants.AM, mvConstants.VM },
        { mvConstants.AM, mvConstants.VM, mvConstants.SM },
        null,
        null,
    };
    ...
    */
    ...
    public mvString DCOUNT(mvString result, mvConstantString substr, int offset) { 
        switch (type) {
            case TYPE_INDEX_AM_STRING:
            case TYPE_INDEX_VM_STRING: 
            case TYPE_INDEX_SM_STRING:
        ...
        switch (type) {
            case TYPE_BASIC_STRING:
                if (o instanceof mvConstantString) {
                    ...
                    } else if (value == ((mvConstantString)o).length()) {
                        char[] buffer = ((char[])data);
                        for (int i = 0; i < value; i++) {
    ...
    */
    ...
    private int findLength(mvConstantString s, int start, int len, char[] delims) {
