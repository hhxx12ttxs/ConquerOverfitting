...
public class MenuBuilder2 implements Menu {
    ...
    private static int getOrdering(int categoryOrder) {
        ...
        return (sCategoryToOrder[index] << 16) | (categoryOrder & 0x0000ffff);
    }
     ...
     *            a menu item does not have a shortcut defined, that item will
     ...
     * shortcut). On the other hand, if two (or more) shortcuts corresponds to
     * the same key, we have to only return the exact match.
     */
     ...
     *            place (false). For example, if the menu is closing because a
