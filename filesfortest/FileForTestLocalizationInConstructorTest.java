...
public class FileForTestLocalizationInConstructorTest {

    private static int counter = 0;

    @Test
    public void testNextGeneration() {
        FileForTestLocalizationInConstructor pop = new FileForTestLocalizationInConstructor(100, 0.203);
    ...
    public void testSetElitismRate() {
        ...
        final FileForTestLocalizationInConstructor pop = new FileForTestLocalizationInConstructor(100, 0.203);
    ...
    public void testConstructorTooLow() {
        final double rate = -0.25;
        new FileForTestLocalizationInConstructor(100, rate);
    }
    ...
    public void testChromosomeListConstructorTooLow() {
        ...
        final double rate = -0.25;
        new FileForTestLocalizationInConstructor(chromosomes, 100, rate);
    }
